...
public enum TxLinkRel {
    ...
    PARTICIPANT_COMMIT_ONE_PHASE("commit-one-phase"), // participant-commit-one-phase
                                                        // URI

    // made up links
    TRANSACTION("transaction"), PARTICIPANT_RECOVERY("recovery");
    ...
    static {
        ...
        linkRelMap.put("terminator", PARTICIPANT_TERMINATOR); // two instances
                                                                // of terminator
