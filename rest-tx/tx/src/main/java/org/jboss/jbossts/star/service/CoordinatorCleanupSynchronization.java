...
/**
 * This synchronization initiates cleanup of the {@link #transaction} and it's
 * participants from the {@link Coordinator}'s internal store. The
 * {@link #beforeCompletion()} is not called when a transaction times out in
 * which case the cleanup is initiated with an empty list of participants and
 * the {@link Coordinator} locates the participants.
 */
