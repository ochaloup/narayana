...
public class RecoveryManagerTestCase {
    ...
    public void testRecoveryWithExistingDeserializer() {
        ...
        final ParticipantInformation participantInformationBefore = new ParticipantInformation(participantId,
                APPLICATION_ID, "", "", loggingParticipantBefore, TxStatus.TransactionCommitted.name());
        ...
        Assert.assertEquals(participantInformationBefore.getApplicationId(),
                participantInformationAfter.getApplicationId());
        ...
        Assert.assertEquals(participantInformationBefore.getRecoveryURL(),
                participantInformationAfter.getRecoveryURL());
        Assert.assertEquals(participantInformationBefore.getId(), participantInformationAfter.getId());

        final LoggingParticipant loggingParticipantAfter = (LoggingParticipant) participantInformationAfter
                .getParticipant();
