...
public class ParticipantRecovery {
    ...
    public static void main(String[] args) {
        ...
        // get a helper for using RESTful transactions, passing in the well know
        // resource endpoint for the transaction manager
        ...
        if ("-r".equals(opt)) {
            ...
            for (long i = 0l; i < 130l; i += 2) {
                try {
                    // ask the service how many transactions it has committed
                    ...
                    if (cnt != null && !"0".equals(cnt)) {
                        System.out.println("SUCCESS participant was recovered after " + (i * 2)
                                + " seconds. Number of commits: " + cnt);
                        System.exit(0);
                    }
        ...
        String wId1 = txn.httpRequest(new int[]{HttpURLConnection.HTTP_OK}, serviceRequest, "GET",
                TxSupport.PLAIN_MEDIA_TYPE, null, null);
        String wId2 = txn.httpRequest(new int[]{HttpURLConnection.HTTP_OK}, serviceRequest, "GET",
                TxSupport.PLAIN_MEDIA_TYPE, null, null);
        ...
        // the transaction manager (TXN_MGR_URL)
