...
/**
 * Start a simple embedded web server for hosting web services that will
 * participate in REST Atomic transactions.
 *
 * We use Grizzly since it is the reference implementation and it supports
 * JAX-RS. Using JAX-RS make our web service example is trivial to implement.
 */
public class JaxrsServer {
     ...
     * 
     * org.jboss.resteasy.spi.Registry registry =
