...
/**
 * A class for discovering which participants are involved in a particular
 * transaction
 */
public class ParticipantDiscovery implements ResourceDiscoveryComponent {
    /**
     * @param context
     *            information about the containing transaction together with
     *            information available in the rhq descriptor
    ...
    public Set discoverResources(ResourceDiscoveryContext context) {
        ...
        for (EmsBean participant : parent.getParticipants()) {
            ...
            participants.add(new DiscoveredResourceDetails(context.getResourceType(), on, on, version, description,
