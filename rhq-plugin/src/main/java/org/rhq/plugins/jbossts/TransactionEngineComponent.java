...
/**
 * The management view of a Transaction Manager instance. By extending from
 * MBeanResourceComponent the RHQ framework makes available an Ems (a kind of
 * JMX wrapper) connection to the target system being managed.
 */
public class TransactionEngineComponent extends MBeanResourceComponent {
    ...
    public Collection<EmsBean> getTransactions() {
        try {
            // ask the MBean to update its view of which transactions are
            // present
