...
public class XMBeanResourceComponent extends MBeanResourceComponent<MBeanResourceComponent> {
    ...
    public void updateResourceConfiguration(ConfigurationUpdateReport report) {
        // the default implementation ignores the readOnly attribute on the
        // resource-configuration property so remove them from the report
        Map<String, PropertyDefinition> propDefs = getResourceContext().getResourceType()
                .getResourceConfigurationDefinition().getPropertyDefinitions();
