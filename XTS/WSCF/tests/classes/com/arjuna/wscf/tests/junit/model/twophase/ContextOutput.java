...
public class ContextOutput {
    ...
    @Test
    public void testContextOutput() throws Exception {
        ...
        try {
            ...
            // this fails because the documents are different -- need a better
            // test than this
            ((SOAPContext) theContext).serialiseToElement(root);
            doc.appendChild(root);

            // this does not do a full recursive conversion to text format --
