 ...
 * @version $Id: WscTranslateContext.java,v 1.6.6.1 2005/11/22 10:34:08 kconner
 *          Exp $
 * @since 1.0.
 */
...
public class WscTranslateContext {
    ...
    @Test
    public void testWscTranslateContext() throws Exception {
        ...
        try {
            ...
            // this fails because the context toString method gets a NPE -- need
            // a better test
    ...
    static private org.w3c.dom.Element translate(org.w3c.dom.Element ctx) throws Exception {
