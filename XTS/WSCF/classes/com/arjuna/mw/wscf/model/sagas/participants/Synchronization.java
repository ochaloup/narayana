...
/**
 * Business Activities don't expose synchronizations but they are used
 * internally to ensure that the transcation association is cleaned up and this
 * interface is used to define the behaviour of the synchronization.
 *
...
public interface Synchronization {
    ...
    /**
     * The transaction that the instance is enrolled with has either closed or
     * compensated and the relevant termination state ss passed as a parameter.
     *
     * @param status
