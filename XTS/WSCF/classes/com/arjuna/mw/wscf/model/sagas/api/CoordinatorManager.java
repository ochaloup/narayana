...
public interface CoordinatorManager extends UserCoordinator {
    ...
    /**
     * The participant has completed its work and it ready to compensate if
     * necessary.
     *
     * @param participantId
     *            The participant.
    ...
    /**
     * A participant has faulted during normal execution or compensation. The
     * saga will attempt to undo. The WS-T specification is a little vague here
     * - we assume the entire transaction has to undo and a heuristic hazard
     * needs to be logged.
     *
     * @param participantId
     *            The participant.
     ...
     * The saga will attempt to undo. The WS-T specification is a little vague
     * here - we assume the entire transaction has to undo.
     *
     * @param participantId
     *            The participant.
     *
