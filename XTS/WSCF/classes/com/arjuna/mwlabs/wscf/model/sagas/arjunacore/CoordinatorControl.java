...
public class CoordinatorControl {
    ...
    public void begin() throws SystemException {
        try {
            ...
            if (status != ActionStatus.RUNNING)
                throw new BegunFailedException(wscfLogger.i18NLogger.get_model_sagas_arjunacore_CoordinatorControl_1()
    ...
    /**
     * The current activity is completing and informs the participants that all
     * work they need to know about has been received.
     */
     ...
     * complete, close and cancel. Such a transaction is not interposed with any
     * parent transaction because the parent may be physically remote from the
     * child. Such interposition is the responsibility of the invoker.
     *
