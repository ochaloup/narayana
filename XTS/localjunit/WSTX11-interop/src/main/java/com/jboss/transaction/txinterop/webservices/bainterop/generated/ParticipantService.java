...
public class ParticipantService extends Service {
    ...
    private final static Logger logger = Logger.getLogger(
            com.jboss.transaction.txinterop.webservices.bainterop.generated.ParticipantService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.jboss.transaction.txinterop.webservices.bainterop.generated.ParticipantService.class
                    .getResource(".");
            url = new URL(baseUrl, "wsdl/interopba-participant-binding.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/interopba-participant-binding.wsdl', retrying as a local file");
    ...
    public ParticipantPortType getParticipantPortType() {
        return super.getPort(new QName("http://fabrikam123.com/wsba", "ParticipantPortType"),
