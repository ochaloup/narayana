...
public class InteropTestSuite extends TestSuite {
    ...
    /**
     * Construct an empty test suite with the specified participant URI and
     * name.
     * 
     * @param participantURI
     *            The participant URI.
    ...
    /**
     * Constructs a TestSuite from the given class using the specified
     * participant URI.
     * 
     * @param participantURI
     *            The participant URI.
