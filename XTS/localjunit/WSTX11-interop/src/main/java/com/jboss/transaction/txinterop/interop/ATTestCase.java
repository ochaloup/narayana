...
public class ATTestCase extends InteropTestCase {
    ...
    /**
     * testAT1_1 - 1.1 CompletionCommit Participant creates and commits a
     * transaction using the initiator's coordinator.
     * 
     * @throws Exception
     *             on failure.
     */
    public void testAT1_1() throws Exception {
        ...
        try {
            ...
            final String coordinatorURI = ProxyURIRewriting.rewriteURI(
                    ProxyConversation.getAlternateConversationId(conversationId), getSourceCoordinatorURI());
    ...
    /**
     * testAT1_2 - 1.2 CompletionRollback Participant creates and rolls back a
     * transaction using the initiator's coordinator.
     * 
     * @throws Exception
     *             on failure.
    ...
    /**
     * testAT2_1 - 2.1 Commit Participant registers for Durable2PC, initiator
     * commits, transaction commits successfully.
     * 
     * @throws Exception
     *             on failure.
     */
    public void testAT2_1() throws Exception {
        ...
        try {
            ...
            final CompletionCoordinatorParticipant participant = ATInteropUtil.registerCompletion(context,
    ...
    /**
     * testAT2_2 - 2.2 Rollback Participant registers for Durable2PC, initiator
     * rolls back.
     * 
     * @throws Exception
     *             on failure.
    ...
    /**
     * testAT3_1 - 3.1 Phase2Rollback Coordinator aborts the transaction due to
     * an Aborted vote during the prepare phase.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT3_2 - 3.2 Readonly Tests coordinator committing a transaction with
    ...
    /**
     * testAT3_3 - 3.3 VolatileAndDurable Tests registration during the volatile
     * prepare phase.
     * 
     * @throws Exception
     *             on failure.
    ...
    /**
     * testAT4_1 - 4.1 EarlyReadonly Tests the case of a participant initiated
     * ReadOnly message occurring prior to the prepare phase.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT4_2 - 4.2 EarlyAborted Tests the case of a participant initiated
     * Aborted message occurring prior to the prepare phase.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_1 - 5.1 ReplayCommit Participant registers for Durable2PC,
     * initator initiates commit, participant fails after prepared, recovers and
     * resends prepared. Transaction commits normally.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_2 - 5.2 RetryPreparedCommit Tests recovery from a communication
     * failure during the prepare phase. Transaction commits normally.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_3 - 5.3 RetryPreparedAbort Tests recovery from a communication
     * failure during the prepare phase. Transaction times out.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_4 - 5.4 RetryCommit Tests recovery from a communication failure
     * during the commit phase. Transaction commits normally.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_5 - 5.5 PreparedAfterTimeout Tests recovery from a communication
     * failure during the prepare phase. Transaction times out. Two
     * participants, volatile and durable.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * testAT5_6 - 5.6 LostCommitted Tests the effect of a lost Committed
     * message.
     * 
     * @throws Exception
     *             on failure.
