...
public class WriterSAXHandler implements ContentHandler {
    ...
    public void startElement(final String uri, final String localName, final String qName, final Attributes attributes)
        ...
        if (numAttributes > 0) {
            for (int count = 0; count < numAttributes; count++) {
                printWriter.write(' ');
                final String attributeQName = getQName(attributes.getURI(count), attributes.getLocalName(count),
                        attributes.getQName(count));
     ...
     * 
     * @param uri
     *            The qualifed namespace uri or empty string.
     * @param localName
     *            The qualified local name.
     * @param qName
     *            The qualified name.
