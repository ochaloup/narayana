...
public interface BAInteropConstants {
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_CANNOT_COMPLETE = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_CANNOT_COMPLETE,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_PARTICIPANT_COMPLETE_CLOSE = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_PARTICIPANT_COMPLETE_CLOSE, INTEROP_PREFIX);
    /**
     * The Participant Complete Close Action.
     */
    public String INTEROP_ACTION_PARTICIPANT_COMPLETE_CLOSE = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_PARTICIPANT_COMPLETE_CLOSE;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_COORDINATOR_COMPLETE_CLOSE = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_COORDINATOR_COMPLETE_CLOSE, INTEROP_PREFIX);
    /**
     * The Coordinator Complete Close Action.
     */
    public String INTEROP_ACTION_COORDINATOR_COMPLETE_CLOSE = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_COORDINATOR_COMPLETE_CLOSE;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_UNSOLICITED_COMPLETE = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_UNSOLICITED_COMPLETE, INTEROP_PREFIX);
    /**
     * The Unsolicited Complete Action.
     */
    public String INTEROP_ACTION_UNSOLICITED_COMPLETE = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_UNSOLICITED_COMPLETE;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_COMPENSATE = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_COMPENSATE,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_COMPENSATION_FAIL = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_COMPENSATION_FAIL, INTEROP_PREFIX);
    /**
     * The Compensation Fail Action.
     */
    public String INTEROP_ACTION_COMPENSATION_FAIL = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_COMPENSATION_FAIL;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_PARTICIPANT_CANCEL_COMPLETED_RACE = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_PARTICIPANT_CANCEL_COMPLETED_RACE, INTEROP_PREFIX);
    /**
     * The Participant Cancel Completed Race Action.
     */
    public String INTEROP_ACTION_PARTICIPANT_CANCEL_COMPLETED_RACE = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_PARTICIPANT_CANCEL_COMPLETED_RACE;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_MESSAGE_LOSS_AND_RECOVERY = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_MESSAGE_LOSS_AND_RECOVERY, INTEROP_PREFIX);
    /**
     * The Message Loss And Recovery Action.
     */
    public String INTEROP_ACTION_MESSAGE_LOSS_AND_RECOVERY = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_MESSAGE_LOSS_AND_RECOVERY;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_MIXED_OUTCOME = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_MIXED_OUTCOME,
            INTEROP_PREFIX);
    /**
