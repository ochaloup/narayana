...
public class BAInteropUnsolicitedCompleteState extends InteropWaitState {
    ...
    private final class RegistrationHandler extends BaseHandler {
        ...
        public void startElement(final String uri, final String localName, final String qName,
            ...
            if (CoordinationConstants.WSCOOR_NAMESPACE.equals(uri)
                    && CoordinationConstants.WSCOOR_ELEMENT_REGISTER.equals(localName)) {
                inRegister = true;
            } else if (inRegister && CoordinationConstants.WSCOOR_NAMESPACE.equals(uri)
                    && CoordinationConstants.WSCOOR_ELEMENT_PROTOCOL_IDENTIFIER.equals(localName)) {
        ...
        public void endElement(final String uri, final String localName, final String qName) throws SAXException {
            if (inProtocolIdentifier && CoordinationConstants.WSCOOR_NAMESPACE.equals(uri)
                    && CoordinationConstants.WSCOOR_ELEMENT_PROTOCOL_IDENTIFIER.equals(localName)) {
