...
/**
 * This class contains constants used to map the front end onto the WS-TX
 * interop tests.
 * 
 * @author kevin
 */
public class TestConstants {
     ...
     */
    public static final String DESCRIPTION_TEST_AT_1_1 = "1.1 - "
            + ATInteropConstants.INTEROP_ELEMENT_COMPLETION_COMMIT;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_AT_1_2 = "1.2 - "
            + ATInteropConstants.INTEROP_ELEMENT_COMPLETION_ROLLBACK;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_AT_3_3 = "3.3 - "
            + ATInteropConstants.INTEROP_ELEMENT_VOLATILE_AND_DURABLE;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_AT_5_2 = "5.2 - "
            + ATInteropConstants.INTEROP_ELEMENT_RETRY_PREPARED_COMMIT;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_AT_5_3 = "5.3 - "
            + ATInteropConstants.INTEROP_ELEMENT_RETRY_PREPARED_ABORT;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_AT_5_5 = "5.5 - "
            + ATInteropConstants.INTEROP_ELEMENT_PREPARED_AFTER_TIMEOUT;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_5 = "1.5 - "
            + BAInteropConstants.INTEROP_ELEMENT_PARTICIPANT_COMPLETE_CLOSE;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_6 = "1.6 - "
            + BAInteropConstants.INTEROP_ELEMENT_COORDINATOR_COMPLETE_CLOSE;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_7 = "1.7 - "
            + BAInteropConstants.INTEROP_ELEMENT_UNSOLICITED_COMPLETE;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_9 = "1.9 - "
            + BAInteropConstants.INTEROP_ELEMENT_COMPENSATION_FAIL;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_10 = "1.10 - "
            + BAInteropConstants.INTEROP_ELEMENT_PARTICIPANT_CANCEL_COMPLETED_RACE;
    /**
     ...
     */
    public static final String DESCRIPTION_TEST_BA_1_11 = "1.11 - "
            + BAInteropConstants.INTEROP_ELEMENT_MESSAGE_LOSS_AND_RECOVERY;
    /**
