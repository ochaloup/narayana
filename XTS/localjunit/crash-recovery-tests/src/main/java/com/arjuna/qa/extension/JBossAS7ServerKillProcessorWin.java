...
public class JBossAS7ServerKillProcessorWin extends BaseServerKillProcessor {
    ...
    private static final String CHECK_JBOSS_ALIVE_CMD = PS_AUX_CMD + " | findstr jboss-module | findstr /v findstr"; // skip
                                                                                                                        // "findstr"
                                                                                                                        // from
                                                                                                                        // output,
                                                                                                                        // windows
                                                                                                                        // workaround
    private static final String CHECK_FOR_DEFUNCT_JAVA_CMD = PS_AUX_CMD + " | findstr defunct | findstr /v findstr"; // skip
                                                                                                                        // "findstr"
                                                                                                                        // from
                                                                                                                        // output,
                                                                                                                        // windows
