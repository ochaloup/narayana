...
public class WarDeployment {
    public static WebArchive getDeployment(Class<?>... args) {
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war").addClass(SagasParticipant.class)
                .addClass(TwoPhaseParticipant.class).addClass(TwoPhaseSynchronization.class)
                .addClass(WSCF11TestUtils.class).addClasses(args).addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml");
