...
public final class EnabledContextPropagationTest extends AbstractContextPropagationTest {
    ...
    public static WebArchive getDeployment() {
        return WarDeployment.getDeployment(AbstractContextPropagationTest.class, TestService.class,
                TestServiceImple.class, TestServiceClient.class, TestServiceBA.class, TestServiceBAImple.class,
                TestServiceBAClient.class, WSTXFeature.class).addAsResource("context-handlers.xml");
    }
     ...
     * enabled WSTXFeature and with enabled WSTX handler.
     *
    ...
    /**
     * Tests invocation to the BA-unaware service without BA context but with
     * disabled WSTXFeature and with enabled WSTX handler.
     *
     * No coordination calls are expected.
     */
    @Test
