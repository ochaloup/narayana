...
public final class DisabledContextPropagationTest extends AbstractContextPropagationTest {
    ...
    public static WebArchive getDeployment() {
        return WarDeployment.getDeployment(AbstractContextPropagationTest.class, TestService.class,
                TestServiceImple.class, TestServiceClient.class, TestServiceAT.class, TestServiceATImple.class,
                TestServiceATClient.class, WSTXFeature.class).addAsResource("context-handlers.xml");
    }
