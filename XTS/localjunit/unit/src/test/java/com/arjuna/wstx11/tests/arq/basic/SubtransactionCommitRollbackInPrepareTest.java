...
public class SubtransactionCommitRollbackInPrepareTest {
    ...
    public static WebArchive createDeployment() {
        return WarDeployment.getDeployment(SubtransactionCommitRollbackInPrepare.class, FailureParticipant.class,
                DemoDurableParticipant.class, DemoVolatileParticipant.class);
    }
