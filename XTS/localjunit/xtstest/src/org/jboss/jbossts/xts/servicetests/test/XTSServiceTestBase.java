...
/**
 * Class providing default behaviour for specific XTSServiceTest
 * implementations. n.b. this class extends
 */
public class XTSServiceTestBase extends XTSServiceTestInterpreter {
    ...
    public boolean isSuccessful() {
        return isSuccessful; // To change body of implemented methods use File |
                                // Settings | File Templates.
    }

    public Exception getException() {
        return exception; // To change body of implemented methods use File |
                            // Settings | File Templates.
    }
