 ...
 * behaviour. This differs from the service in the parent package only in one
 * detail It employs a handler which checks for an existing context, creates a
 * subordinate transaction and installs the subordinate context.
 */
