...
public class TestLogController {
     ...
     *             for reading errors.
     */
    public static String readLog(final String logName) throws IOException {
     ...
     *             for reading errors.
     */
    public static void writeLog(final String logName, final String contents) throws IOException {
        final File logFile = new File(baseDir, logName);
