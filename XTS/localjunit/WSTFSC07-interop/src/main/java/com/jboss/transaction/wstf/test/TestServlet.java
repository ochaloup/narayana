...
public class TestServlet extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        // final String asyncTestValue =
        // request.getParameter(TestConstants.PARAM_ASYNC_TEST) ;
     ...
     * 
     * @param messageLog
     *            The specified message log.
     * @return The transformed result.
     * @throws TransformerConfigurationException
     *             For transformer configuration errors.
     * @throws TransformerException
     *             The transformation errors.
     */
    private String transform(final String messageLog) throws TransformerConfigurationException, TransformerException {
