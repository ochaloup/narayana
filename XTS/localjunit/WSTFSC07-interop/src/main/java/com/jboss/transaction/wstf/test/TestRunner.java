...
public class TestRunner {
     ...
     */
    public static TestResult execute(final String participantURI, final long testTimeout, final boolean asyncTest,
     ...
     *             For access exception instantiating the test class.
     * @throws InstantiationException
     *             For errors instantiating the test class.
     * @throws IllegalArgumentException
     *             For an invalid test class.
     */
    private static TestCase createTest(final Class testClass, final String participantURI, final long testTimeout,
            final boolean asyncTest, final String testName)
