...
public class Sc007TestCase extends InteropTestCase {
    ...
    /**
     * test1_1 - 1.1 CompletionCommit Participant creates and commits a
    ...
    /**
     * test1_2 - 1.2 CompletionRollback Participant creates and rolls back a
     * transaction using the initiator's coordinator.
     * 
     * @throws Exception
     *             on failure.
    ...
    public void test2_1() throws Exception {
        ...
        try {
            ...
            final CompletionCoordinatorParticipant participant = InteropUtil.registerCompletion(context,
    ...
    /**
     * test2_2 - 2.2 Rollback Participant registers for Durable2PC, initiator
     * rolls back.
     * 
     * @throws Exception
     *             on failure.
    ...
    /**
     * test3_1 - 3.1 Phase2Rollback Coordinator aborts the transaction due to an
     * Aborted vote during the prepare phase.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * test3_2 - 3.2 Readonly Tests coordinator committing a transaction with a
    ...
    /**
     * test3_3 - 3.3 VolatileAndDurable Tests registration during the volatile
     * prepare phase.
     * 
     * @throws Exception
     *             on failure.
    ...
    /**
     * test3_4 - 3.4 EarlyReadonly Tests the case of a participant initiated
    ...
    /**
     * test3_5 - 3.5 EarlyAborted Tests the case of a participant initiated
    ...
    /**
     * test3_6 - 3.6 ReplayCommit Participant registers for Durable2PC, initator
     * initiates commit, participant fails after prepared, recovers and resends
     * prepared. Transaction commits normally.
     * 
     * @throws Exception
     *             on failure.
     */
    ...
    /**
     * test3_7 - 3.7 RetryPreparedCommit Tests recovery from a communication
    ...
    /**
     * test3_8 - 3.8 RetryPreparedAbort Tests recovery from a communication
    ...
    /**
     * test3_9 - 3.9 RetryCommit Tests recovery from a communication failure
    ...
    /**
     * test3_10 - 3.10 PreparedAfterTimeout Tests recovery from a communication
    ...
    /**
     * test3_11 - 3.11 LostCommitted Tests the effect of a lost Committed
     * message.
     * 
     * @throws Exception
     *             on failure.
