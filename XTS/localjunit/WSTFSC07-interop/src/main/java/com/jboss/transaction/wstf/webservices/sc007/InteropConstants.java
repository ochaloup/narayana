...
public interface InteropConstants {
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_COMPLETION_COMMIT = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_COMPLETION_COMMIT, INTEROP_PREFIX);
    /**
     * The completion commit Action.
     */
    public String INTEROP_ACTION_COMPLETION_COMMIT = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_COMPLETION_COMMIT;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_COMPLETION_ROLLBACK = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_COMPLETION_ROLLBACK, INTEROP_PREFIX);
    /**
     * The completion rollback Action.
     */
    public String INTEROP_ACTION_COMPLETION_ROLLBACK = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_COMPLETION_ROLLBACK;
     ...
     * The rollback QName.
     */
    public QName INTEROP_ELEMENT_QNAME_ROLLBACK = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_ROLLBACK,
            INTEROP_PREFIX);
    /**
     * The rollback Action.
     */
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_PHASE_2_ROLLBACK = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_PHASE_2_ROLLBACK,
            INTEROP_PREFIX);
    /**
     * The phase 2 rollback Action.
     */
    public String INTEROP_ACTION_PHASE_2_ROLLBACK = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_PHASE_2_ROLLBACK;
     ...
     * The readonly QName.
     */
    public QName INTEROP_ELEMENT_QNAME_READONLY = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_READONLY,
            INTEROP_PREFIX);
    /**
     * The readonly Action.
     */
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_VOLATILE_AND_DURABLE = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_VOLATILE_AND_DURABLE, INTEROP_PREFIX);
    /**
     * The volatile and durable Action.
     */
    public String INTEROP_ACTION_VOLATILE_AND_DURABLE = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_VOLATILE_AND_DURABLE;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_EARLY_READONLY = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_EARLY_READONLY,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_EARLY_ABORTED = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_EARLY_ABORTED,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_REPLAY_COMMIT = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_REPLAY_COMMIT,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_RETRY_PREPARED_COMMIT = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_RETRY_PREPARED_COMMIT, INTEROP_PREFIX);
    /**
     * The retry prepared commit Action.
     */
    public String INTEROP_ACTION_RETRY_PREPARED_COMMIT = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_RETRY_PREPARED_COMMIT;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_RETRY_PREPARED_ABORT = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_RETRY_PREPARED_ABORT, INTEROP_PREFIX);
    /**
     * The retry prepared abort Action.
     */
    public String INTEROP_ACTION_RETRY_PREPARED_ABORT = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_RETRY_PREPARED_ABORT;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_RETRY_COMMIT = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_RETRY_COMMIT,
            INTEROP_PREFIX);
    /**
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_PREPARED_AFTER_TIMEOUT = new QName(INTEROP_NAMESPACE,
            INTEROP_ELEMENT_PREPARED_AFTER_TIMEOUT, INTEROP_PREFIX);
    /**
     * The prepared after timeout Action.
     */
    public String INTEROP_ACTION_PREPARED_AFTER_TIMEOUT = INTEROP_ACTION_PARTICIPANT_PREFIX
            + INTEROP_ELEMENT_PREPARED_AFTER_TIMEOUT;
     ...
     */
    public QName INTEROP_ELEMENT_QNAME_LOST_COMMITTED = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_LOST_COMMITTED,
            INTEROP_PREFIX);
    /**
     ...
     * The response QName.
     */
    public QName INTEROP_ELEMENT_QNAME_RESPONSE = new QName(INTEROP_NAMESPACE, INTEROP_ELEMENT_RESPONSE,
            INTEROP_PREFIX);
    /**
     * The response Action.
     */
