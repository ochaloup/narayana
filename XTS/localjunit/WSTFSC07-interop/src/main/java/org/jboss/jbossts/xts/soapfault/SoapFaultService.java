...
public class SoapFaultService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(org.jboss.jbossts.xts.soapfault.SoapFaultService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/soapfault.wsdl', retrying as a local file");
    ...
    /**
     * 
     * @return returns SoapFaultPortType
     */
    @WebEndpoint(name = "SoapFaultPortType")
    public SoapFaultPortType getSoapFaultPortType() {
        return super.getPort(new QName("http://jbossts.jboss.org/xts/soapfault", "SoapFaultPortType"),
    ...
    public SoapFaultPortType getSoapFaultPortType(WebServiceFeature... features) {
        return super.getPort(new QName("http://jbossts.jboss.org/xts/soapfault", "SoapFaultPortType"),
                org.jboss.jbossts.xts.soapfault.SoapFaultPortType.class, features);
    }
