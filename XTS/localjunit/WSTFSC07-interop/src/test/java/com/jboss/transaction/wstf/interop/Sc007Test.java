...
public class Sc007Test {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "sc007.war").addPackage("com.jboss.transaction.wstf.interop")
                .addPackage("com.jboss.transaction.wstf.interop.states").addPackage("com.jboss.transaction.wstf.proxy")
                .addPackage("com.jboss.transaction.wstf.test").addPackage("com.jboss.transaction.wstf.webservices")
                ...
                .addAsResource("sc007/participanthandlers.xml",
                        "com/jboss/transaction/wstf/webservices/sc007/sei/participanthandlers.xml")
                .addAsWebInfResource("sc007/wsdl/sc007.wsdl",
                        "classes/com/jboss/transaction/wstf/webservices/sc007/generated/wsdl/sc007.wsdl")
                ...
                .addAsResource("com/jboss/transaction/wstf/test/processor.xsl").addAsWebInfResource("web.xml")
