 ...
 * @version $Id: FailureBusinessParticipant.java,v 1.4 2004/09/09 08:48:39
 *          kconner Exp $
 * @since 1.0.
 */

public class FailureBusinessParticipant
        implements
    ...
    /**
     * we use this to time out the failure behaviour for close because otherwise
     * the transaction will keep retrying -- that's as per the sepc but a pain
     * in the proverbial
     */
    private static long closeFirstCalledTime = 0;

    /**
     * timeout for the close failure in milliseconds. this must be bigger than
     * the BA coordinator wait timeout and any timeout used by a test when it
     * waits for the transaction to complete. A few minutes should be adequate.
     */
