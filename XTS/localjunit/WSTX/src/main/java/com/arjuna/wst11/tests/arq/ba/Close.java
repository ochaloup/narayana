...
public class Close {
    public void testClose() throws Exception {
        ...
        // and then uba.close() is invoked before the coordinator has received
        // word
        // that the participant has completed.
        // As the participant is not competed, the coordinator will cancel the
        // participant
        // and the UBA will throw a TransactionRolledBackException
        //
        // we add delay 10s before uba.close() to give the participant time to
        // complete.
