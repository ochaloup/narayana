...
public class MultiCompensateTest {
    ...
    public static WebArchive createDeployment() {
        return WarDeployment.getDeployment(MultiCompensate.class, DemoBusinessParticipant.class,
                FailureBusinessParticipant.class, ParticipantCompletionCoordinatorRules.class);
    }
