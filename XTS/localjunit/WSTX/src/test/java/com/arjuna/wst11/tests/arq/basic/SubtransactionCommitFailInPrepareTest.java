...
public class SubtransactionCommitFailInPrepareTest {
    ...
    public static WebArchive createDeployment() {
        return WarDeployment.getDeployment(SubtransactionCommitFailInPrepare.class, DemoDurableParticipant.class,
                DemoVolatileParticipant.class, FailureParticipant.class);
    }
