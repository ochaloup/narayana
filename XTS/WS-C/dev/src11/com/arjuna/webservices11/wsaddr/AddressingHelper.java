...
public class AddressingHelper {
    ...
    public static MAP createOneWayResponseContext(final MAP map, final String messageID) {
        ...
        // ok just calling initializeAsDestination directly fails when the
        // FaultTo/ReplyTo/From
        // contains reference parameter elements. these get installed into the
        // target element extensions
        // list for insertion into the outgoing message. however, the insertion
        // fails.
        // JBossWS decides they can be inserted as is without copying because
        // they are SOAP
        // elements but this ignores the fact that they have a DOM node
        // attached. when the
        // appendElement is called it barfs because the target and source belong
        // to different
        // documents. we patch this by copying the FaultTo or ReplyTo or from
        // here if need be.
    ...
    /**
     * Create an addressing context that represents an inline reply to the
     * specified addressing context.
     * 
     * @param map
     *            The addressing context being replied to.
     * @param messageID
    ...
    /**
     * Create an addressing context that represents a fault to the specified
     * addressing context.
     * 
     * @param map
     *            The addressing context being replied to.
    ...
    /**
     * Create an addressing context that represents a request to the specified
     * address.
     * 
     * @param address
     *            TheendpointReference target address.
     * @param messageID
     *            The message id of the new message.
    ...
    public static MAP createRequestContext(final String address, final String messageID) {
        ...
        if (messageID != null) {
            ...
            // client does not care about id but we have to set some id or WSA
            // will complain
    ...
    /**
     * Create an addressing context that represents a notification to the
     * specified context.
     * 
     * @param map
     *            The addressing properties used to derive the notification
     *            addressing context.
     * @param messageID
     *            The message id of the new message.
    ...
    /**
     * Create an addressing context specifying only the message id for a
     * notification.
     * 
     * @param messageID
     *            The message id of the new message.
    ...
    public static void installActionMessageID(MAP map, final String action, final String messageID) {
        // requestProperties has been derived from an endpoint so To and
        // ReferenceParameters will be set. we
    ...
    public static void installCallerProperties(MAP map, MAP requestMap) {
        // requestMap has been derived from an endpoint so To and
        // ReferenceParameters will be set. we
    ...
    /**
     * JBossWS Native version to configure request context with MAP, to and
     * action
     * 
    ...
    public static void configureRequestContext(Map<String, Object> requestContext, String to, String action) {
        ...
        if (action != null) {
            // need to set soap action header based upon what the client asks
            // for
    ...
    /**
     * retrieve the inbound server message address properties attached to a
     * message context
     * 
     * @param ctx
     *            the server message context
     * @return
     */
    ...
    /**
     * retrieve the outbound client message address properties attached to a
     * message request map
     * 
     * @param ctx
     *            the client request properties map
     * @return
     */
    ...
    private static QName REPLY_RELATIONSHIP_TYPE_QNAME = new QName(REPLY_RELATIONSHIP_TYPE_NS,
            REPLY_RELATIONSHIP_TYPE_STRING);
}
