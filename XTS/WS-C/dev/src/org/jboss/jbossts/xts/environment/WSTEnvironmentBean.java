...
/**
 * bean storing WS-T 1.0 implementation configuration values derived from the
...
public class WSTEnvironmentBean {
    ...
    /**
     * the name of the class used to implement the WSAT 1.1 TransactionManager
     * API.
     */
    ...
    /**
     * the name of the class used to implement the WSBA 1.1 UserBusinessActivity
     * API.
     */
    ...
    /**
     * the name of the class used to implement the WSBA 1.1
     * BusinessActivityManager API.
     */
    ...
    /**
     * the name of the class used to implement the WSAT 1.0 TransactionManager
     * API.
     */
    @Deprecated
    ...
    /**
     * the name of the class used to implement the WSBA 1.0 UserBusinessActivity
     * API.
     */
    @Deprecated
    ...
    /**
     * the name of the class used to implement the WSBA 1.0
     * BusinessActivityManager API.
     */
    @Deprecated
    ...
    /**
     * the URL path component of the URL at which 1.1 WS-T coordinator services
     * have been mapped. if this is null then the path is defaulted to
     * "ws-t11-coordinator"
     */
    ...
    /**
     * the URL path component of the URL at which 1.1 WS-T client services have
     * been mapped. if this is null then the path is defaulted to
     * "ws-t11-client"
     */
    ...
    /**
     * the URL path component of the URL at which 1.1 WS-T participant services
     * have been mapped. if this is null then the path is defaulted to
     * "ws-t11-participant"
     */
    ...
    /**
     * Returns the name of the class used to implement the WSAT 1.1
     * UserTransaction API.
     *
     * @return the name of the class used to implement the WSAT 1.1
     *         UserTransaction API.
     */
    ...
    /**
     * Sets the name of the class used to implement the WSAT 1.1 UserTransaction
     * API.
     *
     * @param userTransaction11
     *            the name of the class used to implement the WSAT 1.1
     *            UserTransaction API.
     */
    ...
    /**
     * Sets the name of the class used to implement the WSAT 1.1
     * TransactionManager API.
     *
     * @param transactionManager11
     *            the name of the class used to implement the WSAT 1.1
     *            TransactionManager API.
     */
    ...
    /**
     * Returns the name of the class used to implement the WSBA 1.1
     * UserBusinessActivity API.
     *
     * @return the name of the class used to implement the WSBA 1.1
     *         UserBusinessActivity API.
     */
    ...
    /**
     * Sets the name of the class used to implement the WSBA 1.1
     * UserBusinessActivity API.
     *
     * @param userBusinessActivity11
     *            the name of the class used to implement the WSBA 1.1
     *            UserBusinessActivity API.
     */
     ...
     * BusinessActivityManager API.
     *
     * @param businessActivityManager11
     *            the name of the class used to implement the WSBA 1.1
     *            BusinessActivityManager API.
     */
    ...
    /**
     * Returns the name of the class used to implement the WSAT 1.0
     * UserTransaction API.
     *
     * @return the name of the class used to implement the WSAT 1.0
     *         UserTransaction API.
     */
    @Deprecated
    ...
    /**
     * Sets the name of the class used to implement the WSAT 1.0 UserTransaction
     * API.
     *
     * @param userTransaction10
     *            the name of the class used to implement the WSAT 1.0
     *            UserTransaction API.
     */
    @Deprecated
    ...
    /**
     * Sets the name of the class used to implement the WSAT 1.0
     * TransactionManager API.
     *
     * @param transactionManager10
     *            the name of the class used to implement the WSAT 1.0
     *            TransactionManager API.
     */
    @Deprecated
    ...
    /**
     * Returns the name of the class used to implement the WSBA 1.0
     * UserBusinessActivity API.
     *
     * @return the name of the class used to implement the WSBA 1.0
     *         UserBusinessActivity API.
     */
    @Deprecated
    ...
    /**
     * Sets the name of the class used to implement the WSBA 1.0
     * UserBusinessActivity API.
     *
     * @param userBusinessActivity10
     *            the name of the class used to implement the WSBA 1.0
     *            UserBusinessActivity API.
     */
    @Deprecated
     ...
     * BusinessActivityManager API.
     *
     * @param businessActivityManager10
     *            the name of the class used to implement the WSBA 1.0
     *            BusinessActivityManager API.
     */
    @Deprecated
    ...
    /**
     * Returns the URL path component of the URL at which 1.1 WS-T coordinator
     * services have been mapped. If this is null then the path is defaulted to
     * "ws-t11-coordinator".
     *
     * @return the URL path component of the URL at which 1.1 WS-T coordinator
     *         services have been mapped.
     */
    ...
    /**
     * Sets the URL path component of the URL at which 1.1 WS-T coordinator
     * services have been mapped.
     *
     * @param coordinatorServiceURLPath
     *            the URL path component of the URL at which 1.1 WS-T
     *            coordinator services have been mapped.
     */
    ...
    /**
     * Returns the URL path component of the URL at which 1.1 WS-T client
     * services have been mapped. If this is null then the path is defaulted to
     * "ws-t11-client".
     *
     * @return the URL path component of the URL at which 1.1 WS-T client
     *         services have been mapped.
     */
    ...
    /**
     * Sets the URL path component of the URL at which 1.1 WS-T client services
     * have been mapped.
     *
     * @param clientServiceURLPath
     *            the URL path component of the URL at which 1.1 WS-T client
     *            services have been mapped.
     */
    ...
    /**
     * Returns the URL path component of the URL at which 1.1 WS-T participant
     * services have been mapped. If this is null then the path is defaulted to
     * "ws-t11-participant".
     *
     * @return the URL path component of the URL at which 1.1 WS-T participant
     *         services have been mapped.
     */
    ...
    /**
     * Sets the URL path component of the URL at which 1.1 WS-T participant
     * services have been mapped.
     *
     * @param participantServiceURLPath
     *            the URL path component of the URL at which 1.1 WS-T
     *            participant services have been mapped.
     */
