...
/**
 * bean holding the configuration proeprty settings which identify
 * intiialisation routines to be run during XTS startup and shutdown
 */
...
public class XTSEnvironmentBean {
    ...
    /**
     * Returns the list of XTS recovery modules to be installed at startup and
     * removed at shutdown.
     *
    ...
    /**
     * Sets the list of XTS recovery modules to be installed at startup and
     * removed at shutdown.
     *
     * @param xtsInitialisations
