...
public class ActivationService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(org.oasis_open.docs.ws_tx.wscoor._2006._06.ActivationService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wscoor-activation-binding.wsdl', retrying as a local file");
    ...
    public ActivationService() {
        super(ACTIVATIONSERVICE_WSDL_LOCATION,
                new QName("http://docs.oasis-open.org/ws-tx/wscoor/2006/06", "ActivationService"));
    }

    /**
     * 
     * @return returns ActivationPortType
     */
    @WebEndpoint(name = "ActivationPortType")
    public ActivationPortType getActivationPortType() {
        return super.getPort(new QName("http://docs.oasis-open.org/ws-tx/wscoor/2006/06", "ActivationPortType"),
                ActivationPortType.class);
    }
    ...
    public ActivationPortType getActivationPortType(WebServiceFeature... features) {
        return super.getPort(new QName("http://docs.oasis-open.org/ws-tx/wscoor/2006/06", "ActivationPortType"),
                ActivationPortType.class, features);
    }
