...
public abstract class BaseProcessor {
     ...
     * @param ids
     *            The message ids.
     * @return The callbacks associated with the message ids in the addressing
     *         context.
     */
    ...
    protected abstract static class CallbackExecutorAdapter implements CallbackExecutor {
         ...
         */
        public void executeUnknownIds(final String[] ids) {
            WSCLogger.logger.tracev("Received a response for non existent message IDs {0}",
                    new Object[]{toString(ids)});
        }
