...
public class SoapFaultType extends Enumerated {
     ...
     */
    private static final Map ENUM_MAP = generateMap(new Enumerated[]{FAULT_VERSION_MISMATCH, FAULT_MUST_UNDERSTAND,
            FAULT_DATA_ENCODING_UNKNOWN, FAULT_SENDER, FAULT_RECEIVER});
     ...
     *             if the value is not valid.
     */
    public static SoapFaultType toState(final String value) throws InvalidEnumerationException {
