...
public class TransportTimer {
    ...
    /**
     * Set the maximum transport period for engines which require an
     * exponentially increasing period between message resends.
     * 
     * @param period
     *            The transport period in milliseconds.
     */
    ...
    /**
     * Get the maximum transport period for engines which require an
     * exponentially increasing period between message resends.
     * 
     * @return The transport period in milliseconds.
     */
