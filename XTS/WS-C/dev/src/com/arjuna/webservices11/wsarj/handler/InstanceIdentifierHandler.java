    ...
    protected boolean handleMessageOutbound(SOAPMessageContext context) throws ProtocolException {
        try {
            ...
            if (arjunaContext != null) {
                ...
                // instance identifier as a text element
                ...
                final SOAPHeaderElement headerElement = soapHeader
                        .addHeaderElement(ArjunaConstants.WSARJ_ELEMENT_INSTANCE_IDENTIFIER_QNAME);
