...
public class WSCOORClient {
    ...
    private static synchronized ActivationService getActivationService() {
        if (activationService.get() == null) {
            // activationService.set(new ActivationService(null, new
            // QName("http://docs.oasis-open.org/ws-tx/wscoor/2006/06",
            // "ActivationService")));
    ...
    private static synchronized RegistrationService getRegistrationService() {
        if (registrationService.get() == null) {
            // registrationService.set(new RegistrationService(null, new
            // QName("http://docs.oasis-open.org/ws-tx/wscoor/2006/06",
            // "RegistrationService")));
    ...
    public static RegistrationPortType getRegistrationPort(W3CEndpointReference endpointReference, String action,
            String messageID) {
