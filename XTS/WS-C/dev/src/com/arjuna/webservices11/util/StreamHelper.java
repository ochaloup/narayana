...
public class StreamHelper {
    ...
    /**
     * Write a start element with appropriate namespace declarations if
     * necessary
     * 
     * @param out
     *            The output stream.
     ...
     *            The element prefix.
     * @param namespaceURI
     *            The previous binding for the prefix.
     * @throws javax.xml.stream.XMLStreamException
     *             for errors during writing.
     */
    public static void writeEndElement(final XMLStreamWriter out, final String prefix, final String namespaceURI)
            throws XMLStreamException {
        out.writeEndElement();
     ...
     *            The attributes.
     * @throws XMLStreamException
     *             Thrown for errors during writing.
     */
    public static void writeAttributes(final XMLStreamWriter out, final Map attributes) throws XMLStreamException {
     ...
     *             Thrown for errors during writing.
     */
    public static void writeAttribute(final XMLStreamWriter out, final QName attributeName, final Object attributeValue)
            throws XMLStreamException {
     ...
     *            The attribute name.
     * @param attributeValue
     *            The attribute value as a QName.
     * @throws XMLStreamException
     *             Thrown for errors during writing.
     */
    public static void writeAttribute(final XMLStreamWriter out, final QName attributeName, final QName attributeValue)
            throws XMLStreamException {
        ...
        if (namespaceURI.length() == 0) {
            ...
            if (origPrefix == null) {
                ...
                writeAttribute(out, attributeName,
                        QNameHelper.toQualifiedName(origPrefix, attributeValue.getLocalPart()));
            }
        }
    }
     ...
     *             Thrown for errors during writing.
     */
    public static void writeAttribute(final XMLStreamWriter out, final QName attributeName, final String attributeValue)
            throws XMLStreamException {
     ...
     *             Thrown for errors during writing.
     */
    public static void writeQualifiedName(final XMLStreamWriter out, final QName qName) throws XMLStreamException {
     ...
     *             For parsing errors.
     */
    public static void skipToNextStartElement(final XMLStreamReader streamReader) throws XMLStreamException {
        if (streamReader.hasNext()) {
            streamReader.nextTag();
            if (streamReader.isEndElement()) {
                throw new XMLStreamException(
                        WSCLogger.i18NLogger.get_webservices_util_StreamHelper_1(streamReader.getName()));
            }
        } else {
     ...
     *             For parsing errors.
     */
    public static void skipToStartElement(final XMLStreamReader streamReader) throws XMLStreamException {
     ...
     *             For errors during parsing.
     */
    public static void checkTag(final XMLStreamReader streamReader, final QName expected) throws XMLStreamException {
     ...
     *             For errors during parsing.
     */
    public static boolean checkParentFinished(final XMLStreamReader streamReader) throws XMLStreamException {
