...
public final class NativeEndpointReference extends EndpointReference {
    ...
    /**
     * Directly read a NativeEndpointReference from the given source instead of
    ...
    private NativeEndpointReference unmarshalNativeEndpointReference(final Source source) {
        final JAXBContextUnmarshalAction<NativeEndpointReference> unmarshalAction = JAXBContextUnmarshalAction
                .getInstance(jc, source, NativeEndpointReference.class);
