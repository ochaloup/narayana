...
public class TestContextFactory implements ContextFactory {
    ...
    public CoordinationContextType create(final String coordinationTypeURI, final Long expires,
            final CoordinationContextType currentContext) throws InvalidCreateParametersException {
        ...
        final String registrationURI = soapRegistry
        ...
        final EndpointReferenceType registrationService = new EndpointReferenceType(
                new AttributedURIType(registrationURI));
