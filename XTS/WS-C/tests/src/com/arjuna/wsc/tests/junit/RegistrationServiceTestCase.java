...
public class RegistrationServiceTestCase {
    ...
    public void setUp() throws Exception {
        ...
        final String registrationRequesterURI = soapRegistry
        ...
        final String registrationCoordinatorURI = soapRegistry
    ...
    public void testKnownCoordinationType() throws Exception {
        ...
        try {
            final EndpointReferenceType registerResponse = RegistrationCoordinator.register(coordinationContext,
                    messageId, registrationRequester, protocolIdentifier);
