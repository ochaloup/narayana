...
public class ActivationServiceTestCase {
    ...
    public void testKnownCoordinationType() throws Exception {
        ...
        try {
            final CoordinationContextType coordinationContext = ActivationCoordinator
                    .createCoordinationContext(activationCoordinatorURI, messageID, coordinationTypeURI, null, null);
    ...
    public void testUnknownCoordinationType() throws Exception {
        ...
        try {
            ActivationCoordinator.createCoordinationContext(activationCoordinatorURI, messageID, coordinationTypeURI,
                    null, null);
