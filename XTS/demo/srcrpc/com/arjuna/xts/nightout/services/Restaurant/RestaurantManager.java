...
public class RestaurantManager implements Serializable {
    ...
    private RestaurantManager() {
        setToDefault(false);
        // restore any state saved by a previous installation of this web
        // service
        restoreState();
    }
     ...
     * @return true on success, false otherwise
     */
    public synchronized boolean compensateSeats(Object txID) throws FaultedException {
        boolean success = false;
     ...
     *
     * @param commit
     *            true for commitment, false for rollback
     */
