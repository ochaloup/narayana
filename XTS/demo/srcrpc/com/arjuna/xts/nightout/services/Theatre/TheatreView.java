...
public class TheatreView extends javax.swing.JFrame {
     ...
     *
     * @param tManager
     *            The {@link TheatreManager} instance to bind to
     */
    ...
    /**
     * Initialize the form. This is called by the constructor
     * <p/>
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        jLabelNConfirmedSeatsBalcony
                .setText(Integer.toString(theatreManager.getNCommittedSeats(theatreManager.BALCONY)));
     ...
     * Reset event handler.
     */
    private void jButtonResetFieldsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonResetFieldsActionPerformed
     ...
     */
    private void jButtonSetCircleActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSetCircleActionPerformed
     ...
     * Seat reservation event handler.
     */
    private void jButtonSetSallsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSetSallsActionPerformed
        String strNSeats = jTextFieldNewNTotalSeats.getText();
     ...
     * Seat reservation event handler.
     */
    private void jButtonSetBalconyActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSetBalconyActionPerformed
        String strNSeats = jTextFieldNewNTotalSeats.getText();
