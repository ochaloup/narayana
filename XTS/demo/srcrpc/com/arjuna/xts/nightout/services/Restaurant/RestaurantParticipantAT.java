...
/**
 * An adapter class that exposes the RestaurantManager transaction lifecycle API
 * as a WS-T Atomic Transaction participant. Also logs events to a
...
public class RestaurantParticipantAT implements Durable2PCParticipant, Serializable {
    ...
    /**
     * Shortcut method which combines the prepare and commit steps in a single
     * operation.
     *
     * @throws WrongStateException
     * @throws SystemException
