 ...
 * as a WS-T Business Activity participant. Also logs events to a RestaurantView
 * object.
 *
...
public class RestaurantParticipantBA implements BusinessAgreementWithParticipantCompletionParticipant, Serializable {
    ...
    public void compensate() throws FaultedException, WrongStateException, SystemException {
        ...
        getRestaurantView()
                .addPrepareMessage("id:" + txID + ". Compensate called on participant: " + this.getClass().toString());
