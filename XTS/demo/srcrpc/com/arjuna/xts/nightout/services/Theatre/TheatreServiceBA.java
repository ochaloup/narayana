...
public class TheatreServiceBA implements ITheatreServiceBA {
    ...
    public boolean bookSeats(int how_many, int which_area) {
        ...
        theatreView.addPrepareMessage("id:" + transactionId + ". Received a theatre booking request for " + how_many
        ...
        if (theatreManager.prepareSeats(transactionId)) {
            ...
            try {
                participantManager = activityManager.enlistForBusinessAgreementWithParticipantCompletion(
                        theatreParticipant, "com.arjuna.xts-demorpc:theatreBA:" + new Uid().toString());
            } catch (Exception e) {
