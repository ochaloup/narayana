 ...
 * WS-T Business Activity participant. Also logs events to a TaxiView object.
 *
...
public class TaxiParticipantBA implements BusinessAgreementWithParticipantCompletionParticipant, Serializable {
    ...
    public void close() throws WrongStateException, SystemException {
        // let the manager know that this activity no longer requires the option
        // of compensation

        System.out.println("TaxiParticipantBA.close");

        if (!getTaxiManager().closeTaxi(txID)) {
            // throw a WrongStateException to indicate that we were not
            // expecting a close
    ...
    public void compensate() throws FaultedException, WrongStateException, SystemException {
        ...
        try {
            if (!getTaxiManager().compensateTaxi(txID)) {
                ...
                // expecting a close
                System.out.println(
                        "RestaurantParticipantBA.compensate : not expecting a compensate for BA participant " + txID);
            ...
            getTaxiView().addMessage(
                    "id:" + txID + ". FaultedException when compensating participant: " + this.getClass().toString());
