...
public class BasicClient extends HttpServlet {
    ...
    private synchronized void initialise() throws ServletException {
        if (!initialised) {
            try {
                restaurantAT = (IRestaurantServiceAT) getService(RESTAURANT_SERVICE_AT, restaurantATURL,
                        IRestaurantServiceAT.class);
                restaurantBA = (IRestaurantServiceBA) getService(RESTAURANT_SERVICE_BA, restaurantBAURL,
                        IRestaurantServiceBA.class);
     ...
     */
    private void testAtomicTransaction(int restaurantSeats, int theatreSeats, int theatreArea, boolean bookTaxi)
            throws Exception {
     ...
     *             for any unexpected errors, such as a failure to commit.
     */
    private void testBusinessActivity(int restaurantSeats, int theatreSeats, int theatreArea, boolean bookTaxi)
            throws Exception {
     ...
     * 
     * @param jndiName
     *            The JNDI location of the service.
     * @param url
     *            The URL of the service.
     * @param portClass
     *            The port class type.
     * @throws NamingException
     *             For errors accessing JNDI.
     * @throws ServiceException
     *             For errors creating proxy.
