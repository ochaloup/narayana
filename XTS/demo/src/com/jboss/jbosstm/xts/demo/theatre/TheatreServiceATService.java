...
public class TheatreServiceATService extends Service {

    private final static URL THEATRESERVICEATSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger
            .getLogger(com.jboss.jbosstm.xts.demo.theatre.TheatreServiceATService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: '/WEB-INF/wsdl/TheatreServiceAT.wsdl', retrying as a local file");
    ...
    public TheatreServiceATService() {
        super(THEATRESERVICEATSERVICE_WSDL_LOCATION,
                new QName("http://www.jboss.com/jbosstm/xts/demo/Theatre", "TheatreServiceATService"));
    }

    /**
     * 
     * @return returns ITheatreServiceAT
     */
    @WebEndpoint(name = "TheatreServiceAT")
    public ITheatreServiceAT getTheatreServiceAT() {
        return super.getPort(new QName("http://www.jboss.com/jbosstm/xts/demo/Theatre", "TheatreServiceAT"),
