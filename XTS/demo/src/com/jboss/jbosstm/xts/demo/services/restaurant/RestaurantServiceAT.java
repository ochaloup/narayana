 ...
 */
@WebService(serviceName = "RestaurantServiceATService", portName = "RestaurantServiceAT", name = "IRestaurantServiceAT", targetNamespace = "http://www.jboss.com/jbosstm/xts/demo/Restaurant", wsdlLocation = "/WEB-INF/wsdl/RestaurantServiceAT.wsdl")
...
public class RestaurantServiceAT implements IRestaurantServiceAT {
     ...
     * necessary, then passes the call through to the business logic.
     *
     * @param how_many
    ...
    public void bookSeats(@WebParam(name = "how_many", partName = "how_many") int how_many) {
        ...
        try {
            ...
            TransactionManagerFactory.transactionManager().enlistForDurableTwoPhase(restaurantParticipant,
                    "org.jboss.jbossts.xts-demo:restaurantAT:" + new Uid().toString());
