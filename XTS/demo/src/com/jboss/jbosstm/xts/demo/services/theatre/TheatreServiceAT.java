 ...
 */
@WebService(serviceName = "TheatreServiceATService", portName = "TheatreServiceAT", name = "ITheatreServiceAT", targetNamespace = "http://www.jboss.com/jbosstm/xts/demo/Theatre", wsdlLocation = "/WEB-INF/wsdl/TheatreServiceAT.wsdl")
    ...
    public void bookSeats(@WebParam(name = "how_many", partName = "how_many") int how_many,
        ...
        try {
            ...
            if (theatreParticipant == null) {
                ...
                TransactionManagerFactory.transactionManager().enlistForDurableTwoPhase(theatreParticipant,
                        "org.jboss.jbossts.xts-demo:theatreAT:" + new Uid().toString());
        ...
        theatreView.addMessage("id:" + transactionId.toString() + ". Received a theatre booking request for " + how_many
