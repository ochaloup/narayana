...
/**
 * An adapter class that exposes the RestaurantManager as a WS-T Atomic
 * Transaction participant. Also logs events to a RestaurantView object.
 *
...
public class RestaurantParticipantAT implements Durable2PCParticipant, Serializable {
    ...
    public void rollback() throws WrongStateException, SystemException {
        ...
        getRestaurantView()
                .addMessage("id:" + txID + ". Rollback called on participant: " + this.getClass().toString());
