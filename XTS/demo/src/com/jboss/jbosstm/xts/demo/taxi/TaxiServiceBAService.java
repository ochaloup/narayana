...
public class TaxiServiceBAService extends Service {

    private final static URL TAXISERVICEBASERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger
            .getLogger(com.jboss.jbosstm.xts.demo.taxi.TaxiServiceBAService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: '/WEB-INF/wsdl/TaxiServiceBA.wsdl', retrying as a local file");
    ...
    public TaxiServiceBAService() {
        super(TAXISERVICEBASERVICE_WSDL_LOCATION,
                new QName("http://www.jboss.com/jbosstm/xts/demo/Taxi", "TaxiServiceBAService"));
    }

    /**
     * 
     * @return returns ITaxiServiceBA
     */
    @WebEndpoint(name = "TaxiServiceBA")
    public ITaxiServiceBA getTaxiServiceBA() {
        return super.getPort(new QName("http://www.jboss.com/jbosstm/xts/demo/Taxi", "TaxiServiceBA"),
