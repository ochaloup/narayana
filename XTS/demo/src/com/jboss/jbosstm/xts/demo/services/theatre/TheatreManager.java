 ...
 * <p/>
 * Stores and manages seating reservations. The theatre manager provides a book
 * method allowing the web service endpoint to book or unbook seats. It also
 * provides getters which allow the GUI to monitor the state of the service
...
public class TheatreManager extends ServiceStateManager<TheatreState> {
    ...
    public synchronized void bookSeats(Object txID, int nSeats, int area) {
        ...
        if (childState != null) {
            ...
            // see if we can derive a new state from the current state which
    ...
    /**
     * Create and initialise a new TheatreManager instance. If the super
