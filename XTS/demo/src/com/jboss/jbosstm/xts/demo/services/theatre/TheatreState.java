...
/**
 * An object which models the state of a restaurant identifying the number of
 * free and booked seats and the total available
 */
public class TheatreState extends ServiceState {
     ...
     *
     * @param parent
     *            the parent state whose data should be copied into this state
     *            and whose version should be incremented by 1 and then
