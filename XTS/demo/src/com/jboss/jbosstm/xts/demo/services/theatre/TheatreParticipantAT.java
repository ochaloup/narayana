...
/**
 * An adapter class that exposes the TheatreManager as a WS-T Atomic Transaction
 * participant. Also logs events to a TheatreView object.
 *
...
public class TheatreParticipantAT implements Durable2PCParticipant, Serializable {
    ...
    /************************************************************************/
    /**
     * Participant instances are related to transaction instances in a one to
     * one manner.
     *
     * @param txID
    ...
    /************************************************************************/
    /**
     * Invokes the prepare step of the business logic, reporting activity and
     * outcome.
     *
    ...
    public Vote prepare() throws WrongStateException, SystemException {
        ...
        getTheatreView()
                .addPrepareMessage("id:" + txID + ". Prepare called on participant: " + this.getClass().toString());
    ...
    /**
     * Invokes the commit step of the business logic, reporting activity and
     * outcome.
     *
     * @throws WrongStateException
     * @throws SystemException
    ...
    /**
     * Invokes the rollback operation on the business logic, reporting activity
     * and outcome.
     *
     * @throws WrongStateException
     * @throws SystemException
     ...
     * the service (via contrtuctor) at enrolment time, this value is passed to
     * the backend business logic methods.
     */
    ...
    /**
     * this is true by default but we invalidate the participant if the client
     * makes invalid requests
     */
