...
public class DemoATRecoveryModule implements XTSATRecoveryModule {
     ...
     * @return a recovered durable participant if the id belongs to this
     ...
     * in case the participant was originally saved after being converted to a
     * byte array using the PersistibleATParticipant interface.
     *
     * @param id
     *            the id used when the participant was created
     * @param recoveryState
    ...
    public void endScan() {
        if (isFirst) {
            // let the restaurant and theatre state manager know that the AT log
