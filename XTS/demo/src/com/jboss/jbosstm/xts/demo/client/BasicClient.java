...
/**
 * A very basic client application that drives the (transactional) Web Services
...
public class BasicClient extends HttpServlet {
     ...
     */
    private static final QName RESTAURANT_SERVICE_AT_QNAME = new QName(RESTAURANT_NS, RESTAURANT_SERVICE_AT,
            RESTAURANT_PREFIX);
    /**
     ...
     * The QName for the AT Restaurant webservice.
     */
    private static final QName RESTAURANT_SERVICE_BA_QNAME = new QName(RESTAURANT_NS, RESTAURANT_SERVICE_BA,
            RESTAURANT_PREFIX);
    /**
     ...
     */
    private static final QName RESTAURANT_ENDPOINT_AT_QNAME = new QName(RESTAURANT_NS, RESTAURANT_ENDPOINT_AT,
            RESTAURANT_PREFIX);
    /**
     ...
     */
    private static final QName RESTAURANT_ENDPOINT_BA_QNAME = new QName(RESTAURANT_NS, RESTAURANT_ENDPOINT_BA,
            RESTAURANT_PREFIX);
     ...
     */
    private static final QName THEATRE_SERVICE_AT_QNAME = new QName(THEATRE_NS, THEATRE_SERVICE_AT, THEATRE_PREFIX);
    /**
     ...
     * The QName for the AT Theatre webservice.
     */
    private static final QName THEATRE_SERVICE_BA_QNAME = new QName(THEATRE_NS, THEATRE_SERVICE_BA, THEATRE_PREFIX);
    /**
     ...
     */
    private static final QName THEATRE_ENDPOINT_AT_QNAME = new QName(THEATRE_NS, THEATRE_ENDPOINT_AT, THEATRE_PREFIX);
    /**
     ...
     */
    private static final QName THEATRE_ENDPOINT_BA_QNAME = new QName(THEATRE_NS, THEATRE_ENDPOINT_BA, THEATRE_PREFIX);
     ...
     */
    private static final QName TAXI_SERVICE_AT_QNAME = new QName(TAXI_NS, TAXI_SERVICE_AT, TAXI_PREFIX);
    /**
     ...
     * The QName for the AT Taxi webservice.
     */
    private static final QName TAXI_SERVICE_BA_QNAME = new QName(TAXI_NS, TAXI_SERVICE_BA, TAXI_PREFIX);
    /**
     ...
     */
    private static final QName TAXI_ENDPOINT_AT_QNAME = new QName(TAXI_NS, TAXI_ENDPOINT_AT, TAXI_PREFIX);
    /**
     ...
     */
    private static final QName TAXI_ENDPOINT_BA_QNAME = new QName(TAXI_NS, TAXI_ENDPOINT_BA, TAXI_PREFIX);
    ...
    private synchronized void initialise() throws ServletException {
        if (!initialised) {
            try {
                restaurantAT = getService(RESTAURANT_SERVICE_AT_QNAME, RESTAURANT_ENDPOINT_AT_QNAME, restaurantATURL,
                        restaurantATWSDL, IRestaurantServiceAT.class);
                configureClientHandler((BindingProvider) restaurantAT);

                restaurantBA = getService(RESTAURANT_SERVICE_BA_QNAME, RESTAURANT_ENDPOINT_BA_QNAME, restaurantBAURL,
                        restaurantBAWSDL, IRestaurantServiceBA.class);
                configureClientHandler((BindingProvider) restaurantBA);

                theatreAT = getService(THEATRE_SERVICE_AT_QNAME, THEATRE_ENDPOINT_AT_QNAME, theatreATURL, theatreATWSDL,
                        ITheatreServiceAT.class);
                configureClientHandler((BindingProvider) theatreAT);

                theatreBA = getService(THEATRE_SERVICE_BA_QNAME, THEATRE_ENDPOINT_BA_QNAME, theatreBAURL, theatreBAWSDL,
                        ITheatreServiceBA.class);
                configureClientHandler((BindingProvider) theatreBA);

                taxiAT = getService(TAXI_SERVICE_AT_QNAME, TAXI_ENDPOINT_AT_QNAME, taxiATURL, taxiATWSDL,
                        ITaxiServiceAT.class);
                configureClientHandler((BindingProvider) taxiAT);

                taxiBA = getService(TAXI_SERVICE_BA_QNAME, TAXI_ENDPOINT_BA_QNAME, taxiBAURL, taxiBAWSDL,
                        ITaxiServiceBA.class);
    ...
    /**
     * Simple wrapper to allow our test method to be invoked when running in a
     * servlet container, taking parameters from the request URL and displaying
     * the outcome on the resulting html page.
     *
     * @param request
     * @param response
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if ("AtomicTransaction".equals(txType)) {
                testAtomicTransaction(restaurantSeats, theatreCircleSeats, theatreStallsSeats, theatreBalconySeats,
                        bookTaxi);
            } else if ("BusinessActivity".equals(txType)) {
                if (!testBusinessActivity(restaurantSeats, theatreCircleSeats, theatreStallsSeats, theatreBalconySeats,
                        bookTaxi)) {
    ...
    /**
     * Run a simple transaction involving three Web Services. Use the Atomic
     * Transaction type.
     * <p/>
     * Note: due to the implementation of the transaction infrastructure, this
     * method must be invoked with a web application container. It will not run
     * correctly in a standalone java application.
     *
     * @throws Exception
     *             for any unexpected errors, such as a failure to commit.
     */
    private void testAtomicTransaction(int restaurantSeats, int theatreCircleSeats, int theatreStallsSeats,
            int theatreBalconySeats, boolean bookTaxi) throws Exception {
    ...
    /**
     * Run a simple transaction involving three Web Services. Use the Business
     * Activity type.
     * <p/>
     * Note: due to the implementation of the transaction infrastructure, this
     * method must be invoked with a web application container. It will not run
     ...
     *             for any unexpected errors, such as a failure to commit.
     */
    private boolean testBusinessActivity(int restaurantSeats, int theatreCircleSeats, int theatreStallsSeats,
            int theatreBalconySeats, boolean bookTaxi) throws Exception {
     ...
     * @param defaultValue
     *            The default value.
     * @return The initialisation property value or the default value if not
     *         present.
     */
    ...
    /**
     * Get an endpoint reference for a service so we can create a JaxWS port for
     * it
     * 
     * @param serviceName
     *            the QName of the service in question..
     * @param endpointName
     *            the QName of the endpoint associated with the service
     * @param address
     *            a string representation of the service URL. null is ok if this
     *            is a service located in the same app as the client
     * @return a W3CEndpointReference from which the service port can be
     *         obtained.
     */
    private <T> T getService(final QName serviceName, final QName endpointName, final String address,
            final String wsdlURL, final Class<T> clazz) throws MalformedURLException {
