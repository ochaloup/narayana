...
public class RestaurantServiceATService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(com.jboss.jbosstm.xts.demo.restaurant.RestaurantServiceATService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: '/WEB-INF/wsdl/RestaurantServiceAT.wsdl', retrying as a local file");
    ...
    public RestaurantServiceATService() {
        super(RESTAURANTSERVICEATSERVICE_WSDL_LOCATION,
                new QName("http://www.jboss.com/jbosstm/xts/demo/Restaurant", "RestaurantServiceATService"));
    }

    /**
     * 
     * @return returns IRestaurantServiceAT
     */
    @WebEndpoint(name = "RestaurantServiceAT")
    public IRestaurantServiceAT getRestaurantServiceAT() {
        return super.getPort(new QName("http://www.jboss.com/jbosstm/xts/demo/Restaurant", "RestaurantServiceAT"),
