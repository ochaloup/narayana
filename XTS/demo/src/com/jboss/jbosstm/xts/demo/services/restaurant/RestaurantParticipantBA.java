...
/**
 * An adapter class that exposes the RestaurantManager as a WS-T Participant
 * Completion Business Activity participant. Also logs events to a
 * RestaurantView object.
 *
 * The Restaurant Service only allows a single booking in any given transaction.
 * So, this means it can complete at the end of the booking call. Hence it uses
 * a participant which implements the participant completion protocol.
 *
...
public class RestaurantParticipantBA
    ...
    public void compensate() throws FaultedException, WrongStateException, SystemException {
        ...
        getRestaurantView().addPrepareMessage(
                "id:" + txID + ". Attempting to compensate participant: " + this.getClass().toString());

        getRestaurantView().updateFields();

        // we perform the compensation by preparing and then committing a local
        // change which
    ...
    public void error() throws SystemException {
        ...
        getRestaurantView()
                .addMessage("id:" + txID + ". Received error for participant: " + this.getClass().toString());
        ...
        getRestaurantView()
                .addMessage("id:" + txID + ". Notified error for participant: " + this.getClass().toString());
     ...
     * the service (via constructor) at enrolment time, this value is used in
