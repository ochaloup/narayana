...
public class TestParticipantCompletionParticipantProcessor extends ParticipantCompletionParticipantProcessor {
    ...
    public ParticipantCompletionParticipantDetails getParticipantCompletionParticipantDetails(final String messageId,
            final long timeout) {
        final long endTime = System.currentTimeMillis() + timeout;
        synchronized (messageIdMap) {
            long now = System.currentTimeMillis();
            while (now < endTime) {
                final ParticipantCompletionParticipantDetails details = (ParticipantCompletionParticipantDetails) messageIdMap
                        .remove(messageId);
                if (details != null) {
                    return details;
                }
    ...
    public void cancel(NotificationType cancel, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        ...
        final ParticipantCompletionParticipantDetails details = new ParticipantCompletionParticipantDetails(
    ...
    public static class ParticipantCompletionParticipantDetails {
        ...
        ParticipantCompletionParticipantDetails(final AddressingContext addressingContext,
