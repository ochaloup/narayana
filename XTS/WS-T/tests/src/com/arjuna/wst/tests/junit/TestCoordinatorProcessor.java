...
public class TestCoordinatorProcessor extends CoordinatorProcessor {
    ...
    public void aborted(NotificationType aborted, AddressingContext addressingContext, ArjunaContext arjunaContext) {
    ...
    public void committed(NotificationType committed, AddressingContext addressingContext,
    ...
    public void prepared(NotificationType prepared, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        final String messageId = addressingContext.getMessageID().getValue();
        final CoordinatorDetails details = new CoordinatorDetails(addressingContext, arjunaContext);
    ...
    public void readOnly(NotificationType readOnly, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        final String messageId = addressingContext.getMessageID().getValue();
        final CoordinatorDetails details = new CoordinatorDetails(addressingContext, arjunaContext);
    ...
    public void replay(NotificationType replay, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        final String messageId = addressingContext.getMessageID().getValue();
        final CoordinatorDetails details = new CoordinatorDetails(addressingContext, arjunaContext);
