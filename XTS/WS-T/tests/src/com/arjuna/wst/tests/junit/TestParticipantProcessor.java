...
public class TestParticipantProcessor extends ParticipantProcessor {
    ...
    public void commit(NotificationType commit, AddressingContext addressingContext, ArjunaContext arjunaContext) {
    ...
    public void prepare(NotificationType prepare, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        final String messageId = addressingContext.getMessageID().getValue();
        final ParticipantDetails details = new ParticipantDetails(addressingContext, arjunaContext);
    ...
    public void rollback(NotificationType rollback, AddressingContext addressingContext, ArjunaContext arjunaContext) {
        final String messageId = addressingContext.getMessageID().getValue();
        final ParticipantDetails details = new ParticipantDetails(addressingContext, arjunaContext);
