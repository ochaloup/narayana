...
public class BusinessAgreementWithParticipantCompletionCoordinatorTestCase {
    ...
    public void setUp() throws Exception {
        origParticipantCompletionParticipantProcessor = ParticipantCompletionParticipantProcessor
                .setProcessor(testParticipantCompletionParticipantProcessor);
    ...
    public void testSendClose() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendClose(addressingContext,
                new InstanceIdentifier("sender"));

        final ParticipantCompletionParticipantDetails details = testParticipantCompletionParticipantProcessor
                .getParticipantCompletionParticipantDetails(messageId, 10000);
    ...
    public void testSendCancel() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendCancel(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendCompensate() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendCompensate(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendFaulted() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendFaulted(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendExited() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendExited(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendStatus() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendStatus(addressingContext,
    ...
    public void testSendGetStatus() throws Exception {
        ...
        ParticipantCompletionParticipantClient.getClient().sendGetStatus(addressingContext,
                new InstanceIdentifier("sender"));
     ...
     * "testSendGetStatus" ; final AddressingContext addressingContext =
     * AddressingContext.createRequestContext(
     * participantCompletionParticipantServiceURI, messageId) ; final
     ...
     * 
     * ParticipantCompletionParticipantClient.getClient().sendSoapFault(
     * addressingContext, soapFault, instanceIdentifier) ;
     * 
     * final ParticipantCompletionParticipantDetails details =
     * testParticipantCompletionParticipantProcessor.
     * getParticipantCompletionParticipantDetails(messageId, 10000) ;
     * 
    ...
    private void checkDetails(ParticipantCompletionParticipantDetails details, boolean replyTo, String messageId,
