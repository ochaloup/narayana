...
public class TwoPCParticipantTestCase {
    ...
    @Test
    public void testSendReplay() throws Exception {
    ...
    public void testSendError() throws Exception {
        final String messageId = "testSendReplay";
        final AddressingContext addressingContext = AddressingContext.createRequestContext(coordinatorServiceURI,
                messageId);
        final InstanceIdentifier instanceIdentifier = new InstanceIdentifier("5");
        ...
        // for this test we use the soap fault client to send a message where we
        // have no valid instance identifier
        // we could also test the case where we have an instance identifier but
        // it never gets exercised anyway!
    ...
    private void checkDetails(CoordinatorDetails details, boolean replyTo, String messageId,
