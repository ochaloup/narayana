...
public class TestParticipantCompletionCoordinatorProcessor extends ParticipantCompletionCoordinatorProcessor {
    ...
    public void cancelled(NotificationType cancelled, AddressingContext addressingContext,
        ...
        final ParticipantCompletionCoordinatorDetails details = new ParticipantCompletionCoordinatorDetails(
    ...
    public static class ParticipantCompletionCoordinatorDetails {
        ...
        ParticipantCompletionCoordinatorDetails(final AddressingContext addressingContext,
