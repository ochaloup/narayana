...
@RunWith(Suite.class)
@Suite.SuiteClasses({CompletionParticipantTestCase.class, CompletionParticipantTestCase.class,
        TwoPCParticipantTestCase.class, TwoPCCoordinatorTestCase.class, CompletionServiceTestCase.class,
