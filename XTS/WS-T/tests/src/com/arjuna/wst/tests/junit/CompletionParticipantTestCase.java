...
public class CompletionParticipantTestCase {
    ...
    public void setUp() throws Exception {
        ...
        completionCoordinatorService = soapRegistry
    ...
    public void testSendCommit() throws Exception {
        ...
        final AddressingContext addressingContext = AddressingContext.createRequestContext(completionCoordinatorService,
                messageId);
