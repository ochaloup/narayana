...
public class BusinessAgreementWithCoordinatorCompletionParticipantTestCase {
    ...
    public void setUp() throws Exception {
        origCoordinatorCompletionCoordinatorProcessor = CoordinatorCompletionCoordinatorProcessor
                .setProcessor(testCoordinatorCompletionCoordinatorProcessor);
        final SoapRegistry soapRegistry = SoapRegistry.getRegistry();
        coordinatorCompletionCoordinatorServiceURI = soapRegistry
                .getServiceURI(BusinessActivityConstants.SERVICE_COORDINATOR_COMPLETION_COORDINATOR);
        coordinatorCompletionParticipantServiceURI = soapRegistry
    ...
    public void testSendClosed() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendClosed(addressingContext,
                new InstanceIdentifier("sender"));

        CoordinatorCompletionCoordinatorDetails details = testCoordinatorCompletionCoordinatorProcessor
                .getCoordinatorCompletionCoordinatorDetails(messageId, 10000);
    ...
    public void testSendCancelled() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendCancelled(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendCompensated() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendCompensated(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendFault() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendFault(addressingContext,
                new InstanceIdentifier("sender"), exceptionIdentifier);
    ...
    public void testSendCompleted() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendCompleted(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendStatus() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendStatus(addressingContext,
                new InstanceIdentifier("sender"), state);
    ...
    /*
     * cannot test this any longer as client does not provide API to send soap
     * fault
     * 
     * public void testSendError() throws Exception { final String messageId =
     * "testSendError" ; final AddressingContext addressingContext =
     * AddressingContext.createRequestContext(
     * coordinatorCompletionParticipantServiceURI, messageId) ; final
     * InstanceIdentifier instanceIdentifier = new InstanceIdentifier("7") ;
     * final String reason = "testSendErrorReason" ; final SoapFaultType
     * soapFaultType = SoapFaultType.FAULT_SENDER ; final QName subcode =
     * ArjunaTXConstants.UNKNOWNERROR_ERROR_CODE_QNAME ; final SoapFault
     * soapFault = new SoapFault(soapFaultType, subcode, reason) ;
     * 
     * CoordinatorCompletionCoordinatorClient.getClient().sendSoapFault(
     * addressingContext, soapFault, instanceIdentifier) ;
     * 
     * final CoordinatorCompletionCoordinatorDetails details =
     * testCoordinatorCompletionCoordinatorProcessor.
     * getCoordinatorCompletionCoordinatorDetails(messageId, 10000) ;
     * 
    ...
    public void testSendExit() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendExit(addressingContext,
                new InstanceIdentifier("sender"));

        final CoordinatorCompletionCoordinatorDetails details = testCoordinatorCompletionCoordinatorProcessor
                .getCoordinatorCompletionCoordinatorDetails(messageId, 10000);
    ...
    public void testSendGetStatus() throws Exception {
        ...
        CoordinatorCompletionCoordinatorClient.getClient().sendGetStatus(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    /**
     * check the message details to see that they have the correct to and from
     * address and message id, a null reply to address and an arjuna context
     * containing the correct instannce identifier
     * 
     * @param details
     * @param messageId
    ...
    private void checkDetails(CoordinatorCompletionCoordinatorDetails details, boolean replyTo, String messageId,
        ...
        if (replyTo) {
            assertEquals(inAddressingContext.getReplyTo().getAddress().getValue(),
