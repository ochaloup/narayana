...
public class TwoPCCoordinatorTestCase {
    ...
    public void testSendPrepare() throws Exception {
        ...
        final AddressingContext addressingContext = AddressingContext.createRequestContext(participanURIService,
                messageId);
    ...
    private void checkDetails(ParticipantDetails details, boolean replyTo, String messageId,
