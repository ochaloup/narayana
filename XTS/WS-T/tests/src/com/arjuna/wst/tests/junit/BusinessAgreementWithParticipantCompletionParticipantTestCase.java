...
public class BusinessAgreementWithParticipantCompletionParticipantTestCase {
    ...
    public void setUp() throws Exception {
        origParticipantCompletionCoordinatorProcessor = ParticipantCompletionCoordinatorProcessor
                .setProcessor(testParticipantCompletionCoordinatorProcessor);
        final SoapRegistry soapRegistry = SoapRegistry.getRegistry();
        participantCompletionCoordinatorServiceURI = soapRegistry
                .getServiceURI(BusinessActivityConstants.SERVICE_PARTICIPANT_COMPLETION_COORDINATOR);
        participantCompletionParticipantServiceURI = soapRegistry
    ...
    public void testSendClosed() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendClosed(addressingContext,
                new InstanceIdentifier("sender"));

        final ParticipantCompletionCoordinatorDetails details = testParticipantCompletionCoordinatorProcessor
                .getParticipantCompletionCoordinatorDetails(messageId, 10000);
    ...
    public void testSendCancelled() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendCancelled(addressingContext,
                new InstanceIdentifier("sender"));;
    ...
    public void testSendCompensated() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendCompensated(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendCompleted() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendCompleted(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendStatus() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendStatus(addressingContext,
     ...
     * participantCompletionCoordinatorServiceURI, messageId) ; final
     ...
     * 
     * ParticipantCompletionCoordinatorClient.getClient().sendSoapFault(
     * addressingContext, instanceIdentifier, soapFault) ;
     * 
     * final ParticipantCompletionCoordinatorDetails details =
     * testParticipantCompletionCoordinatorProcessor.
     * getParticipantCompletionCoordinatorDetails(messageId, 10000) ;
     * 
     * assertNotNull(details.hasSoapFault()) ;
     * assertEquals(details.hasSoapFault().getSoapFaultType(),
     * soapFault.getSoapFaultType()) ;
    ...
    public void testSendExit() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendExit(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendFault() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendFault(addressingContext,
    ...
    public void testSendGetStatus() throws Exception {
        ...
        ParticipantCompletionCoordinatorClient.getClient().sendGetStatus(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    private void checkDetails(ParticipantCompletionCoordinatorDetails details, boolean replyTo, String messageId,
