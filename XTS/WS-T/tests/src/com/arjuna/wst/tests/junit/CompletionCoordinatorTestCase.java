...
public class CompletionCoordinatorTestCase {
    ...
    public void setUp() throws Exception {
        ...
        completionInitiatorServiceURI = soapRegistry
                .getServiceURI(AtomicTransactionConstants.SERVICE_COMPLETION_INITIATOR);
        completionCoordinatorServiceURI = soapRegistry
    ...
    public void testSendCommitted() throws Exception {
        ...
        final EndpointReferenceType completionInitiatorService = new EndpointReferenceType(
                new AttributedURIType(completionInitiatorServiceURI));
        InstanceIdentifier.setEndpointInstanceIdentifier(completionInitiatorService, instanceIdentifier);
        final AddressingContext addressingContext = AddressingContext.createRequestContext(completionInitiatorService,
                messageId);
    ...
    public void testSendError() throws Exception {
        ...
        try {
            CompletionInitiatorClient.getClient().sendSoapFault(addressingContext, soapFault,
