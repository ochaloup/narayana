...
public class BusinessAgreementWithCoordinatorCompletionCoordinatorTestCase {
    ...
    public void setUp() throws Exception {
        origCoordinatorCompletionParticipantProcessor = CoordinatorCompletionParticipantProcessor
                .setProcessor(testCoordinatorCompletionParticipantProcessor);
    ...
    public void testSendClose() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendClose(addressingContext,
                new InstanceIdentifier("sender"));

        final CoordinatorCompletionParticipantDetails details = testCoordinatorCompletionParticipantProcessor
                .getCoordinatorCompletionParticipantDetails(messageId, 10000);
    ...
    public void testSendCancel() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendCancel(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendCompensate() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendCompensate(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendFaulted() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendFaulted(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendExited() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendExited(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendStatus() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendStatus(addressingContext,
    ...
    public void testSendComplete() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendComplete(addressingContext,
                new InstanceIdentifier("sender"));
    ...
    public void testSendGetStatus() throws Exception {
        ...
        CoordinatorCompletionParticipantClient.getClient().sendGetStatus(addressingContext,
                new InstanceIdentifier("sender"));
     ...
     * fault
     * 
     * @Test public void testSendError() throws Exception { final String
     * messageId = "testSendError" ; final AddressingContext addressingContext =
     ...
     * 
     * CoordinatorCompletionParticipantClient.getClient().sendSoapFault(
     * addressingContext, soapFault, instanceIdentifier) ;
     * 
     * final CoordinatorCompletionParticipantDetails details =
    ...
    private void checkDetails(CoordinatorCompletionParticipantDetails details, boolean replyTo, String messageId,
