...
@RunWith(Suite.class)
@Suite.SuiteClasses({CompletionParticipantTestCase.class, CompletionCoordinatorTestCase.class,
        TwoPCParticipantTestCase.class, TwoPCCoordinatorTestCase.class,
