...
public class TerminationParticipantService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(com.arjuna.schemas.ws._2005._10.wsarjtx.TerminationParticipantService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsarjtx-termination-participant-binding.wsdl', retrying as a local file");
    ...
    public TerminationParticipantService() {
        super(TERMINATIONPARTICIPANTSERVICE_WSDL_LOCATION,
                new QName("http://schemas.arjuna.com/ws/2005/10/wsarjtx", "TerminationParticipantService"));
    }

    /**
     * 
     * @return returns TerminationParticipantPortType
     */
    ...
    public TerminationParticipantPortType getTerminationParticipantPortType() {
        return super.getPort(
                new QName("http://schemas.arjuna.com/ws/2005/10/wsarjtx", "TerminationParticipantPortType"),
                TerminationParticipantPortType.class);
    }
    ...
    public TerminationParticipantPortType getTerminationParticipantPortType(WebServiceFeature... features) {
        return super.getPort(
                new QName("http://schemas.arjuna.com/ws/2005/10/wsarjtx", "TerminationParticipantPortType"),
                TerminationParticipantPortType.class, features);
    }
