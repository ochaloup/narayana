...
public interface ArjunaTXConstants {
     ...
     */
    public QName WSARJTX_ELEMENT_TERMINATION_SERVICE_QNAME = new QName(WSARJTX_NAMESPACE,
            WSARJTX_ELEMENT_TERMINATION_SERVICE, WSARJTX_PREFIX);
     ...
     * The Complete QName.
     */
    public QName WSARJTX_ELEMENT_COMPLETE_QNAME = new QName(WSARJTX_NAMESPACE, WSARJTX_ELEMENT_COMPLETE,
            WSARJTX_PREFIX);
    /**
     * The Complete Action.
     */
     ...
     * The Completed QName.
     */
    public QName WSARJTX_ELEMENT_COMPLETED_QNAME = new QName(WSARJTX_NAMESPACE, WSARJTX_ELEMENT_COMPLETED,
            WSARJTX_PREFIX);
    /**
     ...
     * The Cancelled QName.
     */
    public QName WSARJTX_ELEMENT_CANCELLED_QNAME = new QName(WSARJTX_NAMESPACE, WSARJTX_ELEMENT_CANCELLED,
            WSARJTX_PREFIX);
    /**
     ...
     * The unknown transaction error code.
     */
    public static final QName UNKNOWNTRANSACTION_ERROR_CODE_QNAME = new QName(WSARJTX_NAMESPACE,
            UNKNOWNTRANSACTION_ERROR_CODE, WSARJTX_PREFIX);
    /**
     ...
     * The transaction rolled back error code.
     */
    public static final QName TRANSACTIONROLLEDBACK_ERROR_CODE_QNAME = new QName(WSARJTX_NAMESPACE,
            TRANSACTIONROLLEDBACK_ERROR_CODE, WSARJTX_PREFIX);
    /**
     ...
     * The wrong state error code.
     */
    public static final QName WRONGSTATE_ERROR_CODE_QNAME = new QName(WSARJTX_NAMESPACE, WRONGSTATE_ERROR_CODE,
            WSARJTX_PREFIX);
    /**
     ...
     */
    public static final QName FAULTED_ERROR_CODE_QNAME = new QName(WSARJTX_NAMESPACE, FAULTED_ERROR_CODE,
            WSARJTX_PREFIX);
     ...
     * The unknown error error code.
     */
    public static final QName UNKNOWNERROR_ERROR_CODE_QNAME = new QName(WSARJTX_NAMESPACE, UNKNOWNERROR_ERROR_CODE,
            WSARJTX_PREFIX);
