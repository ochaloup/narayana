...
public class BACoordinatorCompletionParticipantManagerStub implements BAParticipantManager {
    ...
    public void exit() throws WrongStateException, UnknownTransactionException, SystemException {
         ...
         * Faulting-Compensating -> illegal state Exiting -> no response Ended
         * -> ended
         */
    ...
    public void cannotComplete() throws WrongStateException, UnknownTransactionException, SystemException {
        /*
         * Active -> illegal state Canceling -> illegal state Completing ->
         * illegal state Completed -> illegal state Closing -> illegal state
         * Compensating -> illegal state Failing-Active -> illegal state
         * Failing-Canceling -> illegal state Failing-Completing -> illegal
         * state Failing-Compensating -> illegal state NotCompleting -> no
         * response Exiting -> illegal state Ended -> ended
         */
    ...
    public void fail(final QName exceptionIdentifier) throws SystemException {
         ...
         * Active -> illegal state Canceling -> illegal state Completing ->
         * illegal state Completed -> illegal state Closing -> illegal state
         * Compensating -> illegal state Failing-Active -> no response
         * Failing-Canceling -> no response Failing-Completing -> no response
