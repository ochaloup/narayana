...
public class BusinessAgreementWithParticipantCompletionStub
    ...
    public synchronized void close() throws WrongStateException, SystemException {
         ...
         * illegal state Closing -> no response Compensating -> illegal state
         * Faulting -> illegal state Faulting-Active -> illegal state
         * Faulting-Compensating -> illegal state Exiting -> illegal state Ended
         * -> ended
         */
    ...
    public synchronized void cancel() throws FaultedException, WrongStateException, SystemException {
        /*
         * Active -> illegal state Canceling -> no response Completed -> illegal
         * state Closing -> illegal state Compensating -> illegal state Faulting
         * -> illegal state Faulting-Active -> illegal state
         * Faulting-Compensating -> illegal state Exiting -> illegal state Ended
         * -> ended
         */
    ...
    public synchronized void compensate() throws FaultedException, WrongStateException, SystemException {
        /*
         * Active -> illegal state Canceling -> illegal state Completed ->
         * illegal state Closing -> illegal state Compensating -> no answer
         * Faulting -> illegal state Faulting-Active -> illegal state
         * Faulting-Compensating -> fault Exiting -> illegal state Ended ->
         * ended
         */
    ...
    public boolean restoreState(final InputObjectState ios) {
        try {
            ...
            participant = (ParticipantCompletionCoordinatorEngine) ParticipantCompletionCoordinatorProcessor
