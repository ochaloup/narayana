...
public class BusinessActivityTerminatorStub implements BusinessActivityTerminator {
    ...
    public void close() throws TransactionRolledBackException, UnknownTransactionException, SystemException {
        ...
        final TerminationParticipantProcessor terminationParticipantProcessor = TerminationParticipantProcessor
                .getProcessor();
        terminationParticipantProcessor.registerCallback(_id, callback);
        try {
            TerminationCoordinatorClient.getClient().sendClose(_terminationCoordinator, map,
    ...
    public void cancel() throws FaultedException, UnknownTransactionException, SystemException {
        ...
        terminationParticipantProcessor.registerCallback(_id, callback);
        try {
            TerminationCoordinatorClient.getClient().sendCancel(_terminationCoordinator, map,
                    new InstanceIdentifier(_id));
            callback.waitUntilTriggered();
        } catch (final Throwable th) {
            throw new SystemException();
    ...
    public void complete() throws FaultedException, UnknownTransactionException, SystemException {
        ...
        terminationParticipantProcessor.registerCallback(_id, callback);
        try {
            TerminationCoordinatorClient.getClient().sendComplete(_terminationCoordinator, map,
                    new InstanceIdentifier(_id));
            callback.waitUntilTriggered();
        } catch (final Throwable th) {
            throw new SystemException();
    ...
    private static class RequestCallback extends TerminationParticipantCallback {
         ...
         *            The arjuna context.
         */
        public void faulted(final NotificationType faulted, final MAP map, final ArjunaContext arjunaContext) {
            // TODO - convert wsdl to use NotificationType instead of
            // ExceptionType
            this.faulted = true;
            this.map = map;
            this.arjunaContext = arjunaContext;
