...
public class CoordinatorCompletionCoordinatorEngine implements CoordinatorCompletionCoordinatorInboundEvents {
     ...
     *            Ended Canceling-Completing -&gt; Ended Completing -&gt;
     *            Completing (invalid state) Completed -&gt; Completed (invalid
     *            state) Closing -&gt; Closing (invalid state) Compensating
     ...
     *            Canceling-Completing (invalid state) Completing -&gt;
     *            Completing (invalid state) Completed -&gt; Completed (invalid
     *            state) Closing -&gt; Ended Compensating -&gt; Compensating
     ...
     *            Completing (invalid state) Completed -&gt; Completed (invalid
     *            state) Closing -&gt; Closing (invalid state) Compensating
     *            -&gt; Ended Failing-Active -&gt; Failing-Active (invalid
     *            state) Failing-Canceling -&gt; Failing-Canceling (invalid
     *            state) Failing-Completing -&gt; Failing-Completing (invalid
     *            state) Failing-Compensating -&gt; Failing-Compensating
     *            (invalid state) NotCompleting -&gt; NotCompleting (invalid
     ...
     *            -&gt; Exiting Canceling-Completing -&gt; Exiting Completing
     *            -&gt; Exiting Completed -&gt; Completed (invalid state)
     *            Closing -&gt; Closing (invalid state) Compensating -&gt;
     *            Compensating (invalid state) Faulting -&gt; Faulting (invalid
     *            state) Faulting-Active -&gt; Faulting (invalid state)
     *            Faulting-Compensating -&gt; Faulting (invalid state) Exiting
     *            -&gt; Exiting Ended -&gt; Ended (resend Exited)
     */
     ...
     *            The arjuna context.
     *
     *            Active -&gt; Failing-Active Canceling-Active -&gt;
     *            Failing-Canceling Canceling-Completing -&gt; Failing-Canceling
     *            Completing -&gt; Failing-Completing Completed -&gt; Completed
     *            (invalid state) Closing -&gt; Closing (invalid state)
     ...
     *            -&gt; NotCompleting (invalid state) Exiting -&gt; Exiting
     *            (invalid state) Ended -&gt; Ended (resend Failed)
     *
     ...
     *            NotCompleting Completed -&gt; Completed (invalid state)
     *            Closing -&gt; Closing (invalid state) Compensating -&gt;
     *            Compensating (invalid state) Failing-Active -&gt;
     *            Failing-Active (invalid state) Failing-Canceling -&gt;
     *            Failing-Canceling (invalid state) Failing-Completing -&gt;
     *            Failing-Completing (invalid state) Failing-Compensating -&gt;
     *            Failing-Compensating (invalid state) NotCompleting -&gt;
     *            NotCompleting Exiting -&gt; Exiting (invalid state) Ended
     *            -&gt; Ended (resend NotCompleted)
     */
     ...
     * @return The state.
     *
     *         Active -&gt; Canceling-Active Canceling-Active -&gt;
     *         Canceling-Active Canceling-Completing -&gt; Canceling-Completing
     *         Completing -&gt; Canceling-Completing Completed -&gt; Completed
     *         (invalid state) Closing -&gt; Closing (invalid state)
     ...
     *         (invalid state) Completing -&gt; Completing Completed -&gt;
