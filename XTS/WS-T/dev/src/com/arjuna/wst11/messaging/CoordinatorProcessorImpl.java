...
public class CoordinatorProcessorImpl extends CoordinatorProcessor {
     ...
     * 
     * @param identifier
     *            The coordinator identifier as a String.
     ...
     *            The coordinator identifier as an Instanceidentifier.
     * @return The coordinator or null if not known.
     */
    ...
    public void committed(final Notification committed, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (coordinator != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_CoordinatorProcessorImpl_committed_2(instanceIdentifier.toString());
        }
    }
    ...
    public void prepared(final Notification prepared, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (coordinator != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_CoordinatorProcessorImpl_prepared_2(instanceIdentifier.toString());
            ...
            // there may be a participant stub waiting to be recovered from the
            // log so drop the
            // message, forcing the caller to retry

            WSTLogger.i18NLogger
                    .warn_wst11_messaging_CoordinatorProcessorImpl_prepared_3(instanceIdentifier.toString());
        }
    }
    ...
    public void readOnly(final Notification readOnly, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (coordinator != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_CoordinatorProcessorImpl_readOnly_2(instanceIdentifier.toString());
        }
    }
    ...
    public void soapFault(final SoapFault fault, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (coordinator != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_CoordinatorProcessorImpl_soapFault_2(instanceIdentifier.toString());
        }
    }
    ...
    private void sendUnknownTransaction(final MAP map, final ArjunaContext arjunaContext) {
        ...
        try {
            final String message = WSTLogger.i18NLogger
                    .get_wst11_messaging_CoordinatorProcessorImpl_sendUnknownTransaction_1();
