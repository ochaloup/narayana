...
public class CoordinatorCompletionParticipantEngine implements CoordinatorCompletionParticipantInboundEvents {
     ...
     *            -&gt; Canceling Completed -&gt; Completed (resend Completed)
     *            Closing -&gt; Closing Compensating -&gt; Compensating
     ...
     *            -&gt; NotCompleting (resend CannotComplete) Exiting -&gt;
     *            Exiting (resend Exit) Ended -&gt; Ended (send Canceled)
     */
     ...
     *            Active -&gt; Active (invalid state) Canceling -&gt; Canceling
     *            (invalid state) Completing -&gt; Completing (invalid state)
     *            Completed -&gt; Compensating Closing -&gt; Closing (invalid
     *            state) Compensating -&gt; Compensating Failing-Active -&gt;
     *            Failing-Active (invalid state) Failing-Canceling -&gt;
     *            Failing-Canceling (invalid state) Failing-Completing -&gt;
     *            Failing-Completing (invalid state) Failing-Compensating -&gt;
     ...
     *            -&gt; Completing Completed -&gt; Completed (resend Completed)
     *            Closing -&gt; Closing Compensating -&gt; Compensating
     *            Failing-Active -&gt; Failing-Active (resend Fail)
     *            Failing-Canceling -&gt; Failing-Canceling (resend Fail)
     *            Failing-Completing -&gt; Failing-Completing (resend Fail)
     *            Failing-Compensating -&gt; Failing-Compensating NotCompleting
     *            -&gt; NotCompleting (resend CannotComplete) Exiting -&gt;
     *            Exiting (resend Exit) Ended -&gt; Ended (send Fail)
     */
     ...
     *            -&gt; Ended Failing-Completing -&gt; Ended
     *            Failing-Compensating -&gt; Ended NotCompleting -&gt;
     *            NotCompleting (invalid state) Exiting -&gt; Exiting (invalid
     *            state) Ended -&gt; Ended
     */
     ...
     *            state) Failing-Completing -&gt; Failing-Completing (invalid
     *            state) Failing-Compensating -&gt; Failing-Compensating
     *            (invalid state) NotCompleting -&gt; Ended Exiting -&gt;
     ...
     *
     * Active -&gt; Active (invalid state) Canceling -&gt; Canceling (invalid
     * state) Completing -&gt; Completed Completed -&gt; Completed Closing -&gt;
     * Closing (invalid state) Compensating -&gt; Compensating (invalid state)
     * Failing-Active -&gt; Failing-Active (invalid state) Failing-Canceling
     * -&gt; Failing-Canceling (invalid state) Failing-Completing -&gt;
     * Failing-Completing (invalid state) Failing-Compensating -&gt;
     * Failing-Compensating (invalid state) Exiting -&gt; Exiting (invalid
     * state) NotCompleting -&gt; NotCompleting (invalid state) Ended -&gt;
     * Ended (invalid state)
     */
     ...
     * -&gt; Exiting Completed -&gt; Completed (invalid state) Closing -&gt;
     * Closing (invalid state) Compensating -&gt; Compensating (invalid state)
     * Failing-Active -&gt; Failing-Active (invalid state) Failing-Canceling
     * -&gt; Failing-Canceling (invalid state) Failing-Completing -&gt;
     * Failing-Completing (invalid state) Failing-Compensating -&gt;
     ...
     * -&gt; Failing-Completing Completed -&gt; Completed (invalid state)
     * Closing -&gt; Closing (invalid state) Compensating -&gt;
     * Failing-Compensating Failing-Active -&gt; Failing-Active
     * Failing-Canceling -&gt; Failing-Canceling Failing-Completing -&gt;
     * Failing-Completing Failing-Compensating -&gt; Failing-Compensating
     ...
     * Closing -&gt; Closing (invalid state) Compensating -&gt; Compensating
     ...
     * NotCompleting -&gt; NotCompleting Exiting -&gt; Exiting (invalid state)
