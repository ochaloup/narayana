...
public abstract class CoordinatorCompletionCoordinatorProcessor {
     ...
     */
    public static synchronized CoordinatorCompletionCoordinatorProcessor setProcessor(
            final CoordinatorCompletionCoordinatorProcessor processor) {
     ...
     *            The identifier.
     */
    public abstract void activateCoordinator(final CoordinatorCompletionCoordinatorInboundEvents coordinator,
     ...
     *            The arjuna context.
     */
    public abstract void compensated(final NotificationType compensated, final MAP map,
     ...
     *            The arjuna context.
     */
    public abstract void completed(final NotificationType completed, final MAP map, final ArjunaContext arjunaContext);
