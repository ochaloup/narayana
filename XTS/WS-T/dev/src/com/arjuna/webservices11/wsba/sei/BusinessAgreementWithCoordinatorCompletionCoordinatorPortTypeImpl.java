...
@WebService(name = "BusinessAgreementWithCoordinatorCompletionCoordinatorPortType", targetNamespace = "http://docs.oasis-open.org/ws-tx/wsba/2006/06",
        // wsdlLocation =
        // "/WEB-INF/wsdl/wsba-coordinator-completion-coordinator-binding.wsdl",
        serviceName = "BusinessAgreementWithCoordinatorCompletionCoordinatorService", portName = "BusinessAgreementWithCoordinatorCompletionCoordinatorPortType")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@HandlerChain(file = "/ws-t_handlers.xml")
@Addressing(required = true)
public class BusinessAgreementWithCoordinatorCompletionCoordinatorPortTypeImpl // implements
                                                                                // BusinessAgreementWithCoordinatorCompletionCoordinatorPortType
{
    ...
    public void completedOperation(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                CoordinatorCompletionCoordinatorProcessor.getProcessor().completed(completed, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void compensatedOperation(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                CoordinatorCompletionCoordinatorProcessor.getProcessor().compensated(compensated, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void cannotComplete(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                CoordinatorCompletionCoordinatorProcessor.getProcessor().cannotComplete(cannotComplete, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void getStatusOperation(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                CoordinatorCompletionCoordinatorProcessor.getProcessor().getStatus(getStatus, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void soapFault(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                CoordinatorCompletionCoordinatorProcessor.getProcessor().soapFault(soapFault, inboundMap,
                        arjunaContext);;
            }
        });
    }
