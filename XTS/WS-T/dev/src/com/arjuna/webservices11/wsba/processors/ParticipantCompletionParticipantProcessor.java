...
public abstract class ParticipantCompletionParticipantProcessor {
     ...
     */
    public static synchronized ParticipantCompletionParticipantProcessor setProcessor(
            final ParticipantCompletionParticipantProcessor processor) {
     ...
     *            The identifier.
     */
    public abstract void activateParticipant(final ParticipantCompletionParticipantInboundEvents participant,
     ...
     *            The arjuna context.
     */
    public abstract void compensate(final NotificationType compensate, final MAP map,
     ...
     *            The arjuna context.
     */
    public abstract void notCompleted(final NotificationType notCompleted, final MAP map,
            final ArjunaContext arjunaContext);
