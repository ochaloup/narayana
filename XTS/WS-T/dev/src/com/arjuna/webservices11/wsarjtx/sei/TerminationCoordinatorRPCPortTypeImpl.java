...
/**
 * This class was generated by Apache CXF 2.2.9-patch-01 Thu Aug 26 17:07:44 BST
...
public class TerminationCoordinatorRPCPortTypeImpl {
    ...
    public NotificationType cancelOperation(
            @WebParam(partName = "parameters", name = "Cancel", targetNamespace = "http://schemas.arjuna.com/ws/2005/10/wsarjtx") NotificationType parameters) {
    ...
    public NotificationType closeOperation(
            @WebParam(partName = "parameters", name = "Close", targetNamespace = "http://schemas.arjuna.com/ws/2005/10/wsarjtx") NotificationType parameters) {
        MessageContext ctx = webServiceCtx.getMessageContext();
    ...
    public NotificationType completeOperation(
            @WebParam(partName = "parameters", name = "Complete", targetNamespace = "http://schemas.arjuna.com/ws/2005/10/wsarjtx") NotificationType parameters) {
        MessageContext ctx = webServiceCtx.getMessageContext();
