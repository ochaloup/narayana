...
public abstract class ParticipantProcessor {
     ...
     *            The arjuna context.
     */
    public abstract void commit(final Notification commit, final MAP map, final ArjunaContext arjunaContext);
     ...
     *            The arjuna context.
     */
    public abstract void prepare(final Notification prepare, final MAP map, final ArjunaContext arjunaContext);
     ...
     *            The arjuna context.
     */
    public abstract void rollback(final Notification rollback, final MAP map, final ArjunaContext arjunaContext);
