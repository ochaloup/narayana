...
public class CompletionInitiatorProcessor extends BaseNotificationProcessor {
     ...
     *            The arjuna context.
     */
    public void handleAborted(final Notification aborted, final MAP map, final ArjunaContext arjunaContext) {
     ...
     *            The arjuna context.
     */
    public void handleCommitted(final Notification committed, final MAP map, final ArjunaContext arjunaContext) {
        handleCallbacks(new CallbackExecutorAdapter() {
            public void execute(final Callback callback) {
