...
public class CompletionInitiatorClient {
    ...
    private CompletionInitiatorClient() {
        ...
        final String completionCoordinatorURIString = ServiceRegistry.getRegistry()
                .getServiceURI(AtomicTransactionConstants.COMPLETION_COORDINATOR_SERVICE_NAME, false);
        final String secureCompletionCoordinatorURIString = ServiceRegistry.getRegistry()
                .getServiceURI(AtomicTransactionConstants.COMPLETION_COORDINATOR_SERVICE_NAME, true);
     ...
     */
    public void sendCommitted(final W3CEndpointReference participant, final MAP map,
     ...
     *             for any transport errors.
     */
    public void sendSoapFault(final W3CEndpointReference participant, final MAP map, final SoapFault soapFault,
            final InstanceIdentifier identifier) throws SoapFault, IOException {
    ...
    /**
     * return a completion coordinator endpoint appropriate to the type of
    ...
    /**
     * obtain a port from the completion participant endpoint configured with
     ...
     * @return
     */
    private CompletionInitiatorPortType getPort(final W3CEndpointReference participant, final MAP map,
            final String action) {
