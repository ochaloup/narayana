...
public class State extends Enumerated {
     ...
     */
    private static final Map ENUM_MAP = generateMap(new Enumerated[]{STATE_ACTIVE, STATE_PREPARING, STATE_PREPARED,
            STATE_PREPARED_SUCCESS, STATE_COMMITTING, STATE_ABORTING});
     ...
     *             if the value is not valid.
     */
    public static State toState11(final String value) throws InvalidEnumerationException {
