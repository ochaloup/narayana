...
public interface AtomicTransactionConstants {
     ...
     */
    public QName COMPLETION_COORDINATOR_SERVICE_QNAME = new QName(WSAT_NAMESPACE, COMPLETION_COORDINATOR_SERVICE_NAME,
            WSAT_PREFIX);
     ...
     */
    public QName COMPLETION_COORDINATOR_PORT_QNAME = new QName(WSAT_NAMESPACE, COMPLETION_COORDINATOR_PORT_NAME,
            WSAT_PREFIX);
     ...
     */
    public QName COMPLETION_INITIATOR_SERVICE_QNAME = new QName(WSAT_NAMESPACE, COMPLETION_INITIATOR_SERVICE_NAME,
            WSAT_PREFIX);
    /**
     ...
     */
    public QName COMPLETION_INITIATOR_PORT_QNAME = new QName(WSAT_NAMESPACE, COMPLETION_INITIATOR_PORT_NAME,
            WSAT_PREFIX);
     ...
     */
    public QName COMPLETION_COORDINATOR_RPC_SERVICE_QNAME = new QName(WSAT_NAMESPACE,
            COMPLETION_COORDINATOR_RPC_SERVICE_NAME, WSAT_PREFIX);
     ...
     */
    public QName COMPLETION_COORDINATOR_RPC_PORT_QNAME = new QName(WSAT_NAMESPACE, COMPLETION_COORDINATOR_RPC_PORT_NAME,
            WSAT_PREFIX);
     ...
     * The vote QName.
     */
    public QName WSAT_ATTRIBUTE_VOTE_QNAME = new QName(WSAT_ATTRIBUTE_NAMESPACE, WSAT_ATTRIBUTE_VOTE,
            WSAT_ATTRIBUTE_PREFIX);
    /**
     ...
     * The outcome QName.
     */
    public QName WSAT_ATTRIBUTE_OUTCOME_QNAME = new QName(WSAT_ATTRIBUTE_NAMESPACE, WSAT_ATTRIBUTE_OUTCOME,
            WSAT_ATTRIBUTE_PREFIX);
     ...
     */
    public QName WSAT_ERROR_CODE_INCONSISTENT_INTERNAL_STATE_QNAME = new QName(WSAT_NAMESPACE,
            WSAT_ERROR_CODE_INCONSISTENT_INTERNAL_STATE, WSAT_PREFIX);
     ...
     */
    public QName WSAT_ERROR_CODE_UNKNOWN_TRANSACTION_QNAME = new QName(WSAT_NAMESPACE,
            WSAT_ERROR_CODE_UNKNOWN_TRANSACTION, WSAT_PREFIX);
