 ...
 * recovery On the participant this is responsible for saving WS-BA participant
 ...
 * merely records whether coordinator recovery has completed its first scan
 */
public abstract class XTSBARecoveryManager {
    ...
    /*****************************************************************************************/
    /*
     * API used by recovery scanning thread to add entries to the BA recovery
     * manager's
     */
    ...
    /**
     * test whether the first BA subordinate coordinator recovery scan has
     * completed. this indicates whether there may or may not still be unknown
     * BA subtransaction records on disk. If the first scan has not yet
     * completed then a close or cancel/compensate for an unknown subtransaction
     * must raise an exception delaying commit of the parent transaction.
     */
    ...
    /**
     * record the fact that the first BA subordinate coordinator recovery scan
     * has completed.
     */
