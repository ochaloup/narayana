...
/**
 * This class was generated by the JAX-WS RI. JAX-WS RI 2.2-12/14/2009 02:16
 * PM(ramkris)- Generated source version: 2.2
 * 
 */
...
public class CompletionCoordinatorRPCService extends Service {
    ...
    private final static QName COMPLETIONCOORDINATORRPCSERVICE_QNAME = new QName(
            "http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorRPCService");

    static {
        COMPLETIONCOORDINATORRPCSERVICE_WSDL_LOCATION = CompletionCoordinatorRPCService.class
                .getResource("wsdl/wsat-completion-coordinator-rpc-binding.wsdl");
        WebServiceException e = null;
        if (COMPLETIONCOORDINATORRPCSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException(
                    "Cannot find 'wsdl/wsat-completion-coordinator-rpc-binding.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
    ...
    /**
     * 
     * @return returns CompletionCoordinatorRPCPortType
     */
    ...
    public CompletionCoordinatorRPCPortType getCompletionCoordinatorRPCPortType() {
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorRPCPortType"),
                CompletionCoordinatorRPCPortType.class);
    }
    ...
    public CompletionCoordinatorRPCPortType getCompletionCoordinatorRPCPortType(WebServiceFeature... features) {
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorRPCPortType"),
                CompletionCoordinatorRPCPortType.class, features);
    }
