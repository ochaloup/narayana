...
public class CoordinatorService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(org.oasis_open.docs.ws_tx.wsat._2006._06.CoordinatorService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsat-coordinator-binding.wsdl', retrying as a local file");
    ...
    public CoordinatorService() {
        super(COORDINATORSERVICE_WSDL_LOCATION,
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CoordinatorService"));
    }
    ...
    public CoordinatorPortType getCoordinatorPortType() {
        return super.getPort(new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CoordinatorPortType"),
                CoordinatorPortType.class);
    }
