...
public class CompletionCoordinatorService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(org.oasis_open.docs.ws_tx.wsat._2006._06.CompletionCoordinatorService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsat-completion-coordinator-binding.wsdl', retrying as a local file");
    ...
    public CompletionCoordinatorService() {
        super(COMPLETIONCOORDINATORSERVICE_WSDL_LOCATION,
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorService"));
    }
    ...
    public CompletionCoordinatorPortType getCompletionCoordinatorPortType() {
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorPortType"),
                CompletionCoordinatorPortType.class);
    }
    ...
    public CompletionCoordinatorPortType getCompletionCoordinatorPortType(WebServiceFeature... features) {
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionCoordinatorPortType"),
                CompletionCoordinatorPortType.class, features);
    }
