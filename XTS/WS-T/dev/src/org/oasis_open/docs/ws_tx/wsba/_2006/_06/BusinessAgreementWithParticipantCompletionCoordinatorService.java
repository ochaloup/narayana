...
public class BusinessAgreementWithParticipantCompletionCoordinatorService extends Service {

    private final static URL BUSINESSAGREEMENTWITHPARTICIPANTCOMPLETIONCOORDINATORSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(
            org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithParticipantCompletionCoordinatorService.class
                    .getName());
    ...
    static {
        ...
        try {
            URL baseUrl;
            baseUrl = org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithParticipantCompletionCoordinatorService.class
                    .getResource("");
            url = new URL(baseUrl, "wsdl/wsba-participant-completion-coordinator-binding.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsba-participant-completion-coordinator-binding.wsdl', retrying as a local file");
    ...
    public BusinessAgreementWithParticipantCompletionCoordinatorService() {
        super(BUSINESSAGREEMENTWITHPARTICIPANTCOMPLETIONCOORDINATORSERVICE_WSDL_LOCATION,
    ...
    public BusinessAgreementWithParticipantCompletionCoordinatorPortType getBusinessAgreementWithParticipantCompletionCoordinatorPortType(
        ...
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsba/2006/06",
                        "BusinessAgreementWithParticipantCompletionCoordinatorPortType"),
                BusinessAgreementWithParticipantCompletionCoordinatorPortType.class, features);
    }
