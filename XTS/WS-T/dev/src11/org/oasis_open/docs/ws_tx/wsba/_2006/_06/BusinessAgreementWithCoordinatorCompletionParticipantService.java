...
public class BusinessAgreementWithCoordinatorCompletionParticipantService extends Service {
    ...
    private final static Logger logger = Logger.getLogger(
            org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithCoordinatorCompletionParticipantService.class
                    .getName());
    ...
    static {
        ...
        try {
            URL baseUrl;
            baseUrl = org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithCoordinatorCompletionParticipantService.class
                    .getResource("");
            url = new URL(baseUrl, "wsdl/wsba-coordinator-completion-participant-binding.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsba-coordinator-completion-participant-binding.wsdl', retrying as a local file");
    ...
    public BusinessAgreementWithCoordinatorCompletionParticipantService() {
        super(BUSINESSAGREEMENTWITHCOORDINATORCOMPLETIONPARTICIPANTSERVICE_WSDL_LOCATION,
    ...
    public BusinessAgreementWithCoordinatorCompletionParticipantPortType getBusinessAgreementWithCoordinatorCompletionParticipantPortType(
        ...
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsba/2006/06",
                        "BusinessAgreementWithCoordinatorCompletionParticipantPortType"),
                BusinessAgreementWithCoordinatorCompletionParticipantPortType.class, features);
    }
