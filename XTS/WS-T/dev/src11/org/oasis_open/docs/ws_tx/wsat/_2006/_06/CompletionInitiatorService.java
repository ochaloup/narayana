...
public class CompletionInitiatorService extends Service {
    ...
    private final static Logger logger = Logger
            .getLogger(org.oasis_open.docs.ws_tx.wsat._2006._06.CompletionInitiatorService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsat-completion-initiator-binding.wsdl', retrying as a local file");
    ...
    public CompletionInitiatorService() {
        super(COMPLETIONINITIATORSERVICE_WSDL_LOCATION,
                new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionInitiatorService"));
    }
    ...
    public CompletionInitiatorPortType getCompletionInitiatorPortType() {
        return super.getPort(new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionInitiatorPortType"),
                CompletionInitiatorPortType.class);
    }
    ...
    public CompletionInitiatorPortType getCompletionInitiatorPortType(WebServiceFeature... features) {
        return super.getPort(new QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "CompletionInitiatorPortType"),
                CompletionInitiatorPortType.class, features);
    }
