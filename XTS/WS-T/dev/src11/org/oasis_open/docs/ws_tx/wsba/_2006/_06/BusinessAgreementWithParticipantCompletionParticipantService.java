...
public class BusinessAgreementWithParticipantCompletionParticipantService extends Service {
    ...
    private final static Logger logger = Logger.getLogger(
            org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithParticipantCompletionParticipantService.class
                    .getName());
    ...
    static {
        ...
        try {
            URL baseUrl;
            baseUrl = org.oasis_open.docs.ws_tx.wsba._2006._06.BusinessAgreementWithParticipantCompletionParticipantService.class
                    .getResource("");
            url = new URL(baseUrl, "wsdl/wsba-participant-completion-participant-binding.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/wsba-participant-completion-participant-binding.wsdl', retrying as a local file");
    ...
    public BusinessAgreementWithParticipantCompletionParticipantService() {
        super(BUSINESSAGREEMENTWITHPARTICIPANTCOMPLETIONPARTICIPANTSERVICE_WSDL_LOCATION,
    ...
    public BusinessAgreementWithParticipantCompletionParticipantPortType getBusinessAgreementWithParticipantCompletionParticipantPortType(
        ...
        return super.getPort(
                new QName("http://docs.oasis-open.org/ws-tx/wsba/2006/06",
                        "BusinessAgreementWithParticipantCompletionParticipantPortType"),
                BusinessAgreementWithParticipantCompletionParticipantPortType.class, features);
    }
