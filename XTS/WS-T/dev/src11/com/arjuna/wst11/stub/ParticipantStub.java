...
public class ParticipantStub implements Participant, PersistableParticipant {
    ...
    public ParticipantStub(final String id, final boolean durable, final W3CEndpointReference twoPCParticipant)
            throws Exception {
        // id will be supplied as null during recovery in which case we can
        // delay creation
    ...
    public Vote prepare() throws WrongStateException, SystemException {
        /*
         * null - aborted or read only Active - illegal state Preparing - no
         * answer Prepared - illegal state PreparedSuccess - prepared Committing
         * - illegal state Aborting - aborting
         */
    ...
    public void commit() throws WrongStateException, SystemException {
        /*
         * null - committed Active - illegal state Preparing - illegal state
         * Prepared - illegal state PreparedSuccess - illegal state Committing -
         * no response Aborting - illegal state
         */
    ...
    public void rollback() throws WrongStateException, SystemException {
        /*
         * null - aborted Active - illegal state Preparing - illegal state
         * Prepared - illegal state PreparedSuccess - illegal state Committing -
         * illegal state Aborting - no response
         */
    ...
    public boolean restoreState(final InputObjectState ios) {
        ...
        try {
            ...
            // if we already have a coordinator from a previous recovery scan or
            // because
            // we had a heuristic outcoe then reuse it with luck it will have
            // been committed
