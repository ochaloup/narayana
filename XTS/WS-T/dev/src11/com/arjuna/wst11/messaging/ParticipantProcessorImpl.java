...
public class ParticipantProcessorImpl extends ParticipantProcessor {
    ...
    public boolean isActive(final String identifier) {
        // if there is an entry in the table then it is active or completed and
        // pending delete
    ...
    public void rollback(final Notification rollback, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (recoveryManager == null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_ParticipantProcessorImpl_rollback_3(instanceIdentifier.toString());
        ...
        if (participant != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_ParticipantProcessorImpl_rollback_4(instanceIdentifier.toString());
        } else if (recoveryManager.findParticipantRecoveryRecord(instanceIdentifier.getInstanceIdentifier()) != null) {
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_ParticipantProcessorImpl_rollback_5(instanceIdentifier.toString());
        } else {
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_ParticipantProcessorImpl_rollback_2(instanceIdentifier.toString());
            sendAborted(map, arjunaContext);
        }
    }
    ...
    public void soapFault(final SoapFault fault, final MAP map, final ArjunaContext arjunaContext) {
        ...
        if (participant != null) {
            ...
            WSTLogger.i18NLogger
                    .warn_wst11_messaging_ParticipantProcessorImpl_soapFault_2(instanceIdentifier.toString());
        }
    }
