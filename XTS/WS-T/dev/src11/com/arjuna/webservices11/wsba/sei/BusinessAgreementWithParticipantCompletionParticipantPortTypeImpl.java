...
@WebService(name = "BusinessAgreementWithParticipantCompletionParticipantPortType", targetNamespace = "http://docs.oasis-open.org/ws-tx/wsba/2006/06",
        // wsdlLocation =
        // "/WEB-INF/wsdl/wsba-participant-completion-participant-binding.wsdl",
        serviceName = "BusinessAgreementWithParticipantCompletionParticipantService", portName = "BusinessAgreementWithParticipantCompletionParticipantPortType")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@HandlerChain(file = "/ws-t_handlers.xml")
@Addressing(required = true)
public class BusinessAgreementWithParticipantCompletionParticipantPortTypeImpl // implements
                                                                                // BusinessAgreementWithParticipantCompletionParticipantPortType
{
    ...
    public void compensateOperation(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                ParticipantCompletionParticipantProcessor.getProcessor().compensate(compensate, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void notCompleted(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                ParticipantCompletionParticipantProcessor.getProcessor().notCompleted(notCompleted, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void getStatusOperation(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                ParticipantCompletionParticipantProcessor.getProcessor().getStatus(getStatus, inboundMap,
                        arjunaContext);
            }
        });
    }
    ...
    public void soapFault(
        ...
        TaskManager.getManager().queueTask(new Task() {
            public void executeTask() {
                ParticipantCompletionParticipantProcessor.getProcessor().soapFault(soapFault, inboundMap,
                        arjunaContext);;
            }
        });
    }
