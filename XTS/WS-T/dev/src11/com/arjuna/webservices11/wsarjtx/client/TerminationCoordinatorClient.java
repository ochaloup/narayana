...
public class TerminationCoordinatorClient {
    ...
    private TerminationCoordinatorClient() {
        ...
        final String terminationParticipantURIString = ServiceRegistry.getRegistry()
                .getServiceURI(ArjunaTX11Constants.TERMINATION_PARTICIPANT_SERVICE_NAME, false);
        final String secureTerminationParticipantURIString = ServiceRegistry.getRegistry()
                .getServiceURI(ArjunaTX11Constants.TERMINATION_PARTICIPANT_SERVICE_NAME, true);
     ...
     * 
     * @param coordinator
     * @return either the secure terminaton coordinator endpoint or the
     *         non-secure endpoint
     */
    ...
    private TerminationCoordinatorPortType getPort(final W3CEndpointReference endpoint, final MAP map,
