...
@WebService(name = "CompletionCoordinatorRPCPortType", targetNamespace = "http://docs.oasis-open.org/ws-tx/wsat/2006/06",
        // wsdlLocation =
        // "/WEB-INF/wsdl/wsat-completion-coordinator-binding.wsdl",
        serviceName = "CompletionCoordinatorRPCService", portName = "CompletionCoordinatorRPCPortType")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@HandlerChain(file = "/ws-t-rpc_handlers.xml")
@Addressing(required = true)
public class CompletionCoordinatorRPCPortTypeImpl // implements
