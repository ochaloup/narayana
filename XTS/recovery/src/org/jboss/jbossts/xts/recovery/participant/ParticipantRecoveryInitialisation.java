...
/**
 * manager allowing XTS participant recovery moduels to be registered at startup
 * and unregistered at shutdown. note that these are the recovery modules which
 * drive XTS participant recovery. if participant recovery is configured then
 * this will include the participant recovery modules which drive calls to
 * application specific recovery modules registered by participant web services.
 */
    ...
    public static void startup() {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                RecoveryLogger.i18NLogger.error_recovery_participant_ParticipantRecoveryInitialisation_1(className,
                        cnfe);
                continue;
            }
            ...
            try {
                ...
                RecoveryLogger.i18NLogger.error_recovery_participant_ParticipantRecoveryInitialisation_4(className,
                        iae);
            }
        }
