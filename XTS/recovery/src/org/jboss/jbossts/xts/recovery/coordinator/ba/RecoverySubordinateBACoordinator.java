 ...
 * for recovering failed WSBA ACCoordinator transactions.
 *
 */
    ...
    public void replayPhase2() {
        ...
        if (RecoveryLogger.logger.isDebugEnabled()) {
            RecoveryLogger.logger.debugv(
                    "RecoverBASubordinateCoordinator.replayPhase2 recovering {0} ActionStatus is {1}",
        ...
        if (_activated) {
            ...
            if (RecoveryLogger.logger.isDebugEnabled()) {
                RecoveryLogger.logger.debugv("RecoverBASubordinateCoordinator.replayPhase2( {0} )  finished",
                        new Object[]{get_uid()});
            }
        } else {
