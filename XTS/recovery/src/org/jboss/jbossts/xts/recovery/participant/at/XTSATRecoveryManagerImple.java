...
public class XTSATRecoveryManagerImple extends XTSATRecoveryManager {
    /**
     * constructor for use by ATParticipantRecoveryModule and
    ...
    public boolean writeParticipantRecoveryRecord(ATParticipantRecoveryRecord participantRecoveryRecord) {
        ...
        if (participantRecoveryRecord.saveState(oos)) {
            ...
            try {
                ...
                RecoveryLogger.i18NLogger.warn_participant_at_XTSATRecoveryModule_1(participantRecoveryRecord.getId(),
                        ose);
            }
        }
    ...
    private void cullOrphanedSubordinates() {
        ...
        for (SubordinateATCoordinator coordinator : coordinators) {
            if (coordinator.getSubordinateType().equals(SubordinateATCoordinator.SUBORDINATE_TX_TYPE_AT_AT)
                    && coordinator.isOrphaned()) {
    ...
    /**
     * set a global flag indicating that the first AT participant recovery scan
     * has been performed.
     */
    ...
    /**
     * a global flag indicating whether the first AT participant recovery scan
     * has been performed.
     */
    private boolean participantRecoveryStarted = false;

    /**
     * a global flag indicating whether the first AT coordinator recovery scan
     * has been performed.
     */
    private boolean coordinatorRecoveryStarted = false;

    /**
     * a global flag indicating whether the first AT subordinate coordinator
