 ...
 * for recovering failed XTS AT (ACCoordinator) transactions. (instances of
 * com.arjuna.mwlabs.wscf.model.twophase.arjunacore.ACCoordinator)
 *
 * $Id$
 *
 */
    ...
    private void doRecoverTransaction(Uid recoverUid) {
        ...
        if (!inFlight) {
            try {
                ...
                // TODO jjh
                RecoveryATCoordinator rcvACCoordinator = new RecoveryATCoordinator(recoverUid);
