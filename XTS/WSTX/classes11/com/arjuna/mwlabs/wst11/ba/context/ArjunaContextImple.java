 ...
 * @version $Id: ArjunaContextImple.java,v 1.6.6.1 2005/11/22 10:36:16 kconner
 *          Exp $
 */
    ...
    private synchronized Element context() {
        ...
        if (_context == null) {
            ...
            if (_identifierValues != null) {
                ...
                coordinationType
                        .appendChild(doc.createTextNode(BusinessActivityConstants.WSBA_PROTOCOL_ATOMIC_OUTCOME));
