...
@Suite.SuiteClasses({
        // wst basic tests
        // this test fails because the commit is retried forever instead of an
        // exception being generated
        // addTest(new
        // junit.framework.TestSuite(CommitExceptionInCommit.class));
        ...
        SubtransactionCommit.class, SubtransactionRollback.class, SubtransactionCommitRollbackInPrepare.class,
        SubtransactionCommitFailInPrepare.class,

        // wst BA tests
        com.arjuna.wst11.tests.junit.ba.Cancel.class, com.arjuna.wst11.tests.junit.ba.Close.class,
        com.arjuna.wst11.tests.junit.ba.Compensate.class, com.arjuna.wst11.tests.junit.ba.ConfirmWithComplete.class,
        com.arjuna.wst11.tests.junit.ba.Exit.class, com.arjuna.wst11.tests.junit.ba.MultiCancel.class,
        com.arjuna.wst11.tests.junit.ba.MultiClose.class, com.arjuna.wst11.tests.junit.ba.MultiCompensate.class})
