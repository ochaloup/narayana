 ...
 * @version $Id: DemoBusinessParticipant.java,v 1.5 2004/09/09 08:48:39 kconner
 *          Exp $
 * @since 1.0.
 */
...
public class DemoBusinessParticipant implements com.arjuna.wst.BusinessAgreementWithParticipantCompletionParticipant {
    ...
    /*
     * TODO does EXIT imply a memory leak? How does the participant get
     * unregistered from the dispatcher if it isn't called during termination?
     */
    ...
    public final boolean passed() {
        /*
         * If we get a passed result and our status was EXIT then this means
         * that one of our methods was called, which is wrong if we exited!
         */
