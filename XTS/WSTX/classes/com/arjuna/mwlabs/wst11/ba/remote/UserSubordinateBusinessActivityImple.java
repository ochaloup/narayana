 ...
 * the singleton instance which implements UserBusinessActivity. In the case of
 * a begin call it redirects to a beginSubordinate call on the
 * UserBusinessActivity singleton. In the case of a complete, cancel or
 * compensate it throws a WrongStateException, irrespective of whether the
 * current transaction is top-level or subordinate since these operations should
 * only be attempted via the UserTransactionImple singleton obtained by calling
...
public class UserSubordinateBusinessActivityImple extends UserBusinessActivity {
    ...
    public String transactionIdentifier() {
        return ((UserBusinessActivityImple) UserBusinessActivityImple.getUserBusinessActivity())
