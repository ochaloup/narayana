...
/**
 * Local business activity terminator which can be used to close a business
 * activity from the terminator side.
 */
public class BusinessActivityTerminatorImple implements BusinessActivityTerminator {
    ...
    /**
     * create a business activity terminator for use on the server side with an
     * empty participant endpoint which gets set at registration time
     * 
    ...
    /**
     * update the business activity terminator with an endpoint supplied at
     * registration time
     *
    ...
    /**
     * retrieve the participant endpoint associated with this business activity
     * terminator
     * 
     * @return
     */
