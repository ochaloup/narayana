...
public class SOAPUtil {
    ...
    private static final class SOAPElementIterator implements Iterator {
        ...
        /**
         * Remove the current object. &nbsp;This method is not supported on this
         * iterator.
         * 
         * @throws UnsupportedOperationException
         *             if not supported.
         * @throws IllegalStateException
         *             if the next method has not been called or remove has
         *             already been called on the current element.
         */
