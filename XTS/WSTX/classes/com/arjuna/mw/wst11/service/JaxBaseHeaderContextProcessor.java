...
class JaxBaseHeaderContextProcessor {
     ...
     * @param soapMessage
     *            The current message context.
     * @param installSubordinateTx
     *            true if a subordinate transaction should be interposed and
     *            false if the handler should just resume the incoming
     *            transaction. currently only works for AT transactions but will
     *            eventually be extended to work for BA transactions too.
     */
            ...
            try {
                ...
                if (soapHeaderElement != null) {
                    ...
                    if (AtomicTransactionConstants.WSAT_PROTOCOL.equals(coordinationType)) {
                        ...
                        // interposition is not yet implemented for business
                        // activities
                        clearMustUnderstand(soapHeader, soapHeaderElement);
    ...
    protected void suspendTransaction() {
        try {
            ...
            final BusinessActivityManager businessActivityManager = BusinessActivityManagerFactory
