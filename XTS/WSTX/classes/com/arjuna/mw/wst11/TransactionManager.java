 ...
 * @version $Id: TransactionManager.java,v 1.10.6.1 2005/11/22 10:36:06 kconner
 *          Exp $
 * @since XTS 1.0.
 */
...
public abstract class TransactionManager {
     ...
     * is thrown. If the coordinator already has a participant enrolled with the
     ...
     * the invoking thread.
     */
    public abstract void resume(final TxContext txContext) throws UnknownTransactionException, SystemException;
     ...
     * transactions. The suspend method accomplishes this, returning a TxContext
     * instance, which is a handle on the transaction. The thread is then no
     ...
     * not disassociate the current thread from the transaction(s). This can be
     * used to enable multiple threads to execute within the scope of the same
     * transaction.
     */
