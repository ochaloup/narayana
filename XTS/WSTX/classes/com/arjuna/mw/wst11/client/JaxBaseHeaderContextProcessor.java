...
/**
 * Common base class for classes used to perform WS-Transaction context
 * manipulation on SOAP messages.
 *
 */
class JaxBaseHeaderContextProcessor {
    ...
    public boolean handleOutboundMessage(final SOAPMessage soapMessage, boolean mustUnderstand) {
        ...
        try {
            /*
             * There should either be an Atomic Transaction *or* a Business
             * Activity associated with the thread.
             */
            final TransactionManager transactionManager = TransactionManagerFactory.transactionManager();
            final com.arjuna.mw.wst11.BusinessActivityManager businessActivityManager = BusinessActivityManagerFactory
            ...
            if (businessActivityManager != null) {
                final com.arjuna.mwlabs.wst11.ba.context.TxContextImple txContext = (com.arjuna.mwlabs.wst11.ba.context.TxContextImple) businessActivityManager
                        .currentTransaction();
            ...
            if (coordinationContext != null) {
                ...
                final Name name = env.createName(CoordinationConstants.WSCOOR_ELEMENT_COORDINATION_CONTEXT,
                        CoordinationConstants.WSCOOR_PREFIX, CoordinationConstants.WSCOOR_NAMESPACE);
                final SOAPHeaderElement headerElement = header.addHeaderElement(name);
                headerElement.addNamespaceDeclaration(CoordinationConstants.WSCOOR_PREFIX,
                        CoordinationConstants.WSCOOR_NAMESPACE);
                headerElement.setMustUnderstand(mustUnderstand);
                CoordinationContextHelper.serialise(coordinationContext, headerElement);
            }
        } catch (final Throwable th) {
            wstxLogger.i18NLogger.warn_mw_wst11_client_JaxHC11P_1(
                    "com.arjuna.mw.wst11.client.JaxBaseHeaderContextProcessor.handleRequest()", th);
        }
    ...
    protected void resumeTransaction(final SOAPMessage soapMessage) {
        if (soapMessage != null) {
            try {
                ...
                final SOAPHeaderElement soapHeaderElement = getHeaderElement(soapEnvelope,
                        CoordinationConstants.WSCOOR_NAMESPACE,
                ...
                if (soapHeaderElement != null) {
                    ...
                    if (cc != null) {
                        ...
                        if (AtomicTransactionConstants.WSAT_PROTOCOL.equals(coordinationType)) {
                            ...
                            wstxLogger.i18NLogger.warn_mw_wst11_client_JaxHC11P_2(
                                    "com.arjuna.mw.wst11.client.JaxBaseHeaderContextProcessor.resumeTransaction()",
                                    coordinationType);
                        }
                    }
                }
                ...
                wstxLogger.i18NLogger.warn_mw_wst11_client_JaxHC11P_1(
                        "com.arjuna.mw.wst11.client.JaxBaseHeaderContextProcessor.resumeTransaction()", th);
            }
        }
    }
     ...
     * 
     * @param soapEnvelope
     *            The soap envelope containing the header.
     * @param uri
     *            The uri of the header element.
     * @param name
    ...
    private SOAPHeaderElement getHeaderElement(final SOAPEnvelope soapEnvelope, final String uri, final String name)
        ...
        if (soapHeader != null) {
            ...
            while (headerIter.hasNext()) {
                ...
                if ((currentName != null) && match(name, currentName.getLocalName())
