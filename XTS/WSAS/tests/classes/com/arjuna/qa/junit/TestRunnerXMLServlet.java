...
public class TestRunnerXMLServlet extends TestRunnerServlet {
    ...
    public void doStatus(PrintWriter writer, HttpServletRequest request, HttpServletResponse response)
        ...
        if (!_passedTests.isEmpty()) {
            ...
            while (passedTestsIterator.hasNext()) {
                ...
                testsuite.add(newTestcase(passedTest.description.getClass().getName(),
                        passedTest.description.toString(), passedTest.duration));
            }
        }
        ...
        if (!_failedTests.isEmpty()) {
            ...
            while (failedTestsIterator.hasNext()) {
                ...
                testsuite.add(newFailedTestcase(failedTest.description.getClass().getName(),
                        failedTest.description.toString(), failedTest.duration,
        ...
        if (!_errorTests.isEmpty()) {
            ...
            while (errorTestsIterator.hasNext()) {
                ...
                testsuite.add(
                        newErrorTestcase(errorTest.description.getClass().getName(), errorTest.description.toString(),
    ...
    private DOMElement newFailedTestcase(String classname, String name, long duration, String failureMessage,
            String failureDetail) {
        return newTestcase(classname, name, duration, "junit.framework.AssertionFailedError", failureMessage,
                failureDetail);
    }

    private DOMElement newErrorTestcase(String classname, String name, long duration, String failureMessage,
            String failureDetail) {
    ...
    private DOMElement newTestcase(String classname, String name, long duration, String failureMessage,
        ...
        testcase.addAttribute("time", Float.toString(duration / 1000f)); // converts
                                                                            // from
                                                                            // miliseconds
                                                                            // to
                                                                            // seconds
