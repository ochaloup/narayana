...
public class TestRunnerServlet extends HttpServlet {
    ...
    public void doStatus(PrintWriter writer, HttpServletRequest request, HttpServletResponse response)
        ...
        writer.println(
                "<TR><TD colspan=\"3\" align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Status</TD></TR>");
        writer.println("<TR>");
        writer.println(
                "<TD style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Test suite class:</TD>");
        ...
        if (!_passedTests.isEmpty()) {
            ...
            writer.println(
                    "<TR><TD colspan=\"3\" align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Passes</TD></TR>");

            writer.println("<TR>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Test</TD>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Duration</TD>");
            writer.println("</TR>");
            ...
            while (passedTestsIterator.hasNext()) {
                ...
                writer.println("</TD>");
                writer.print("<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif\">"
                        + passedTest.duration + " ms</TD>");
                writer.println("</TR>");
            }
        ...
        if (!_failedTests.isEmpty()) {
            ...
            writer.println(
                    "<TR><TD colspan=\"3\" align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Failures</TD></TR>");
            writer.println("<TR>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Test</TD>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Duration</TD>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Message</TD>");
            writer.println("</TR>");
        ...
        if (!_errorTests.isEmpty()) {
            ...
            writer.println("<TR>");
            writer.println(
                    "<TR><TD colspan=\"3\" align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Errors</TD></TR>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Test</TD>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Duration</TD>");
            writer.println(
                    "<TD align=\"center\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Exception/Error</TD>");
            writer.println("</TR>");
    ...
    public void doStatusFailed(PrintWriter writer, HttpServletRequest request, HttpServletResponse response)
        ...
        if (failedTest != null) {
            ...
            writer.println("<BODY bgcolor=\"white\" style=\"font-family: Arial, Helvetica, sans-serif\">");
            writer.println(
                    "<DIV style=\"font-family: Arial, Helvetica, sans-serif; font-size: large\">&nbsp;<BR>Test Runner: Failed Status<BR>&nbsp;</DIV>");
            ...
            writer.print("<TR>");
            writer.print(
                    "<TD colspan=\"2\" style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Stack trace:</TD>");
            writer.println("</TR>");
            writer.println("<TR>");
            ...
            if (failedIndex > 0)
                writer.println("<A href=\"" + request.getRequestURL() + "?failednumber=" + (failedIndex - 1)
                        + "\">previous</A>");
            else
                writer.print("&nbsp;");
            writer.println("</TD>");
            ...
            if (failedIndex < (_failedTests.size() - 1))
                writer.println(
                        "<A href=\"" + request.getRequestURL() + "?failednumber=" + (failedIndex + 1) + "\">next</A>");
            else
                writer.print("&nbsp;");
            writer.println("</TD>");
            writer.println("</TR>");
    ...
    public void doStatusError(PrintWriter writer, HttpServletRequest request, HttpServletResponse response)
        ...
        if (errorTest != null) {
            ...
            writer.println("<BODY bgcolor=\"white\" style=\"font-family: Arial, Helvetica, sans-serif\">");
            writer.println(
                    "<DIV style=\"font-family: Arial, Helvetica, sans-serif; font-size: large\">&nbsp;<BR>Test Runner: Error Status<BR>&nbsp;</DIV>");
            ...
            writer.println("<TR>");
            writer.print(
                    "<TD style=\"font-family: Arial, Helvetica, sans-serif; font-weight: bold\">Exception/error:</TD>");
            writer.print("<TD style=\"font-family: Arial, Helvetica, sans-serif\">");
            encode(writer, errorTest.throwable.toString());
            writer.println("</TD>");
            writer.println("</TR>");
            ...
            writer.println("<TD align=\"left\" width=\"33%\" style=\"font-family: Arial, Helvetica, sans-serif\">");
            if (errorIndex > 0)
                writer.println("<A href=\"" + request.getRequestURL() + "?errornumber=" + (errorIndex - 1)
                        + "\">previous</A>");
            else
                writer.print("&nbsp;");
            writer.println("</TD>");
            ...
            if (errorIndex < (_errorTests.size() - 1))
                writer.println(
                        "<A href=\"" + request.getRequestURL() + "?errornumber=" + (errorIndex + 1) + "\">next</A>");
            else
                writer.print("&nbsp;");
            writer.println("</TD>");
            writer.println("</TR>");
