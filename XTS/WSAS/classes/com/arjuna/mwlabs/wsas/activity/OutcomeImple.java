...
/**
 * The Outcome represents the final outcome of the activity. Because different
 * HLS implementations will have different requirements on what they can or
 * cannot return, this interface is deliberately generic.
 */
...
public class OutcomeImple implements Outcome {
     ...
     * @return some implementation specific name for the Outcome. Typically this
     *         will be the only thing necessary to determine the transaction's
     ...
     *         information (e.g., exception types) may be provided by the data
     *         method.
     */
    ...
    /**
     * Outcome specific information that can be used to determine finer level
     * details about the outcome instance.
     *
     * @exception SystemException
     *                Thrown if an error occurs.
     * @return completion specific data for this activity. Examples include the
     *         type of failure exception that was thrown by the implementation
     *         (e.g., HeuristicMixed).
     */
