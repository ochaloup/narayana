...
/**
 * The activity manager is the way in which an HLS can register itself with the
 * activity service. This allows it to be informed of the lifecycle of
 * activities and to augment that lifecyle and associated context.
 *
 * An HLS can be associated with all threads (globally) or with only a specific
 * thread (locally).
 *
...
public interface ActivityManager {
     ...
     *            The HLS to register.
     *
     * @exception InvalidHLSException
     *                Thrown if the HLS is invalid in the current execution
     *                environment.
    ...
    /**
     * Allows an invoker to obtain a list of all registered HLSs. Elements at
     * the start of the array have higher priority than those at the end.
     *
     * @exception SystemException
    ...
    /**
     * Allows an invoker to obtain a specific registered HLS supporting a given
     * coordination type.
     *
     * @exception SystemException
     *                Thrown if any error occurs.
