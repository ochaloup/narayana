...
public interface UserActivity {
    ...
    /**
     * Start a new activity with a given coordination type. If there is already
     * an activity associated with the thread then it will be nested. If the
     * activity is still active when the specified timeout elapses, it will be
     * terminated.
     *
     * @param serviceType
     *            specifies the type of coordinator which will be instantiated
    ...
    public Outcome end() throws InvalidActivityException, WrongStateException, ProtocolViolationException,
            NoActivityException, ActiveChildException, SystemException, NoPermissionException;
    ...
    public Outcome end(CompletionStatus cs)
            ...
            ActiveChildException, NoActivityException, NoPermissionException;
