...
/**
 * This class represents a handle on a stack of activities. It should only be
 * used for suspending and resuming the thread-to-activity association.
 *
...
public interface ActivityHierarchy {
    ...
    /**
     * @return whether or not this is a valid context. If a single entry in the
     *         context is invalid then we assume the entire context is.
     */
    ...
    /**
     * @param index
     *            index of the specific activity in the stack.
    ...
    /**
     * Obtain a copy of this context. Although the context may be shared between
     * different threads, the same instance of the context should not be.
     *
