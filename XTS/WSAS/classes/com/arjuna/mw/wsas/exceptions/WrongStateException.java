...
/**
 * Thrown if the state of the activity is such that it disallows the attempted
 * operation. For example, the activity is committing and a participant that has
 * prepared attempts to resign.
 *
 * Do we want to remove this and replace it with IllegalStateException as is
 * done in the JTA?
 * 
