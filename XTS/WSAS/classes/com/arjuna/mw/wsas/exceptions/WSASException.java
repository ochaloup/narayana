...
/**
 * This is the base class from which all WSAS related exceptions inherit. It
 * provides several kinds of additional information:
 *
 * (i) a string describing the error. (ii) an integer code for the error.
 * 
...
public class WSASException extends Exception {
    ...
    /**
     * Constructs a WSASException object; reason defaults to null and errorcode
     * defaults to 0.
     */
