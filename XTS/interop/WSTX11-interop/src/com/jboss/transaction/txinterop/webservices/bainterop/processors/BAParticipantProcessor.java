...
public class BAParticipantProcessor {
     ...
     */
    public void cancel(final CoordinationContextType coordinationContext, final MAP map) throws SoapFault11 {
        try {
            BAInteropUtil.registerParticipantCompletion(coordinationContext, new CancelParticipant(),
                    new Uid().toString());
    ...
    public void exit(final CoordinationContextType coordinationContext, final MAP map) throws SoapFault11 {
        try {
            ...
            final CoordinatorCompletionParticipantEngine engine = BAInteropUtil
                    .registerCoordinatorCompletion(coordinationContext, participant, new Uid().toString());
    ...
    public void fail(final CoordinationContextType coordinationContext, final MAP map) throws SoapFault11 {
        try {
            ...
            final ParticipantCompletionParticipantEngine engine = BAInteropUtil
                    .registerParticipantCompletion(coordinationContext, participant, new Uid().toString());
            participant.setEngine(engine);
            participant.initialiseTimeout();
        } catch (final Throwable th) {
            throw new SoapFault11(th);
    ...
    public void coordinatorCompleteClose(final CoordinationContextType coordinationContext, final MAP map)
            throws SoapFault11 {
        try {
            BAInteropUtil.registerCoordinatorCompletion(coordinationContext, new CoordinatorCompleteCloseParticipant(),
                    new Uid().toString());
        } catch (final Throwable th) {
            throw new SoapFault11(th);
        }
    ...
    public void messageLossAndRecovery(final CoordinationContextType coordinationContext, final MAP map)
            throws SoapFault11 {
        try {
            BAInteropUtil.registerCoordinatorCompletion(coordinationContext, new DropFirstCompensateParticipant(),
                    new Uid().toString());
        } catch (final Throwable th) {
            throw new SoapFault11(th);
        }
     ...
     *             for errors during processing
     */
    public void mixedOutcome(final CoordinationContextType coordinationContext, final MAP map) throws SoapFault11 {
    }
}
