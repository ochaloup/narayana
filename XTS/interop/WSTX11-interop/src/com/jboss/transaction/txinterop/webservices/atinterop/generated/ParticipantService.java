...
public class ParticipantService extends Service {
    ...
    private final static Logger logger = Logger.getLogger(
            com.jboss.transaction.txinterop.webservices.atinterop.generated.ParticipantService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.jboss.transaction.txinterop.webservices.atinterop.generated.ParticipantService.class
                    .getResource(".");
            url = new URL(baseUrl, "wsdl/interopat-participant-binding.wsdl");
        } catch (MalformedURLException e) {
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/interopat-participant-binding.wsdl', retrying as a local file");
