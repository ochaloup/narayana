...
public class XTSServiceTestService extends Service {

    private final static URL XTSSERVICETESTSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger
            .getLogger(org.jboss.jbossts.xts.servicetests.generated.XTSServiceTestService.class.getName());
    ...
    static {
        ...
        try {
            ...
            logger.warning(
                    "Failed to create URL for the wsdl Location: 'wsdl/xtsservicetests.wsdl', retrying as a local file");
    ...
    public XTSServiceTestService() {
        super(XTSSERVICETESTSERVICE_WSDL_LOCATION,
                new QName("http://jbossts.jboss.org/xts/servicetests/generated", "XTSServiceTestService"));
    }

    /**
     * 
     * @return returns XTSServiceTestPortType
     */
    @WebEndpoint(name = "XTSServiceTestPortType")
    public XTSServiceTestPortType getXTSServiceTestPortType() {
        return super.getPort(new QName("http://jbossts.jboss.org/xts/servicetests/generated", "XTSServiceTestPortType"),
                XTSServiceTestPortType.class);
    }
