...
/**
 * Starts a transaction and enlists a single participant in each of multiple
 * services with instructions to prepare and commit without error
 */
public class MultiServiceParticipantCompletionParticipantCloseAndExitTest extends XTSServiceTestBase
        implements
            XTSServiceTest {
    public void run() {
