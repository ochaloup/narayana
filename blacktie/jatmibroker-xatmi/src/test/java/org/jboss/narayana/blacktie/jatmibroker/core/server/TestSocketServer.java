...
public class TestSocketServer {
    ...
    private void send(DataOutputStream outs, int sid, int correlationId, int rcode, byte[] toSend, int flags, int rval,
            String toReplyTo, String type, String subtype) throws IOException {
