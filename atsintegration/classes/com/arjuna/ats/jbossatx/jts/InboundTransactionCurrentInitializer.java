 ...
 * implementation so that the app server can find it. Used together with the
 * InterpositionORBInitializerImpl this sets up processing for inbound
 * distributed transaction contexts on the server, replacing the app server's
...
public class InboundTransactionCurrentInitializer extends LocalObject implements ORBInitializer {
    public void pre_init(ORBInitInfo info) {
        ...
        try {
            // Create and register the InboundTransactionCurrent implementation
            // class
            ...
            throw new RuntimeException(
                    "Could not register initial " + "reference for InboundTransactionCurrent implementation: " + e, e);
        }
    }
