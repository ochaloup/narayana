...
public interface TransactionHelper {
     ...
     * @throws JMSException
     *             if transaction service has failed in unexpected way to obtain
     *             transaction status
     */
     ...
     * @throws JMSException
     *             if error occurred registering synchronization that occurs
     *             when transaction service fails in an unexpected way or when
     *             the transaction is marked for rollback only or when
     *             transaction is in a state where {@link Synchronization}
     ...
     * @throws JMSException
     *             if error occurred enlisting resource that occurs when
     *             transaction service fails in an unexpected way or when the
     *             transaction is marked for rollback only or when transaction
     *             is in a state where resources cannot be enlisted.
     */
     ...
     * @throws JMSException
     *             if error occurred delisting resource. that occurs when
     *             transaction service fails in an unexpected way or when
     *             transaction is in a state where resources cannot be delisted.
     */
