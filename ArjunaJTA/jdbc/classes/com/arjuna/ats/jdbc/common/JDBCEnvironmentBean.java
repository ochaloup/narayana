...
public class JDBCEnvironmentBean implements JDBCEnvironmentBeanMBean {
     ...
     *
     * Default: Connection.TRANSACTION_SERIALIZABLE Equivalent deprecated
     * property: com.arjuna.ats.jdbc.isolationLevel"
     *
    ...
    /**
     * Returns the Hashtable used for the JNDI environment in transactional
     * driver code. The returned object is a clone. May return an empty
     * Hashtable , will not return null.
     *
     * Default: empty Hashtable.
     *
     * Note: unlike previous versions, the contents is passed to InitialContext
     * verbatim. Hence String keys should be of the form e.g.
     * "java.naming.factory.initial", not "Context.INITIAL_CONTEXT_FACTORY"
     *
    ...
    /**
     * Sets the JNDI properties used by transactional driver code. The provided
     * Hashtable will be cloned, not retained.
     *
