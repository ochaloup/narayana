 ...
 *
 * The properties in the file must be as follows: xaDataSourceClassName : The
 * name of the driver class that implements XADataSource All other properties in
 * the file are read and a matching setter method called on the XADataSource.
 * This allows for implementations that require non standard configuration. e.g.
 * serverName=foo results in the method call setServerName("foo"); in accordance
 * with JavaBeans naming conventions.
 *
...
public class PropertyFileDynamicClass implements DynamicClass {
    ...
    public XADataSource getDataSource(String propertyFileName) throws SQLException {
        // read some system properties and use reflection to load and configure
        // the datasource.
        ...
        XADataSourceReflectionWrapper xaDataSourceReflectionWrapper = new XADataSourceReflectionWrapper(
