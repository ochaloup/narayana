...
public interface jtaI18NLogger {
    ...
    // @Message(id = 16003, value = "{0} - could not get class name for {1}",
    ...
    // @Message(id = 16007, value = "Caught exception: {0} for {1}", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16012, value = "Told not to rollback {0}", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16014, value = "Ignoring Xid {0} and leaving for
    // transaction recovery to drive.", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    // public void warn_recovery_info_rollingbackignore(String arg0);

    // @Message(id = 16015, value = "{0} - second pass", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = INFO)
    ...
    // @Message(id = 16024, value = "{0} - could not remove record for {1}",
    // format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16050, value = "rollback failed with status:", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16052, value = "commit failed with status:", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16057, value = "Can't enlist the resource because the
    // transaction is marked for rollback", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    @LogMessage(level = WARN)
    public void warn_transaction_arjunacore_enliststarterror(String arg0, String arg1, String arg2,
    ...
    // @Message(id = 16065, value = "Caught unexpected exception: {0}", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16077, value = "Could not mark transaction as rollback
    // only.", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    @LogMessage(level = WARN)
    public void warn_transaction_arjunacore_timeouterror(String arg0, String arg1, String arg2,
            @Cause() Throwable arg3);
    ...
    // @Message(id = 16090, value = "Failed to create instance of
    // TransactionManager", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16092, value = "Failed to create instance of
    // UserTransaction", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16094, value = "Failed to bind the JTA implementations with
    // the appropriate JNDI contexts: {0}", format = MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    // public void warn_utils_JNDIManager_jndibindfailure(String arg0);

    // @Message(id = 16095, value = "Failed to bind the JTA transaction manager
    // implementation with the approprite JNDI context: {0}", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
    ...
    // @Message(id = 16097, value = "Failed to bind the JTA user transaction
    // implementation with the appropriate JNDI context: {0}", format =
    // MESSAGE_FORMAT)
    // @LogMessage(level = WARN)
