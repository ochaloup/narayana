...
/**
 * To perform recovery on arbitrary XAResources we may need to obtain new
 * instances. Users can provide implementations of this interface which we will
 * use at recovery time to re-create XAResources and from them perform recovery.
 *
 * @since JTS 3.3.
 */
