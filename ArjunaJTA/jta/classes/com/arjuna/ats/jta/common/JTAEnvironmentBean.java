...
public class JTAEnvironmentBean implements JTAEnvironmentBeanMBean {
    ...
    private static final String defaultTransactionOperationsProviderClassName = ServerVMClientUserTransactionOperationsProvider.class
            .getName();
     ...
     *
     * @param supportSubtransactions
     *            true to enable subtransactions, false to disable.
     */
    ...
    /**
     * Returns the class name of the javax.transaction.TransactionManager
     * implementation.
     *
     * Default:
     * "com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionManagerImple"
     * Equivalent deprecated property:
     * com.arjuna.ats.jta.transactionManagerClassName
     *
    ...
    /**
     * Sets the class name of the javax.transaction.TransactionManager
     * implementation.
     *
     * @param transactionManagerClassName
     *            the name of a class which implements TransactionManager.
     */
     ...
     *
     * @return a javax.transaction.TransactionManager implementation instance,
     *         or null.
     */
    public TransactionManager getTransactionManager() {
        if (transactionManager == null && transactionManagerClassName != null) {
            synchronized (this) {
                if (transactionManager == null && transactionManagerClassName != null) {
                    TransactionManager instance = ClassloadingUtility.loadAndInstantiateClass(TransactionManager.class,
                            transactionManagerClassName, null);
     ...
     *            javax.transaction.TransactionManager, or null.
     */
    ...
    /**
     * Returns the class name of the javax.transaction.UserTransaction
     * implementation.
     *
     * Default:
     * "com.arjuna.ats.internal.jta.transaction.arjunacore.UserTransactionImple"
     * Equivalent deprecated property:
     * com.arjuna.ats.jta.userTransactionClassName
     *
    ...
    /**
     * Sets the class name of the javax.transaction.UserTransaction
     * implementation.
     *
     * @param userTransactionClassName
     ...
     * return null, not throw an exception.
     *
     * @return a javax.transaction.UserTransaction implementation instance, or
     *         null.
     */
    public UserTransaction getUserTransaction() {
        if (userTransaction == null && userTransactionClassName != null) {
            synchronized (this) {
                if (userTransaction == null && userTransactionClassName != null) {
                    UserTransaction instance = ClassloadingUtility.loadAndInstantiateClass(UserTransaction.class,
                            userTransactionClassName, null);
     ...
     *
     * @param instance
     *            an Object that implements javax.transaction.UserTransaction,
     *            or null.
     */
     ...
     * javax.transaction.TransactionSynchronizationRegistry implementation.
     *
     * Default:
     * "com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionSynchronizationRegistryImple"
     * Equivalent deprecated property:
     * com.arjuna.ats.jta.transactionSynchronizationRegistryClassName
     *
     * @return the name of the class implementing
     ...
     * javax.transaction.TransactionSynchronizationRegistry implementation.
     *
     * @param transactionSynchronizationRegistryClassName
     *            the name of a class which implements
    ...
    public void setTransactionSynchronizationRegistryClassName(String transactionSynchronizationRegistryClassName) {
        synchronized (this) {
            ...
            } else if (!transactionSynchronizationRegistryClassName
                    .equals(this.transactionSynchronizationRegistryClassName)) {
                this.transactionSynchronizationRegistry = null;
            }
     ...
     * return null, not throw an exception.
     *
     * @return a javax.transaction.TransactionSynchronizationRegistry
    ...
    public TransactionSynchronizationRegistry getTransactionSynchronizationRegistry() {
        if (transactionSynchronizationRegistry == null && transactionSynchronizationRegistryClassName != null) {
            synchronized (this) {
                if (transactionSynchronizationRegistry == null && transactionSynchronizationRegistryClassName != null) {
                    TransactionSynchronizationRegistry instance = ClassloadingUtility.loadAndInstantiateClass(
                            TransactionSynchronizationRegistry.class, transactionSynchronizationRegistryClassName,
                            null);
     ...
     * @param instance
     *            an Object that implements
     *            javax.transaction.TransactionSynchronizationRegistry, or null.
     */
     ...
     * The returned list is a copy. May return an empty list, will not return
     * null.
     *
    ...
    /**
     * Sets the node identifiers for which recovery will be performed. The
    ...
    /**
     * Returns the set of XAResourceRecovery implementation class names, each of
     * which may have configuration data appended to it. The returned list is a
     * copy. May return an empty list, will not return null.
     *
     * Default: empty list. Equivalent deprecated property prefix:
     * com.arjuna.ats.jta.recovery.XAResourceRecovery
     *
     * @return the set of XAResourceRecovery implementations with their
     *         configuration data.
     */
    ...
    /**
     * Sets the class names of the XAResourceRecovery implementations that will
     * be used, each optionally including trailing configuration data. The
     * provided list will be copied, not retained.
     *
     * @param xaResourceRecoveryClassNames
     *            the XAResourceRecovery implementation class names and
     *            configuration.
     */
    ...
    /**
     * Returns the set of XAResourceRecovery instances. The returned list is a
     * copy. May return an empty list, will not return null.
     *
     * If there is no pre-instantiated instance set and classloading or
    ...
    public List<XAResourceRecovery> getXaResourceRecoveries() {
        synchronized (this) {
            if (xaResourceRecoveries == null) {
                List<XAResourceRecovery> instances = ClassloadingUtility
                        .loadAndInstantiateClassesWithInit(XAResourceRecovery.class, xaResourceRecoveryClassNames);
    ...
    /**
     * Sets the instances of XAResourceRecovery. The provided list will be
     * copied, not retained.
     *
     * @param xaResourceRecoveries
    ...
    /**
     * Sets the class names of XAResourceOrphanFilter implementations. List
     * elements should be names of classes that implement
     * XAResourceOrphanFilter. The provided list will be copied, not retained.
     *
     * @param xaResourceOrphanFilterClassNames
     *            a list of XAResourceOrphanFilter implementation classes.
     */
    ...
    /**
     * Returns the set of XAResourceOrphanFilter instances. The returned list is
     * a copy. May return an empty list, will not return null.
     *
     * If there is no pre-instantiated instance set and classloading or
     * instantiation of one or more elements fails, this method will log an
     * appropriate warning and return a non-null set with fewer elements.
    ...
    public List<XAResourceOrphanFilter> getXaResourceOrphanFilters() {
        synchronized (this) {
            if (xaResourceOrphanFilters == null) {
                List<XAResourceOrphanFilter> instances = ClassloadingUtility.loadAndInstantiateClassesWithInit(
                        XAResourceOrphanFilter.class, xaResourceOrphanFilterClassNames);
    ...
    /**
     * Sets the instances of XAResourceOrphanFilter. The provided list will be
     * copied, not retained.
     *
     * @param xaResourceOrphanFilters
    ...
    /**
     * Returns if connections associated to XAResources that fail during prepare
     * should be cleaned up immediately. TODO move to JDBC module as it's only
     * for our own connection manager?
     *
     * Default: false. Equivalent deprecated property:
     * com.arjuna.ats.jta.xaRollbackOptimization
     *
     * @return true for cleanup during prepare, false for cleanup during phase
     *         two rollback.
     */
    ...
    /**
     * Sets if failed resources should be cleaned up during prepare or during
     * phase two.
     *
     * @param xaRollbackOptimization
     *            true for immediate cleanup, false for phase two cleanup.
     */
    ...
    /**
     * Returns if XAResources that can't be recovered should be assumed to have
     * completed. WARNING: enabling this property is not recommended and may
     * cause inconsistency if your recovery configuration is incorrect or
     * resource managers are not available.
     *
     * Default: false. Equivalent deprecated property:
    ...
    /**
     * Sets if XAResources that can't be recovered should be assumed to have
     * completed.
     *
     * @param xaAssumeRecoveryComplete
     *            true to enable completion assumption, false to disable.
     */
     ...
     *
     * Default: "java:/UserTransaction" Equivalent deprecated property:
     * com.arjuna.ats.jta.utils.UTJNDIContext
     *
     ...
     *
     * @param userTransactionJNDIContext
     ...
     *
     * Default: "java:/TransactionManager" Equivalent deprecated property:
     * com.arjuna.ats.jta.utils.TMJNDIContext
     *
     ...
     *
     * @param transactionManagerJNDIContext
    ...
    /**
     * Returns the JNDI bind name for the implementation of
     * TransactionSynchronizationRegistry.
     *
     * Default: "java:/TransactionSynchronizationRegistry" Equivalent deprecated
     * property: com.arjuna.ats.jta.utils.TSRJNDIContext
     *
     * @return the JNDI bind location for the TransactionSynchronizationRegistry
     *         interface.
     */
    ...
    /**
     * Sets tje JNDI bind name for the implementation of
     * TransactionSynchronizationRegistry.
     *
     * @param transactionSynchronizationRegistryJNDIContext
     *            the JNDI bind location for the
    ...
    /**
     * Returns the set of XAResourceMap implementation class names used to
     * configure XAException handling. The returned list is a copy. May return
     * an empty list, will not return null.
     *
     * Default: empty list. Equivalent deprecated property prefix:
     * com.arjuna.ats.jta.xaErrorHandler
     *
    ...
    /**
     * Sets the names of the XAResourceMap classes used for XAException
     * handling. The provided list will be copied, not retained.
     *
     * @param xaResourceMapClassNames
     *            a set of names of classes, each implementing XAResourceMap.
     */
    ...
    /**
     * Returns the set of XAResourceMap instances. The returned list is a copy.
    ...
    public List<XAResourceMap> getXaResourceMaps() {
        synchronized (this) {
            if (xaResourceMaps == null) {
                List<XAResourceMap> instances = ClassloadingUtility
                        .loadAndInstantiateClassesWithInit(XAResourceMap.class, xaResourceMapClassNames);
    ...
    /**
     * Sets the instances of XAResourceMap. The provided list will be copied,
     * not retained.
     *
     * @param xaResourceMaps
    ...
    /**
     * Returns if the transaction timeout is passed on to the enlisted
     * XAResources.
     *
     * Default: true. Equivalent deprecated property:
     * com.arjuna.ats.jta.xaTransactionTimeoutEnabled
     *
     * @return true to pass transaction timeout configuration on to the
     *         XAResources, false to skip setting resource timeout.
     */
    ...
    /**
     * Sets if the transaction timeout should be passed to the enlisted
     * XAResource or not.
     *
     * @param xaTransactionTimeoutEnabled
     *            true to enable setting XAResource timeouts, false to disable.
     */
    ...
    /**
     * Returns the class name of the marker interface used to indicate a
     * LastResource.
     *
     * Default: null. Equivalent deprecated property:
     * com.arjuna.ats.jta.lastResourceOptimisationInterfaceClassName
     *
    ...
    /**
     * Sets the class name of the marker interface used to indicate a
     * LastResource.
     *
     * @param lastResourceOptimisationInterfaceClassName
     *            the class name of the marker interface.
     */
    public void setLastResourceOptimisationInterfaceClassName(String lastResourceOptimisationInterfaceClassName) {
        synchronized (this) {
            ...
            } else if (!lastResourceOptimisationInterfaceClassName
                    .equals(this.lastResourceOptimisationInterfaceClassName)) {
                this.lastResourceOptimisationInterface = null;
            }
     ...
     *
     * If there is no Class set and loading fails, this method will log an
     * appropriate warning and return null, not throw an exception.
     *
    ...
    public Class getLastResourceOptimisationInterface() {
        if (lastResourceOptimisationInterface == null && lastResourceOptimisationInterfaceClassName != null) {
            synchronized (this) {
                if (lastResourceOptimisationInterface == null && lastResourceOptimisationInterfaceClassName != null) {
                    lastResourceOptimisationInterface = ClassloadingUtility
                            .loadClass(lastResourceOptimisationInterfaceClassName);
                }
            }
        }
     ...
     *
     * @param clazz
     *            a marker interface Class, or null.
     */
    ...
    /**
     * Returns the class name of the XAResourceRecordWrappingPlugin
     * implementation.
     *
     * Default: null
     *
     ...
     * return null, not throw an exception.
     *
     * @return a XAResourceRecordWrappingPlugin implementation instance, or
     *         null.
     */
    public XAResourceRecordWrappingPlugin getXAResourceRecordWrappingPlugin() {
        if (xaResourceRecordWrappingPlugin == null && xaResourceRecordWrappingPluginClassName != null) {
            synchronized (this) {
                if (xaResourceRecordWrappingPlugin == null && xaResourceRecordWrappingPluginClassName != null) {
                    XAResourceRecordWrappingPlugin instance = ClassloadingUtility.loadAndInstantiateClass(
                            XAResourceRecordWrappingPlugin.class, xaResourceRecordWrappingPluginClassName, null);
     ...
     *
     * @param instance
     *            an Object that implements XAResourceRecordWrappingPlugin, or
     *            null.
     */
    ...
    /**
     * Returns maximum size of a thread pool, used to execute asynchronous
     * commits.
     *
     * @return maximum size of a thread pool, used to execute asynchronous
     *         commits.
     */
     ...
     *
     * @param asyncCommitPoolSize
     *            maximum size of a thread pool, used to execute asynchronous
     *            commits.
     */
     ...
     * between the two recovery scan phases the xids from the RM will be
     * considered as orphaned. Although this does not cause data integrity
     * issues it can appear unsettling.
     * 
    ...
    public void setCommitMarkableResourceTableNameMap(Map<String, String> commitMarkableResourceTableNameMap) {
        synchronized (this) {
            ...
            } else if (!commitMarkableResourceTableNameMap.equals(this.commitMarkableResourceTableNameMap)) {
                this.commitMarkableResourceTableNameMap = new HashMap<String, String>(
    ...
    public void setCommitMarkableResourceJNDINames(List<String> commitMarkableResourceJNDINames) {
        synchronized (this) {
            ...
            } else if (!commitMarkableResourceJNDINames.equals(this.commitMarkableResourceJNDINames)) {
                this.commitMarkableResourceJNDINames = new ArrayList<String>(commitMarkableResourceJNDINames);
            }
        }
    }
     ...
     * {@link UserTransactionOperationsProvider}. The provider is later used to
     * get more info about {@link UserTransaction}.
     * <p>
     ...
     *            {@link UserTransactionOperationsProvider}
     */
    ...
    /**
     * Returning singleton instance of {@link UserTransactionOperationsProvider}
     * instantiated based based on name specified by
     * {@link #setUserTransactionOperationsProviderClassName(String)}.<br>
     * When class name is redefined during runtime there should be instantiated
     * new provider.
     *
     * @return instance of class implementing
     *         {@link UserTransactionOperationsProvider}
     */
            ...
            synchronized (this) {
                if (userTransactionOperationsProvider == null && userTransactionOperationsProviderClassName != null) {
                    userTransactionOperationsProvider = ClassloadingUtility.loadAndInstantiateClass(
                            UserTransactionOperationsProvider.class, userTransactionOperationsProviderClassName, null);
                }
            }
        }
    ...
    /**
     * Returns true if we would treat XAER_PROTO out of duplicate xar as an
     * error.
     *
     * Default: false.
     *
    ...
    /**
     * Sets if to not allow non-JTA 1.2 XAR to return XAER_PROTO out of
     * duplicate XAR xa_end calls
     *
     * @param strictJTA12DuplicateXAENDPROTOErr
