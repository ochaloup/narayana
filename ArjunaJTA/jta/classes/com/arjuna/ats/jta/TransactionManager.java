...
public class TransactionManager {
    /**
     * Retrieve a reference to the transaction manager from the passed in JNDI
     * initial context.
     * 
     * @param ctx
     *            The JNDI initial context to lookup the Transaction Manager
     *            reference from.
     * @return The transaction manager bound to the appropriate JNDI context.
     *         Returns null if the transaction manager cannot be found.
     * 
     */
    public static javax.transaction.TransactionManager transactionManager(InitialContext ctx) {
        ...
        try {
            transactionManager = (javax.transaction.TransactionManager) ctx
     ...
     * 
     * @return The singleton transaction manager. Can return null if the
