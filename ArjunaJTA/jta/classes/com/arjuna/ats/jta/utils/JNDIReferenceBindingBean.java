...
public class JNDIReferenceBindingBean {
    private String className; // The non-null class name of the object to which
                                // this reference refers.
    private String factory; // The possibly null class name of the object's
                            // factory.
    private String factoryLocation; // The possibly null location from which to
                                    // load the factory (e.g. URL)
