...
/**
 * Exception may be thrown under certain circumstances. Typically this is when
 * we would like to throw IllegalStateException to indicate that the transaction
 * is in an illegal state for the action attempted (inactive), but JTA has
 * reserved that for something else, e.g., that there is no transaction
