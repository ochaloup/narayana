...
public interface XAModifier {
    ...
    /**
     * Given an Arjuna xid, create a local driver representation. Some drivers
     * expect their own implementations to be used, despite the fact that the
     * JTA does not mention this!
     */
