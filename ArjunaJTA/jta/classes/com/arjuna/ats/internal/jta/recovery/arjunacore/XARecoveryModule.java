...
public class XARecoveryModule implements RecoveryModule {
    ...
    private XAResource getNewXAResource(Xid xid) {
        ...
        // JBTM-895 updated so that retrieving an XAResource triggers garbage
        // collection, this is required because garbage collecting
        // The XA resources in a bottom up scenario (e.g.
        // resourceInitiatedRecoveryForRecoveryHelpers) means that any xids that
        // are
        // not eligible for recovery after the first scan may be removed as
        // stale and due to the undocumented _xidScans check above will not be
        // reloaded
        if (_xidScans != null) {
