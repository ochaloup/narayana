...
public class XAOnePhaseResource implements OnePhaseResource, ExceptionDeferrer {
     ...
     * 
     * @return TwoPhaseOutcome.FINISH_OK, TwoPhaseOutcome.ONE_PHASE_ERROR or
    ...
    public int commit() {
        ...
        try {
            ...
            try {
                ...
                if (jtaLogger.logger.isTraceEnabled()) {
                    jtaLogger.logger
                            .trace("XAOnePhaseResource.commit(" + xid + ") called forget and got " + ex.getMessage());
                }
            }
        }
     ...
     * 
     * @param os
     *            The object output state.
     */
    public void pack(final OutputObjectState os) throws IOException {
    ...
    public void unpack(final InputObjectState is) throws IOException {
        ...
        switch (recoveryType) {
            case RecoverableXAConnection.AUTO_RECOVERY :
                ...
                recoverableXAConnection = ClassloadingUtility.loadAndInstantiateClass(RecoverableXAConnection.class,
                        recoverableXAConnectionClassName, null);
                if (recoverableXAConnection == null) {
            ...
            case RecoverableXAConnection.OBJECT_RECOVERY :
                ...
                break;
            default :
                final String message = jtaLogger.i18NLogger
                        .get_resources_arjunacore_XAOnePhaseResource_unpackType(Integer.toString(recoveryType));
     ...
     * 
     * @param ex
     *            The exception caught in unpack.
