...
public class XAResourceRecord extends AbstractRecord {
    ...
    static {
         ...
         * transaction but before updating the log. In which case we just need
         * to ignore this resource and remove the entry from the log.
         *
         * BUT if not all XAResourceRecovery instances are correctly implemented
         * (or present) we may end up removing participants that have not been
         * dealt with. Hence USE WITH EXTREME CARE!!
         */
