...
public class TxWorkManager {
    ...
    /*
     * Although we allow multiple units of work per transaction, currently JCA
     * only allows one. Might not be worth the hassle of maintaing this support.
     */
     ...
     * @param tx
     *            The transaction to have associated with the work.
     * 
     * @throws WorkCompletedException
     *             thrown if there is already work associated with the
     *             transaction.
     */
    ...
    public static void addWork(Work work, Transaction tx) throws WorkCompletedException {
        ...
        synchronized (_transactions) {
            ...
            /*
             * Stack is not required due to JCA 15.4.4 which restricts to one
             * unit of work per TX.
             */
            ...
            if (workers == null) {
                ...
                throw new WorkCompletedException(jtaLogger.i18NLogger.get_transaction_arjunacore_jca_busy(),
     ...
     * 
     * @return <code>true</code> if there is work associated with the
