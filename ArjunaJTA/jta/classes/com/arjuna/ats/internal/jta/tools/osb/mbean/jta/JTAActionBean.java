...
public class JTAActionBean extends ActionBean {
    ...
    /*
     * protected ActionBeanWrapperInterface createWrapper(UidWrapper w) { String
     * cn = SubordinateAtomicAction.class.getCanonicalName(); return new
     ...
     * 
     * 
     * class SubordinateAtomicActionWrapper extends SubordinateAtomicAction
     * implements ActionBeanWrapperInterface { boolean activated;
     * 
     * public SubordinateAtomicActionWrapper(UidWrapper w) { super(w.getUid());
     * }
     * 
     * public boolean activate() { if (!activated) activated = super.activate();
     * 
     * return activated; }
     * 
     * public void doUpdateState() { updateState(); }
     * 
     * public Uid getUid(AbstractRecord rec) { return get_uid(); }
     * 
     * public StringBuilder toString(String prefix, StringBuilder sb) { prefix
     * += '\t'; return sb.append('\n').append(prefix).append(get_uid()); }
     * 
     * public void clearHeuristicDecision(int newDecision) { if
     * (super.heuristicList.size() == 0) setHeuristicDecision(newDecision); }
     * 
     * public RecordList getRecords(ParticipantStatus type) { switch (type) {
     * default: case PREPARED: return preparedList; case FAILED: return
     * failedList; case HEURISTIC: return heuristicList; case PENDING: return
     * pendingList; case READONLY: return readonlyList; } }
     * 
     * }
     */
}
