...
public class CommitMarkableResourceRecord extends AbstractRecord {
    ...
    public boolean restore_state(InputObjectState os, int t) {
        ...
        try {
            ...
            jtaLogger.logger.warn("Could not restore_state" + XAHelper.xidToString(xid), e);
        }
    ...
    public int topLevelPrepare() {
        try {
            ...
            PreparedStatement prepareStatement = preparedConnection.prepareStatement(
    ...
    private int commit(boolean onePhase) {
        ...
        if (connectableResource != null) {
            ...
            try {
                ...
                tsLogger.logger.error("Could not commit the preparedConnection", e);
                return TwoPhaseOutcome.FINISH_ERROR;
            } finally {
                if (!isPerformImmediateCleanupOfBranches) {
                    try {
