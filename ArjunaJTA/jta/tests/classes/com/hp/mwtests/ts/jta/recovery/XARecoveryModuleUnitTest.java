...
public class XARecoveryModuleUnitTest {
    ...
    public void testRecoverPassFailure() throws Exception {
        ...
        // The first two recovery cycles do nothing with the resource (because
        // phase two is getting the exception)
        // When count reaches 6 it sees that the xid has gone and presumes abort
        // so calls rollback and hence assertTrue(rolledback) passes
