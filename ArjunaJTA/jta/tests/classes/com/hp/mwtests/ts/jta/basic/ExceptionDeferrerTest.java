...
public class ExceptionDeferrerTest {
    ...
    // @Test
    // public void testCheckDeferredHeuristicRollbackSecondResourceFails()
    // throws Exception
    // {
    // ThreadActionData.purgeActions();
    //
    ...
    // catch (final RollbackException ex)
    // {
    // assertEquals(XAException.XA_HEURRB, ((XAException)
    // ex.getSuppressed()[0]).errorCode);
    // }
    // }
    //
    // @Test
    // public void testCheckDeferredHeuristicRollbackFirstResourceFails() throws
    // Exception
    // {
    // ThreadActionData.purgeActions();
    //
