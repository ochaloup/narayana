...
public class TestXAResourceRecovery implements XAResourceRecovery {
    ...
    public XAResource getXAResource() throws SQLException {
        // This method was changed because now periodicWorkFirstPass can be
        // called to retry loading Xids from XAR
        // During getNewXAResource. If we don't return an XAR then
        // getContactedJndiNames (JBTM-860) fails and the TX
