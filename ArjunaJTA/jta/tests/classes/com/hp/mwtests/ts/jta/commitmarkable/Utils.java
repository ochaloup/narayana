...
public class Utils {
    public static void createTables(Connection connection) throws SQLException {
        ...
        if (driverName.equals("jconnect")) {
            ...
            statement.execute("create table xids (xid RAW(144), transactionManagerID varchar(64), actionuid RAW(28))");
            ...
            if (driverName.equals("postgresql")) {
                ...
                statement.execute("create table xids (xid bytea, transactionManagerID varchar(64), actionuid bytea)");
                statement.execute("create unique index index_xid on xids (xid)");
            } else {
                statement.execute(
                        "create table xids (xid varbinary(144), transactionManagerID varchar(64), actionuid varbinary(28))");
