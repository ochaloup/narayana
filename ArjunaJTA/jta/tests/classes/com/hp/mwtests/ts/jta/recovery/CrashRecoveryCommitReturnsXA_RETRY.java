...
public class CrashRecoveryCommitReturnsXA_RETRY {
    ...
    public void test() throws Exception {
        ...
        final SimpleResourceXA_RETRY secondResource = new SimpleResourceXA_RETRY(toWakeUp);
    ...
    public void testHeuristicRollback() throws Exception {
        ...
        StoreManager.getRecoveryStore().allObjUids("/StateManager/BasicAction/TwoPhaseCoordinator/AtomicAction", uids);
