...
public abstract class Product {
    ...
    protected void runTest(ProductInterface prod) {
        ...
        Measurement measurement = PerformanceProfileStore.regressionCheck(worker, worker, prod.getNameOfMetric(),
                readTestArgsFromFile, maxTestTime, warmUpCount, numberOfTransactions, threads, batchSize);
