...
public class XADSWrapperObjectFactory implements ObjectFactory {
    ...
    private static Map<String, String> jdbcDrivers = new HashMap<String, String>() {
        {
            ...
            put("com.microsoft.sqlserver.jdbc.SQLServerDriver", "com.microsoft.sqlserver.jdbc.SQLServerXADataSource"); // no
                                                                                                                        // setPassword
            put("com.mysql.jdbc.Driver", "com.mysql.jdbc.jdbc2.optional.MysqlXADataSource");
            put("com.ibm.db2.jcc.DB2Driver", "com.ibm.db2.jcc.DB2XADataSource"); // for
                                                                                    // DB2
                                                                                    // version
                                                                                    // 8.2
                                                                                    // //
                                                                                    // no
                                                                                    // setPassword
            put("com.sybase.jdbc3.jdbc.SybDriver", "com.sybase.jdbc3.jdbc.SybXADataSource"); // no
                                                                                                // setPassword
        }
    };
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable<?, ?> environment)
        ...
        XADataSource xads = getXADataSource(getStringProperty(ref, "binding"), getStringProperty(ref, "driver"),
                getStringProperty(ref, "databaseName"), getStringProperty(ref, "host"),
                getIntegerProperty(ref, "port", 0), getStringProperty(ref, "username"),
                getStringProperty(ref, "password"));

        return xads;
    }

    public static Reference getReference(String className, String binding, String driver, String databaseName,
            String host, Integer port, String userName, String password) throws NamingException {
    ...
    public static XADSWrapper getXADataSource(String binding, String driver, String databaseName, String host,
        ...
        if (driver.equals("oracle.jdbc.driver.OracleDriver")) {
            ...
            wrapper.setProperty("pinGlobalTxToPhysicalConnection", true); // Bad
                                                                            // Things
                                                                            // happen
                                                                            // if
                                                                            // you
