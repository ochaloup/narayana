...
public class DataSourceManagerImpl {
    ...
    public void registerDataSource(String binding, String driver, String databaseUrl, String userName, String password)
            throws InitializationException {
        registerDataSource(binding, driver, databaseUrl, null, -1, userName, password);
    }

    public void registerDataSource(String binding, String driver, String databaseName, String host, long port,
        ...
        try {
            xaDataSourceToBind = XADSWrapperObjectFactory.getXADataSource(binding, driver, databaseName, host,
        ...
        try {
            // initJndi should have already been called resulting in suitable
            // java.naming.provider.url and java.naming.factory.initial
