...
public class TestManagedBeanCustomerManager {
    ...
    public static WebArchive createDeployment() {
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
                .addClasses(CustomerManagerEJB.class, CustomerManagerEJBImpl.class, Customer.class)
                .addClasses(CustomerCreationCounter.class)
                .addClasses(CustomerManager.class, CustomerManagerManagedBean.class)
    ...
    public void checkListCustomers() throws Exception {
        ...
        // Create a customer
        managedBeanCustomerManager.addCustomer("Test" + System.currentTimeMillis());
