...
public class TransactionExample {
    ...
    public void commitUserTransaction() throws SystemException, NotSupportedException, RollbackException,
    ...
    public void commitTransactionManager() throws NotSupportedException, RollbackException, SystemException,
    ...
    public void setRollbackOnly()
        ...
        try {
            ...
            throw new RuntimeException(
                    "Should have got an exception whilst committing a transaction is marked as rollback only");
    ...
    public void transactionTimeout() throws SystemException, NotSupportedException, InterruptedException,
            HeuristicRollbackException, HeuristicMixedException {
        UserTransaction utx = com.arjuna.ats.jta.UserTransaction.userTransaction();
        ...
        try {
            utx.commit();
            throw new RuntimeException(
                    "Should have got an exception whilst committing a transaction that exceeded its timeout");
        } catch (RollbackException e) {
        }
    }
}
