...
/**
 * This verticle is pretty artificial and is here only so that the module has
 * something that people can look at and hopefully understand where STM fits in.
 *
 * Could consider removing this and making the module a pure library version,
 * with some tests/examples separate.
 */
...
public class STMVerticle extends AbstractVerticle {
    ...
    /*
     * Have a persistent container for this example, but it's likely recoverable
     * and optimistic cc are better for Vert.x.
     */
