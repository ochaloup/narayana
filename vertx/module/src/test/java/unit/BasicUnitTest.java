...
public class BasicUnitTest {
    ...
    public class ExampleSTM implements Atomic {
        /*
         * Define read/write operations here. Can do them in the interface if
         * you want.
         */
    ...
    public void testExampleSTM() throws Exception {
        ...
        /*
         * Create the instance of the class. But this won't be an STM object
         * yet, so don't manipulate it just yet.
         */
        ...
        try {
             ...
             * can then create an STM object which we then use to manipulate the
             * first object in a transactional manner.
             */
        ...
        assertEquals(obj.get(), 1234); // we aborted, so the value should be
                                        // back to 1234
    }
}