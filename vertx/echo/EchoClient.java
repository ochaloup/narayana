        ...
        vertx.createNetClient().connect(1234, "localhost", new AsyncResultHandler<NetSocket>() {
            public void handle(AsyncResult<NetSocket> asyncResult) {
                if (asyncResult.succeeded()) {
                    ...
                    /*
                     * If you are running this for the first time then leave as
                     * is. If you are running this more than once and want
                     * clients to share the STM objects between address spaces
                     * then go into the ObjectStore dir and look for the Uid
                     * that represents the state you want to share. Then
                    ...
                    /*
                     * STM states are identified by Uids in the ObjectStore.
                     * This is an example.
                     */
                    ...
                    // Modify this line if sharing state and uncomment.
                    // Sample obj1 = theContainer.clone(new SampleLockable(10),
                    // u);
