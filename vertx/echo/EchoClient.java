    ...
    public void start() throws Exception {
        vertx.createNetClient().connect(1234, "localhost", res -> {
            ...
            if (res.succeeded()) {
                 ...
                 * If you are running this more than once and want clients to
                 * share the STM objects between address spaces then go into the
                 * ObjectStore dir and look for the Uid that represents the
                 * state you want to share. Then uncomment the Uid line below
                 * and replace the Uid in quotes with the Uid you have selected.
                 * Uncomment the other obj1 creation line and comment out the
                 * original.
                 *
                 * If you want to see how this might work then just go with the
                 * example state in the ObjectStore shipped as part of this
                 * example and uncomment the lines.
                 */

                /*
                 * STM states are identified by Uids in the ObjectStore. This is
                 * an example.
                 */
