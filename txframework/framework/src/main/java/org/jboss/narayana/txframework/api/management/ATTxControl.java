...
/**
 * Interface defining a transaction control object which can be injected into a
 * framework web service or lifecycle method for one of the Atomic Transaction
 * protocols.
 */
