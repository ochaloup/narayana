...
public class JAXWSHandlerAnnotatonTest {
    ...
    public static JavaArchive createTestArchive() {
        ...
        JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "test.jar")
                .addAsResource("jaxws-handlers-jaxws-service.xml").addClass(SimpleHandler.class)
                .addClass(JAXWSHandlerAnnotationClient.class).addClass(JAXWSHandlerAnnotation.class)
    ...
    public void echoTest() throws Exception {
        ...
        // Assert.assertTrue("Expected handler to be called 5 times, was called
        // " + MyServerHandler.getCount() + " times", MyServerHandler.getCount()
        // == 5);
    }
