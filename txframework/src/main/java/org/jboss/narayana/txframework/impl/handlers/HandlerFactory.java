...
public class HandlerFactory {
    ...
    public static ProtocolHandler createInstance(ServiceInvocationMeta serviceInvocationMeta)
        ...
        Transactional Transactional = (Transactional) serviceInvocationMeta.getServiceClass()
