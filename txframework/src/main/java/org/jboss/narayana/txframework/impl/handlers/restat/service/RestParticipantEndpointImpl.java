...
public class RestParticipantEndpointImpl {
    ...
    public static void enlistParticipant(String txid, UriInfo info, String enlistUrl, Object serviceImpl)
         ...
         * registration
         *
         * The next call constructs the participant-resource and
         * participant-terminator URIs for participants in the format:
         * "<baseURI>/{uid1}/{uid2}/participant" and
         * "<baseURI>/{uid1}/{uid2}/terminator"
         */
    ...
    /*
     * This method handles requests from the REST-AT coordinator for the
     * participant terminator URI
     */
    @HEAD
