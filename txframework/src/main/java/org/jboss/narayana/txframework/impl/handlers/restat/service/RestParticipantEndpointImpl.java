...
public class RestParticipantEndpointImpl {
    ...
    public static void enlistParticipant(String txid, UriInfo info, String enlistUrl, Object serviceImpl)
        ...
        // draft 8 of the REST-AT spec uses link headers for participant
        // registration
        ...
        /*
         * String path = info.getPath(); if (path.startsWith("/")) { path =
         * path.substring(1); }
         * 
         * String serviceURL = info.getBaseUri() + path; String terminator =
         * serviceURL + txid + "/" + pid + "/terminate"; String participant =
         * serviceURL + txid + "/" + pid + "/terminator";
         * 
         * String pUrls = TxSupport.getParticipantUrls(terminator, participant);
         * System.out.println("Service: Enlisting " + pUrls);
         * 
         * 
         * TxSupport txSupport = new TxSupport(); String response =
         * txSupport.httpRequest(new int[]{HttpURLConnection.HTTP_CREATED},
         * enlistUrl, "POST", TxSupport.POST_MEDIA_TYPE, pUrls, null); //todo:
         * check response
         */
    }
    ...
    public Response terminate(@PathParam("txid") @DefaultValue("") String txid,
            @PathParam("pId") @DefaultValue("") Integer pId, String content) {
        ...
        // todo: shouldn't we get a FORGET here? If so, that is the time to
        // remove the participant entry from the participants map.
    }
}
