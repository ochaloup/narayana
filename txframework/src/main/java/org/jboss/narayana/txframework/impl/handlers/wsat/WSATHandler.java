        ...
        try {
            synchronized (participantRegistry) {
                ...
                if (!participantRegistry.isRegistered(txid, serviceInvocationMeta.getServiceClass())) {
                    ...
                    Volatile2PCParticipant volatileParticipant = new WSATVolatile2PCParticipant(serviceInvocationMeta,
                            txDataMap, txid);
                    Durable2PCParticipant durableParticipant = new WSATDurable2PCParticipant(serviceInvocationMeta,
                            txDataMap);
