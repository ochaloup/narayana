...
public class ATBridgeTest {
    ...
    public static JavaArchive createTestArchive() {
        ...
        JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "test.jar")
                .addPackage(ATBridgeTest.class.getPackage()).addPackage(EventLog.class.getPackage())
                .addAsManifestResource("persistence.xml").addClass(ParticipantCompletionCoordinatorRules.class)
