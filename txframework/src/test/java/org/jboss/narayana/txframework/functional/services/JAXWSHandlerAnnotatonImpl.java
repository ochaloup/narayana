 ...
 */
@Stateless
@WebService(serviceName = "JAXWSHandlerAnnotatonService", portName = "JAXWSHandlerAnnotatonPort", name = "JAXWSHandlerAnnotatonImpl", targetNamespace = "http://www.jboss.com/functional/JAXWSHandlerAnnotatonImpl")
