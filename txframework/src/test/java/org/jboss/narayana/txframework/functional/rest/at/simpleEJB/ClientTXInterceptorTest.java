    ...
    public static WebArchive createTestArchive() {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
                ...
                .addAsWebInfResource(new ByteArrayAsset(
                        "<interceptors><class>org.jboss.narayana.txframework.impl.handlers.restat.client.RestTXRequiredInterceptor</class><class>org.jboss.narayana.txframework.impl.ServiceRequestInterceptor</class></interceptors>"
                                .getBytes()),
