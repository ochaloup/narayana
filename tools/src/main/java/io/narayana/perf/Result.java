 ...
 *
 *         Config data for running a work load (@see PerformanceTester and @see
 *         Worker)
 */
public class Result<T> implements Serializable {
    ...
    public String toString() {
        return String.format("%11d %6d %9d %11d%n", getThroughput(), getNumberOfCalls(), getErrorCount(), threadCount);
    }
