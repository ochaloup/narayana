 ...
 *             <p/>
 *             Interface defining a transaction control object which can be
 *             injected into a framework web service or lifecycle method for the
 *             Web Service Business Activity protocol.
 */
@Deprecated
