...
public class LocalParticipantRecoveryModule implements RecoveryModule {
    ...
    /**
     * Method checks if the provided participant should be compensated. I looks
     * for the BACoordinator record with the coordinator id from the
     * participant. If such record exists, recovery should be done by the
