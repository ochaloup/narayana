...
public class OptimisticHammerUnitTest extends TestCase {
    ...
    public void testRecoverableHammer() {
        ...
        /*
         * Make sharing of objects like this the default even for pessimistic.
         * Just pass back the same instance in that case. Also hide
         * getUidForHandle by simply passing the obj instance.fr
         */
