...
public class InvocationHandlerUnitTest extends TestCase {
    ...
    private int createStoreManager() {
        ...
        try {
            ...
            System.err
                    .println("InvocationHandler could not initialise object store for optimistic concurrency control.");
    ...
    public void test() {
        assertEquals(createStoreManager(), STORE_NEW); // first time should
                                                        // always work!
