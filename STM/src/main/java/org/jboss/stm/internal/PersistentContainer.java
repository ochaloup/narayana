 ...
 * persistent user objects can be placed and managed.
 * 
...
public class PersistentContainer<T> extends RecoverableContainer<T> {
    ...
    /**
     * Given a unique identifier, the container will either return an existing
     * handle to the object or recreate the handle with the same state that
     * existed at the commit of the last transaction to use it.
     * 
     * @param member
     *            the instance of type T that you want to be made transactional
     *            and persistent.
