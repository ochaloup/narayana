 ...
 * non-persistent user objects can be placed and managed.
 * 
...
public class RecoverableContainer<T> {
     ...
     * Create a container without a name. A name will be assigned automatically.
     * 
     * @param objectModel whether the instances are to be shared across address
     ...
     * 
     * @param global whether the instances are to be shared across address
     * spaces or classloaders.
     */
    ...
    public synchronized T enlist(T member, Uid id) {
        ...
        /*
         * Everything that is transactional needs to be explicitly marked as
         * such in the public API, even if the private methods are the ones that
         * do the real work.
         */
    ...
    /**
     * Return a handle through which the object should be used, rather than the
     * one passed in. Can specify the type of the object (recoverable,
     * persistent, neither).
     */
    ...
    protected synchronized T createHandle(T member, int ot) {
        ...
        if (proxy == null) {
            ...
            proxy = (T) Proxy.newProxyInstance(c.getClassLoader(), c.getInterfaces(),
                    new InvocationHandler<T>(this, member, ot));
    ...
    /*
     * Should the following methods all be protected/package scope, i.e., not
     * for applications to view and/or call?
     */
     ...
     * @exception throws
     *                IllegalArgumentException if the real object is not within
     *                the container.
     */
     ...
     * @exception throws
     *                IllegalArgumentException if the instance is not within the
     *                container.
     */
