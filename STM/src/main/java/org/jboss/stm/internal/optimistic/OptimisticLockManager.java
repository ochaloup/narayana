...
public class OptimisticLockManager extends LockManager {
    /*
     * Some of these methods are copied directly from LockManager and do 99% the
     * same thing. The only way they differ is with the types of Locks or
     * LockRecords that they create. Probably should refactor later to reduce
     * the amount of copied code.
     */

    /*
     * All of this is here to prevent us grabbing a copy of the state of the
     * object when we lock it. Optimistic and pessimistic locks cannot be used
     * in the same transaction on the same object.
     * 
     * WARNING HERE BE DRAGONS.
     * 
     * (non-Javadoc)
     * 
     * @see com.arjuna.ats.txoj.LockManager#setlock(com.arjuna.ats.txoj.Lock,
     * int, int)
     */
