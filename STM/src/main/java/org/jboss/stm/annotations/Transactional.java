...
/**
 * Defines that the class is to be managed within a transactional container.
 * Unless specified using other annotations, all public methods will be assumed
 * to modify the state of the object, i.e., require write locks. The only state
 * that will be saved/restored is that which is marked using the @State
 * annotation or SaveState/RestoreState.
 * 
 ...
 * and drive setlock, modified etc. implicity.
 */
