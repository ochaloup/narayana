        ...
        try {
            ...
            if (tm != null) {
                ...
                if (theTransaction != null) {
                    ...
                    /*
                     * XA does not support subtransactions. By default we ignore
                     * any attempts to create such transactions. Appropriate
                     * settings can be made which will cause currently running
                     * transactions to also rollback, if required.
                     */
