...
public class LastOnePhaseResource implements XAResource, Serializable, LastResourceCommitOptimisation {
    ...
    public void commit(final Xid xid, final boolean onePhaseCommit) throws XAException {
        if (!onePhaseCommit) {
    ...
    public void start(final Xid xid, final int flags) throws XAException {
        System.out.println(
                "start called on LastOnePhaseResource for xid: " + xid + " with flags 0x" + Integer.toHexString(flags));
    }

    public void end(final Xid xid, final int flags) throws XAException {
        System.out.println(
                "end called on LastOnePhaseResource for xid: " + xid + " with flags 0x" + Integer.toHexString(flags));
    }
