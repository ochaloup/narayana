...
public class JTSOSBTestBase extends TestBase {
    ...
    protected void assertBeanWasCreated(ArjunaTransactionImple txn) {
        ...
        try {
            ...
            // mbs.queryMBeans(new
            // ObjectName("jboss.jta:type=ObjectStore,itype=*"), null)
            assertEquals(heuristicParticipantCount, participants.size());
            mbs.queryMBeans(
                    new ObjectName(
                            "jboss.jta:type=ObjectStore,itype=StateManager/BasicAction/TwoPhaseCoordinator/ArjunaTransactionImple/ServerTransaction,uid=0_ffff7f000001_de8b_557556b4_1f"),
                    null);
