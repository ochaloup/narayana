...
public class TransactionImple extends com.arjuna.ats.internal.jta.transaction.jts.TransactionImple {
    ...
    public void commit() throws javax.transaction.RollbackException, javax.transaction.HeuristicMixedException,
        ...
        /*
         * throw new IllegalStateException( jtaxLogger.loggerI18N.getString(
        ...
        try {
            ...
            if (!endSuspendedRMs()) {
                try {
                    ...
                    // shouldn't happen! ignore because prepare will fail next
                    // anyway.
                }
            }
        ...
        try {
            ...
            if (!endSuspendedRMs()) {
                try {
                    ...
                    // shouldn't happen! ignore because commit will fail next
                    // anyway.
                }
            }

            int status = subAct.doOnePhaseCommit(); // ActionStatus status =
                                                    // TwoPhaseOutcome
    ...
    public String toString() {
        if (super._theTransaction == null)
            ...
            return "TransactionImple < jts-subordinate, " + super._theTransaction.get_uid() + " >";
        }
    }
