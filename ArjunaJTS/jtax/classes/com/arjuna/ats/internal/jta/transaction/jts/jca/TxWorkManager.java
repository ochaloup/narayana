...
public class TxWorkManager {
     ...
     * only allows one. Might not be worth the hassle of maintaining this
     * support.
     */
    ...
    public static void addWork(Work work, Transaction tx) throws WorkCompletedException {
        ...
        synchronized (_transactions) {
            ...
            if (workers == null) {
                ...
                throw new WorkCompletedException(jtaxLogger.i18NLogger.get_jtax_transaction_jts_jca_busy(),
