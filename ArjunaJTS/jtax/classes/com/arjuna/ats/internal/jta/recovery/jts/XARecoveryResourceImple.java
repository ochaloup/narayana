...
public class XARecoveryResourceImple extends XAResourceRecord implements XARecoveryResource {
    ...
    public int recoverable() {
        /*
         * If we haven't got an XID then we probably tried to load the state of
         * an inflight transaction and that state had just been deleted. So, no
         * recovery to perform.
         */
         ...
         * The XAResource will have to be provided for us and then we can retry.
         */
