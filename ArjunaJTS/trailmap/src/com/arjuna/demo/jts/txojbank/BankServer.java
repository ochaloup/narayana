...
/**
 * This is the entry point into a simple server application that is used to
 * expose a transaction-aware object, the <CODE>BankImpl</CODE>. All that this
 * application does is to create the <CODE>BankImpl</CODE> server object and
...
public class BankServer {
    ...
    public static void main(String[] args) {
        ...
        // 1. Create the workhorse of this section of the trailmap, the BankImpl
        // which responds to calls under
        ...
        if (uidBankFile.exists()) {
            ...
            // This section is executed when the bank server is executed for the
            // first time.
        ...
        // 2. Create an IOR reference to the <CODE>BankImpl</CODE> that can be
        // used by the <CODE>BankClient</CODE>
        ...
        try {
            // Display information to indicate that the client application may
            // now be ran
