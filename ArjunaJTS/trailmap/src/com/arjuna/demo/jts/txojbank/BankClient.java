...
public class BankClient {
     ...
     *
     * @param args
     *            The arguments to use for this trailmap example, not used.
     */
    public static void main(String[] args) {
        ...
        // Obtain a reference to the BankImpl CORBA representation inorder to be
        // able to use it to transactionally
        // invoke banking operations as part of the JBoss Transactions product
        // trailmap
        ...
        // Create the bank client to invoke user-chosen banking operations on
        // the Bank reference
