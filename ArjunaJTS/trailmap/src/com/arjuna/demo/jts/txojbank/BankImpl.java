...
/**
 *
 * The object is also available remotely under transactional control ensuring
 * that no partial accounts are commited to the underlying datastore (for this
...
public class BankImpl extends LockManager implements BankOperations {
    ...
    /**
     * Create a new bank with the object adapter to use to create account object
     * references.
     *
     * @param oa
     *            The object adapter to create account object references with.
     */
     ...
     *
     * @param uid
     *            The UID of this bank.
     * @param oa
     *            The object adapter to use to resolve and return
     *            <CODE>Account</CODE> references.
     */
     ...
     * @param ObjectType
     *            The type of the object (used in super call).
     *
