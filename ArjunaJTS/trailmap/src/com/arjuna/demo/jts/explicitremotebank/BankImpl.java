...
/**
 * This is an in memory, remotely available implementation of the Bank class
 * used in the JBoss Transactions product trailmap. As it is non-persistent, it
 * is only used to perform the banking operations that all Bank implementations
 * in the trailmap provide, such as creating and accessing an account, though it
 * is a CORBA object and as such can be remotely accessed.
 */
public class BankImpl extends BankPOA {
    /**
     * Initialize a new in memory bank represenation. As all the accounts are
     * merely stored in a hashtable without a persistent representation, this is
     * all that is required.
     */
    private java.util.Hashtable _accounts = new java.util.Hashtable();

    /**
     * A reference to the object adapter in order to obtain CORBA references to
     * the account objects.
     */
    private OA _oa;

    /**
     * Create a bank passing it a reference to the object adapter to use to
     * resolve the account objects.
     *
     * @param oa
     *            The object adapter to use to resolve references to the account
     *            objects.
     */
    ...
    /**
     * Create a new bank account and store it in the bank. Return a CORBA object
     ...
     *
     * @param name
     *            The name of the account to access.
    ...
    public Account get_account(String name) throws NotExistingAccount {
        ...
        // Print out a message to indicate that the <CODE>Account</CODE> local
        // reference is being converted to a
        // CORBA reference
