 ...
 *
 * For this trailmap example, the account must be interacted with by explicitly
 * passing a transaction contorl for the resource to be registered with.
 */
public class AccountImpl extends AccountPOA {
     ...
     *
     * @param ctrl
     *            The transaction control to indicate the transaction to acquire
     *            the balance under.
     *
     ...
     *
     * @param ctrl
     *            The transaction control to indicate the transaction to update
     *            the account under.
     * @param value
     ...
     *
     * @param control
     *            The transaction to enlist the resource within.
     *
