 ...
 * user of the JBoss Transactions product to manipulate a volatile
 * hashtable-backed <CODE>Bank</CODE> under transactional control.
 */
public class BankClient {
    ...
    /**
     * This operation will create a new zero balance bank account and then
     * update the balance of this account to the amount required, all under
    ...
    private void newAccount() {
        ...
        try {
            ...
            // transactionally perform this work, this
    ...
    /**
     * This operation is used to get information about an account. It will query
     * the underlying <CODE>Bank</CODE> object for an account holders current
     * balance.
     */
    private void getInfo() {
        ...
        try {
            ...
            try {
                ...
                // This is a rather artifical example as the operation is only a
                // read operation
    ...
    /**
     * This operation is used to make a transfer from an account to another
     * account.
     */
    ...
    /**
     * This operation is used to credit an account. It will ask the user to
     * enter the name of an account and an amount to credit this account with.
     */
    ...
    /**
     * This operation is used to debit money from an accout. It will prompt the
     * user to enter the name of the account and the amount to debit.
     */
     ...
     * sample that uses a <CODE>Hashtable</CODE> to store the bank accounts
     * repository. It is part of the JTA trailmap when using local objects.
     *
     * @param args
