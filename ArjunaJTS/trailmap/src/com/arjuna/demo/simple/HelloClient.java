...
/**
 * The <CODE>HelloClient</CODE> is used in the first stage of the JBoss
 * Transactions product trailmap. It is a trivial JTS client application which
 * invokes a remote method within the scope of a transaction.
 */
public class HelloClient {
    /**
     * The client entry point. This runs a simple client application which
     * connects to a <CODE>HelloImpl</CODE> and transactionally invokes it's
     * service method.
     *
     * @param args
     *            These are not used by this application.
     */
    public static void main(String[] args) {
        ...
        // 1. Obtain a reference to the HelloImpl CORBA representation inorder
        // to be able to use it to transactionally
        // invoke a method to validate the installation of the JBoss
        ...
        try {
            ...
            // configuration problem
            System.out
                    .println("Trailmap Error: Could not read the IOR of the HelloImpl (from file ./ObjectId): " + ioe);
            ioe.printStackTrace();
            System.exit(0);
        }
        ...
        try {
            ...
            // Transactionally invoke the print_hello operation. This is purely
            // to validate the installation of the product
        ...
        // 3. This indicates that the client was succesful in transactionally
        // calling the Hello server program over
        // CORBA
