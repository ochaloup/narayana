...
/**
 * This is a trivial implementation of a Serializable XAResource. It will crash
 * (<CODE>System.exit</CODE>) when commit is called on it for the first time and
 * will then complete normally when it is recovered.
 *
...
public class ExampleXAResource extends NonSerializableExampleXAResource implements Serializable {
     ...
     *
     * @param out
     *            The stream to write the state of this object to.
     * @throws IOException
     ...
     *
     * @param in
     *            The stream to read the state of this object from.
     * @throws IOException
     *             Not thrown by this implementation.
     */
