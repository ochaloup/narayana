...
public class ServiceTestSetup {
    ...
    public void test() throws Exception {
         ...
         */
        testServ.registerService(com.hp.mwtests.orbportability.orbspecific.orbtests.SimpleObjectHelper
                .narrow(testOA.corbaReference(servant)), TEST_SERVICE_NAME, params, Services.CONFIGURATION_FILE);
    }
}
