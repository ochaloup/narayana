...
public class ORBPrePostShutdownTest implements PrePostTestCallback {
     ...
     *
     * @param value
     *            The 'enumerated value' to generate the string of.
    ...
    /**
     * Called by the pre-shutdown subclass to inform test that it has been
     * prodded
     *
     * @param name
     *            The name associated with this pre-shutdown callback
     */
    ...
    /**
     * Called by the post-shutdown subclass to inform test that it has been
     * prodded
     *
     * @param name
     *            The name associated with this post-shutdown callback
     */
