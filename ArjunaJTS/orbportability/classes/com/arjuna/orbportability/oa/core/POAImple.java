...
public interface POAImple {
    ...
    /**
     * run is a way of starting a server listening for invocations. For
     * historical reasons we do this via the Object Adapter interface, though
     * POA ORBs may implement this via the ORB.
     */
