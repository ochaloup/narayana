...
public class PerfHammer {
    ...
    private static Integer getDefaultCallCnt() {
        return PerformanceProfileStore.isFailOnRegression() ? DEFAULT_CALL_CNT * 30 : DEFAULT_CALL_CNT;
    }

    private static Integer getDefaultThreadCount() {
        return PerformanceProfileStore.isFailOnRegression() ? DEFAULT_THR_CNT * 5 : DEFAULT_THR_CNT;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean correct = PerformanceProfileStore.checkPerformance(
                "JTSRemote_PerfTest_PerfHammer_" + myORB.orb().getClass().getName(), variance, opts.getThroughput(),
                true);
