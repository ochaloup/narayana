...
public class PerfHammer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean correct = PerformanceProfileStore.checkPerformance(metricName,
                PerformanceProfileStore.getVariance(metricName), opts.getThroughput(), true);

        System.out.printf(
                "Test performance (for orb type %s): %d calls/sec (%d invocations using %d threads with %d errors. Total time %d ms)%n",
