...
public class ExtendedResourceUnitTest extends TestBase {
    ...
    public void test() throws Exception {
        ...
        ExtendedResourceRecord res1 = new ExtendedResourceRecord(false, new Uid(), ares.getReference(), null, new Uid(),
                tx);
        ExtendedResourceRecord res2 = new ExtendedResourceRecord(false, new Uid(), ares.getReference(), null, new Uid(),
                tx);
    ...
    public void testNestedCommit() throws Exception {
        ...
        ExtendedResourceRecord res = new ExtendedResourceRecord(false, new Uid(), ares.getReference(),
                tx.getControlHandle().get_coordinator(), new Uid(),
                OTSImpleManager.current().getControlWrapper().getImple().getImplHandle());
    ...
    public void testTopLevelCommit() throws Exception {
        ...
        assertTrue(res.forgetHeuristic()); // no heuristic but we can still call
                                            // method
    }
