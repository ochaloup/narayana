...
/**
 * Instances of TxAssociation can be added on a per thread basis, or for all
 * threads.
 *
...
public class ThreadAssociations {
                ...
                if (v != null) {
                    for (int i = 0; i < v.size(); i++) {
                        ...
                        try {
                            ...
                            jtsLogger.i18NLogger.warn_extensions_threadasserror("ThreadAssociations.updateAssociations",
                                    e);
                        }
                    }
                }
    ...
    private static void update(TxAssociation ta, ControlWrapper tx, int reason) throws SystemException {
        switch (reason) {
