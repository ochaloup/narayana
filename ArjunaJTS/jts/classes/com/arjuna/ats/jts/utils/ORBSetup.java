...
public class ORBSetup implements InitClassInterface {
    ...
    public void invoke(Object obj) {
        if (!ORBManager.isInitialised()) {
            ...
            /**
             * If the object passed in is an ORB Portability ORB then set it to
             * be the ORB used by the JTS.
             */
            if (obj instanceof ORB) {
                ...
                /**
                 * Set the orb manager and then set the POA to be the root POA
                 * for that ORB. If another POA is then initialised this will be
                 * overridden.
                 */
            ...
            /**
             * If the object passed in is an ORB Portability OA then set it to
             * be the OA used by the JTS.
             */
