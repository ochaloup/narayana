...
public class JTSEnvironmentBean implements JTSEnvironmentBeanMBean {
     ...
     *
     * @return true for separate transaction manaager process, false for
     *         in-process.
     */
     ...
     *            true to enable use of a separate transaction manager, false to
     *            disable.
     */
    ...
    /**
     * Returns if transaction context interceptors will require a context to be
     * present.
     *
     * Default: false Equivalent deprecated property:
    ...
    /**
     * Sets if transaction context interceptors will require a context to be
     * present.
     *
     * @param needTranContext
     *            true to require a transaction context, false if it is
     *            optional.
     */
    ...
    /**
     * Returns if a transaction context should always be propagated on remote
     * calls.
     *
     * Default: false Equivalent deprecated property:
    ...
    /**
     * Sets if a transaction context should always be propagated on remote
     * calls.
     *
     * @param alwaysPropagateContext
     ...
     * com.arjuna.ats.jts.interposition
     *
     ...
     *            true to enable checked transactions, false to disable.
     */
    ...
    /**
     * Returns if subtransactions should be used in the JTS. Note that this is
     * distinct from the JTA module subtransaction option.
     *
     ...
     * Note: this is distinct from the coordinator's
     * beforeCompletionWhenRollbackOnly option.
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.jts.supportRollbackSync
     *
     * @return true if Synchronizations will run on transaction rollback, false
     *         if they will be skipped.
     */
     ...
     *
     * @param supportRollbackSync
     *            true to enable Synchronizations on rollback transactions,
     *            false to disable.
     */
    ...
    /**
     * Returns if Synchronizations can be interposed i.e. registered direct with
     * the parent coordinator.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.jts.supportInterposedSynchronization
     *
     * @return true for interposed (remote) Synchronization handling, false for
     *         local handling.
     */
     ...
     *
     * @param supportInterposedSynchronization
     *            true to enable interposition of synchronizations, false to
     *            disable.
     */
    ...
    /**
     * Returns if a reference to the terminator should be included in the
     * propagation context.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.jts.propagateTerminator
     *
    ...
    /**
     * Sets if a reference to the terminator should be included in the
     * propagation context.
     *
     * @param propagateTerminator
     *            true to enable propagation of the terminator, false to
     *            disable.
     */
    ...
    /**
     * Returns the name of the context propagation mode. "CONTEXT" or "NONE"
     *
     * Default: null Equivalent deprecated property:
     ...
     *
     * Default: 4711 Equivalent deprecated property:
     * com.arjuna.ats.jts.recoveryManagerPort
     *
     ...
     *
     * @param recoveryManagerPort
     *            the port number to use for the recovery manager.
     */
     ...
     *
     * Default: "" Equivalent deprecated property:
     ...
     *
     * @param recoveryManagerAddress
     *            the hostname to use for the recovery manager.
     */
    ...
    /**
     * Sets the InetAddress on which the recovery manager should bind. Mainly
     ...
     * true for OTS 1.2 (time remaining), false for backwards compatible (total
     * time)
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.jts.ots_1_0.timeoutPropagation
     *
     * @return true for remaining time propagation, false for total time
     *         propagation.
     */
     ...
     *
     * @param timeoutPropagation
     *            true for OTS 1.2 behaviour, false for backwards compatible.
     */
    ...
    /**
     * Returns if resources will have rollback invoked explicitly on them by
     * recovery.
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.jts.recovery.issueRecoveryRollback
     *
    ...
    /**
     * Sets if resources will have rollback invoked explicitly on them by
     * recovery.
     *
     * @param issueRecoveryRollback
     *            true to enable explicit rollback, false to disable.
     */
    ...
    /**
     * Returns the number of attempts to make to notify resources of a
     * transaction commit during recovery.
     *
     * Default: 3 Equivalent deprecated property:
     * com.arjuna.ats.jts.recovery.commitTransactionRetryLimit
     *
    ...
    /**
     * Sets the number of attempts to make to notify resource of a transaction
     * commit during recovery.
     *
     * @param commitedTransactionRetryLimit
