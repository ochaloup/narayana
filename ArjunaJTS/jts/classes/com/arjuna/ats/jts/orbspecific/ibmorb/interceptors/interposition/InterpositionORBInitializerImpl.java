...
public class InterpositionORBInitializerImpl extends LocalObject implements ORBInitializer {
    ...
    public void pre_init(ORBInitInfo init_info) {
        ...
        try {
            if (jtsLogger.logger.isTraceEnabled()) {
                jtsLogger.logger
                        .trace("InterpositionORBInitializerImpl - getting reference to ENCODING_CDR_ENCAPS codec");
            }
            ...
            throw new FatalError(jtsLogger.i18NLogger.get_orbspecific_javaidl_interceptors_interposition_codeccreate(),
                    ex);
        }
        ...
        try {
            ...
            ClientRequestInterceptor client_interceptor = new InterpositionClientRequestInterceptorImpl(localSlot,
                    cdr_codec);
        ...
        try {
            ...
            ServerRequestInterceptor server_interceptor = new InterpositionServerRequestInterceptorImpl(receivedSlot,
                    cdr_codec);
