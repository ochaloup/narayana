...
public class ContextORBInitializerImpl extends LocalObject implements ORBInitializer {
    ...
    public void pre_init(ORBInitInfo init_info) {
        ...
        try {
            ...
            jtsLogger.i18NLogger.warn_orbspecific_jacorb_interceptors_context_codecerror("ContextORBInitializerImpl",
        ...
        try {
            ...
            jtsLogger.i18NLogger.warn_orbspecific_jacorb_interceptors_context_duplicatename("ContextORBInitializerImpl",
                    "ClientRequestInterceptor", ex);
