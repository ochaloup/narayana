...
public interface jtsI18NLogger {
    ...
    // @Message(id = 22086, value = "Starting RecoveryServer ORB on port {0} and
    // address {1}", format = MESSAGE_FORMAT)
    // @LogMessage(level = INFO)
    // public void
    // info_orbspecific_jacorb_recoverycoordinators_JacOrbRCServiceInit_6(String
    // arg0, String arg1);
