...
/**
 * Threaded object used to replay phase 2 of the commit protocol in a background
 * thread.
 */
public class RecoveredTransactionReplayer extends Thread {
    ...
    public final void tidyup() {
        /*
         * Now notify any waiters that this recovery phase has ended. This is
         * used when multiple resources may call replay_completion together, and
         * we cannot replace more than one at a time in the intentions list!
         */
    ...
    /**
     * Swap an old Resource that was registered with the transaction for a new
     * one. The old one is identified by its RecoveryCoordinator that was
     * returned when the Resource was registered. The second parameter is the
     * new Resouce.
     */
