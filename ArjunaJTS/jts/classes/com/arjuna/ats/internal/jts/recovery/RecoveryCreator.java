...
/**
 * This abstract class is used to allow dynamic registration of creators for
 * RecoveryCoordinators. This means that we can provide ORB specific
 * implementations without having to have implementation specific information
 * within the transaction service.
 */
