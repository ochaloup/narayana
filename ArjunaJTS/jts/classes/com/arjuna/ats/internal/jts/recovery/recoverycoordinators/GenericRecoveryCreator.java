...
/**
 * Implementation of
 * {@link com.arjuna.ats.internal.jts.recovery.RecoveryCreator}. Orb-specific
 * aspects, especially the specific construction of the RecoveryCoordinator IOR
 * are delegated to an implementation of {@link RcvCoManager}. The RCs may be
 * created locally (depends on the orb-specific mechanisms) but will be
 * recreated in the RecoveryManager if called there (possibly following a crash
 * of this process).
 * 
 */
...
public class GenericRecoveryCreator extends RecoveryCreator {
     ...
     * aspects to the supplied RcvCoManager instance and register it with the
     * transaction service.
     */
    ...
    /**
     * Create a new RecoveryCoordinator for Resource res. The params array is
     * used to pass additional data. Currently params[0] is the
     * ArjunaTransactionImple ref. When create returns additional data is passed
     * back using params. Currently returned params[0] is the
    ...
    /**
     * The RC instance is not longer needed by the application. This is a
     * null-op for orb environments that do not actually create RC objects in
    ...
    /**
     * Destroy all RC instances for the transactions identified in params. This
     * is a null-op for orb environments that do not actually create RC objects
    ...
    /**
     * Get the service name. This ties the recoverycoordinators whose IOR's are
     * created here with the RecoveryManager that will recreate them in
     * recovery.
     */
