 ...
 * object is constructed, but ignores everything except the first ArjunaFactory
 *
 * On seeing an ArjunaFactory, it causes a FactoryContactItem to be saved and
 * deregisters itself (and thus relies on the fact (true for 2.1) that any
 * ArjunaFactory can be used to find the status of any transaction.
 */
...
public class RecoveryContactWriter implements com.arjuna.orbportability.event.EventHandler {
    ...
    public void connected(org.omg.CORBA.Object obj) {
        ...
        // only do this once - but shouldn't need this, since de-register on
        // writing
        ...
        try {
            ...
            if (theFactory != null) {
                ...
                // we've done our work, so set the flag and try to remove
                // ourselves
                _noted = true;
