 ...
 * Normally failed resources are terminated by replaying the transaction in
 * which the Resource was participating. However, if the transaction rolled back
 * then we won't have any persistent record of the transaction so it can't be
 * reactivated. Resources (and subordinate coordinators) may use the
 * replay_completion response to trigger their own rollback.
 * 
 */
