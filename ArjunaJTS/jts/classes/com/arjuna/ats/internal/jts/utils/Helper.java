...
public class Helper {
    ...
    /**
     * Given a Control_ptr determine if this is a reference to a local action,
     * and if so return the raw BasicAction pointer.
     */
    ...
    public static final Uid getUid(UidCoordinator coord) {
        ...
        /*
         * Try twice, and if this still fails then throw NO_MEMORY.
         */
