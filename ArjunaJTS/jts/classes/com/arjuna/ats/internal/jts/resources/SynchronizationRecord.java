...
/**
 * CosTransactions::Synchronizations are maintained in a separate list from the
 * standard transaction intentions list.
 *
...
public class SynchronizationRecord implements Comparable {
    ...
    /*
     * SyncronizationsImples are ordered first according to the isJTAInterposed
     * property and then by Uid. Interposed synchronizations must come after
     * non-interposed ones (see TransactionSynchronizationRegistry) The ordering
     * within the interposed/non-interposed categories is arbitrary but must be
     * defined for correct functioning of the sort. Just don't rely on it in
     * application level code.
     *
     * Note that interposition here is in the JTA TSR interface sense, not CORBA
     * TS.
     *
     * @param object
     * 
