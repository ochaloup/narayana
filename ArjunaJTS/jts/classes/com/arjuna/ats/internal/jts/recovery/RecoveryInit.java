...
public class RecoveryInit {
    ...
    public RecoveryInit() {
        ...
        if (!_initialised) {
            ...
            if (_isNormalProcess) {
                try {
                    // Use Here a class that should be initialized with a
                    // specific class specific to the ORB
                    ...
                    switch (orbType) {
                        ...
                        case ORBType.JAVAIDL :
                            ...
                            break;
                        case ORBType.IBMORB : // ibm jdk bundles the javaidl orb
                                                // so use that
                    ...
                    // register the ContactWriter to watch for the first
                    // ArjunaFactory construction

                    List<String> eventHandlers = opPropertyManager.getOrbPortabilityEnvironmentBean()
