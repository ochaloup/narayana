...
/**
 * Implementation of RecoveryCreator for ibmorb orb Handles the creation of
 * RecoveryCoordinator objects for ibmorb orb. The RCs are created locally but
...
public class JavaIdlRCManager implements RcvCoManager {
    ...
    static {
        ...
        String env3 = System
                .getProperty("com.arjuna.ats.internal.jts.orbspecific.ibmorb.recoverycoordinators.noDaemon");
