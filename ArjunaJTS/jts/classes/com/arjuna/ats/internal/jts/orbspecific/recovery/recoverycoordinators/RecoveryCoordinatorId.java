...
/**
 * Holds and manipulates the fields used to identify which branch of which
 * transaction a RecoveryCoordinator is concerned with. Split from
 * {@link GenericRecoveryCoordinator} to allow for default servant mechanism
 * with POA
 *
...
public class RecoveryCoordinatorId {
    /*
     * fields have package access - we are close friends with
    ...
    String makeId() {
        ...
        /*
         * Pack the fields in to the string. perhaps replace ':' with '-' if
         * required (likely to be orb-specific requirement)
         */
