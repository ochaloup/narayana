 ...
 * AssumedCompleteServerTransaction (e.g. the status must be committed), but
 * they are kept the same to simplify maintenance
 * <P>
 * 
...
public class AssumedCompleteServerTransaction extends RecoveredServerTransaction {
     ...
     * AssumedCompleteServerTransactions separate
     */
