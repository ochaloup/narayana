...
public void makeDeposit(float amt);
    ...
    /*
     * Upon entering, the context of the transaction is implicitly associated
     * with the object’s thread. The makeDeposit operation performs some
     * transactional requests on external, recoverable servers. The objects res1
     * and res2 are recoverable objects. The current transaction context is
     * implicitly propagated to these objects.
     */
