...
public class TransactionManagerDelegate extends BaseTransactionManagerDelegate implements ObjectFactory {
     ...
     * @return the time (in ms) remaining in the current transaction or -1 if
    ...
    public long getTimeLeftBeforeTransactionTimeout(boolean errorRollback) throws RollbackException {
        ...
        try {
                ...
                case Status.STATUS_ROLLING_BACK :
                    if (errorRollback) {
                        throw new RollbackException(jbossatxLogger.i18NLogger
                                .get_jta_TransactionManagerDelegate_getTimeLeftBeforeTransactionTimeout_1());
                    }
                    break;
            ...
            RollbackException rollbackException = new RollbackException(jbossatxLogger.i18NLogger
                    .get_jta_TransactionManagerDelegate_getTimeLeftBeforeTransactionTimeout_2());
