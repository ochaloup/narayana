...
public class TransactionManagerDelegate extends BaseTransactionManagerDelegate implements ObjectFactory {
     ...
     * @return the remaining in the current transaction or -1 if there is no
     *         transaction
     * @throws RollbackException
     *             if the transaction is marked for rollback and errorRollback
     *             is true
     */
    public long getTimeLeftBeforeTransactionTimeout(boolean errorRollback) throws RollbackException {
        // see JBAS-5081, JBTM-371 and
        // http://www.jboss.com/index.html?module=bb&op=viewtopic&t=132128
        ...
        try {
            switch (getStatus()) {
                ...
                case Status.STATUS_ROLLING_BACK :
                    if (errorRollback) {
                        throw new RollbackException(jbossatxLogger.i18NLogger
                                .get_jts_TransactionManagerDelegate_getTimeLeftBeforeTransactionTimeout_1());
                    }
                    break;
                case Status.STATUS_COMMITTED :
                case Status.STATUS_COMMITTING :
                case Status.STATUS_UNKNOWN :
                    throw new IllegalStateException(); // would be better to use
                                                        // a checked exception,
                    // but RollbackException does not make sense and the API
                    // does not allow any other.
                    // also need to clarify if we should throw an exception at
                    // all if !errorRollback?
            ...
            RollbackException rollbackException = new RollbackException(jbossatxLogger.i18NLogger
                    .get_jts_TransactionManagerDelegate_getTimeLeftBeforeTransactionTimeout_2());
     ...
     * @param relativeName
     *            The instance name relative to the context.
     * @param namingContext
     *            The naming context for the instance.
     * @param env
     *            The environment.
     */
    public Object getObjectInstance(final Object initObj, final Name relativeName, final Context namingContext,
