...
public class PropagationContextManager
    ...
    public Object getTransactionPropagationContext() {
        ...
        if (jbossatxLogger.logger.isTraceEnabled()) {
            jbossatxLogger.logger
                    .trace("PropagationContextManager.getTransactionPropagationContext() - returned tpc = " + txid);
        }
    ...
    public Object getTransactionPropagationContext(Transaction tx) {
        ...
        if (tx instanceof com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionImple) {
            String tpc = ((com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionImple) tx).get_uid()
                    .stringForm();

            if (jbossatxLogger.logger.isTraceEnabled()) {
                jbossatxLogger.logger
                        .trace("PropagationContextManager.getTransactionPropagationContext(Transaction) - returned tpc = "
                                + tpc);
            }
    ...
    public Transaction importTransactionPropagationContext(Object tpc) {
        ...
        if (tpc instanceof String) {
            try {
                ...
                Transaction newTx = com.arjuna.ats.internal.jta.transaction.arjunacore.TransactionImple
                        .getTransaction(importedTx);
