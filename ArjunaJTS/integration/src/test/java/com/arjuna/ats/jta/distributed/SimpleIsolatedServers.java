...
public class SimpleIsolatedServers {
    ...
    @BeforeClass
    public static void setup() throws SecurityException, NoSuchMethodException, InstantiationException,
            IllegalAccessException, ClassNotFoundException, CoreEnvironmentBeanException, IOException,
    ...
    private static void boot(int index) throws SecurityException, NoSuchMethodException, InstantiationException,
