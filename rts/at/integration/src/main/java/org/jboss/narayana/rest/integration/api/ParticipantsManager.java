...
public interface ParticipantsManager {
     ...
     *
     * NOTE: not needed if application is deployed to the WildFly and uses RTS
     * subsystem.
     *
     * @param baseUrl
     */
     ...
     *
     * @param applicationId
     *            Application ID unique in the container scope.
     * @param participantEnlistmentURL
     *            Participant enlistment URL returned by the transaction manager
     *            after creating REST-AT transaction.
     * @param participant
     *            Participant to be enlisted.
     * @return Participant ID which can be later used to report heuristic
     *         decision.
     */
     ...
     *
     * @param volatileParticipantEnlistmentURL
     *            VolatileParticipant enlistment URL returned by the transaction
     *            manager after creating REST-AT transaction.
     * @param volatileParticipant
     *            VolatileParticipant to be enlisted.
     */
    void enlistVolatileParticipant(String volatileParticipantEnlistmentURL, VolatileParticipant volatileParticipant);

    /**
     * Register ParticipantDeserializer instance which can be used during
     * recovery to recreate participant instances.
     *
     * @param applicationId
     *            Application ID unique in the container scope.
     * @param deserializer
     *            Instance of ParticipantDeserializer.
     */
     ...
     *
     * @param participantId
     *            Participant ID received after enlisting participant to the
     *            transaction.
     * @param heuristicType
