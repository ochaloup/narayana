...
public class SRAInfo {
    ...
    public SRAInfo(String lraId) {
        this.lraId = lraId;
    }
    public SRAInfo(URL lraId) {
        this.lraId = lraId.toString();
    }

    public SRAInfo(String lraId, String clientId, boolean isComplete, boolean isCompensated, boolean isRecovering, boolean isActive, boolean isTopLevel) {
        this.lraId = lraId;
