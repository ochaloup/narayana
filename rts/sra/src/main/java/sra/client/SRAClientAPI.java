...
public interface SRAClientAPI {
     ...
     *                SRA. It may therefore be necessary for the application or sra.demo.service to start other
     ...
     *                -  Completed: the coordinator/sra has confirmed.
     ...
     * @param compensateUrl Performing a POST onthis URL will cause the sra to compensate the work that
     *                      was done within the scope of the SRA.
     * @param completeUrl Performing a POST on this URL  will cause the sra to tidy up and it can forget this transaction.
