...
public class ConfigAuxiliaryArchiveAppender implements AuxiliaryArchiveAppender {
    ...
    public Archive<?> createAuxiliaryArchive() {
        JavaArchive archive = ShrinkWrap.create(JavaArchive.class)
            ...
            .addPackages(true, io.narayana.lra.client.NarayanaLRAClient.class.getPackage())
            .addPackages(true, io.narayana.lra.Current.class.getPackage())
            .addPackages(true, org.apache.http.HttpEntity.class.getPackage())
            .addPackages(true, io.narayana.lra.client.internal.proxy.nonjaxrs.LRAParticipantRegistry.class.getPackage())
            .addPackages(true, io.narayana.lra.client.internal.proxy.nonjaxrs.LRACDIExtension.class.getPackage())
            /* .addAsResource(new StringAsset(io.narayana.lra.client.internal.proxy.nonjaxrs.LRACDIExtension.class.getName()),
