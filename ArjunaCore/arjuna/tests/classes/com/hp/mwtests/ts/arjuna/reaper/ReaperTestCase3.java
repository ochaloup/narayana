...
public class ReaperTestCase3 extends ReaperTestCaseControl {
    ...
    public void testReaperWait() throws Exception {
        ...
        // create test reapables some of which will not respond immediately to
        // cancel requests
        ...
        // reapable2 will return CANCELLED from cancel and will not rendezvous
        // inside the cancel call
        // prevent_commit should not get called so we don't care about the
        // arguments
        TestReapable reapable2 = new TestReapable(uid2, true, false, false, false);
        // reapable3 will return CANCELLED from cancel and will not rendezvous
        // inside the cancel call
        // prevent_commit should not get called so we don't care about the
        // arguments
        ...
        // let the reaper process the first reapable then latch it again before
        // it checks the queue
        ...
        // let the worker process the first reapable then latch it again before
        // it checks the queue
        ...
        // byteman rules will ensure that the reaper and reaperworker rendezvous
        // get deleted
        // under this call
    ...
    public void testReaperForce() throws Exception {
        ...
        /*
         * Since we've (hopefully) just run two tests with new reapers in the
         * same VM we've also shown that it's possible to start/terminate/start
         * again!
         */
    }
