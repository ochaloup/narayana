...
public class ActionStatusServiceTest {
    ...
    public void test1() {
        ...
        String[] expectedStatus = new String[]{"ActionStatus.ABORTED", "ActionStatus.RUNNING",
    ...
    public void runTest(int crashType, String[] expectedStatus, boolean doAbort) {
        ...
        assertEquals(expectedStatus[0],
                ActionStatus.stringForm(_test_service.getTransactionStatus(test_type, test_uid)));
