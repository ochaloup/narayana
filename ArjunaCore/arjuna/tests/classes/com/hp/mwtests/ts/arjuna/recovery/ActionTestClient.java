...
class ActionTestClientTestService implements Service {
    private void test1() {
        ...
        try {
            ...
            if ((test_status1 == ActionStatus.ABORTED) && (test_status2 == ActionStatus.ABORTED)
                    && (test_status3 == ActionStatus.RUNNING) && (test_status4 == ActionStatus.RUNNING)
                    && (test_status5 == ActionStatus.COMMITTED) && (test_status6 == ActionStatus.COMMITTED)) {
    ...
    private void test2() {
        try {
            ...
            if ((test_status1 == ActionStatus.ABORTED) && (test_status2 == ActionStatus.ABORTED)
                    && (test_status3 == ActionStatus.RUNNING) && (test_status4 == ActionStatus.RUNNING)
                    && (test_status5 == ActionStatus.ABORTED) && (test_status6 == ActionStatus.ABORTED)) {
...
public class ActionTestClient {
    ...
    static private void terminateTx(AtomicAction tx, boolean commit) {
        ...
        ActionManager.manager().put(tx); // put it back on list to simulate
                                            // running condition.
    }
