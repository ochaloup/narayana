...
public class OnePhaseCommitUnitTest {
    ...
    public void testDynamic() throws Exception {
        ...
        /*
         * Because these are the same record type, we know that they will be called in
         * the order in which they were registered.
         *
         * There are two records, so 1PC will not be triggered initially. But the first
         * record will return read-only from prepare, which will then trigger 1PC to
         * happen dynamically.
         */
