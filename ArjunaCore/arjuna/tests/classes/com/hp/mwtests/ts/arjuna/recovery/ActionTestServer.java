...
public class ActionTestServer {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            System.out.println(_unit_test + "tests passed: " + _tests_passed + "  tests failed: " + _tests_failed);
            ...
            fail(_unit_test + "FATAL EXCEPTION: " + "tests passed: " + _tests_passed + "  tests failed: "
                    + _tests_failed);
        }
    }
    ...
    private static void test1() {
        try {
            ...
            CrashAbstractRecordImpl cr1 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.CRASH_IN_COMMIT);
            CrashAbstractRecordImpl cr2 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.CRASH_IN_COMMIT);
            ...
            if ((addcr1 == AddOutcome.AR_ADDED) && (addcr2 == AddOutcome.AR_ADDED)) {
    ...
    private static void test2() {
        try {
            ...
            CrashAbstractRecordImpl cr1 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.CRASH_IN_PREPARE);
            CrashAbstractRecordImpl cr2 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.CRASH_IN_PREPARE);
    ...
    private static void test3() {
        try {
            ...
            CrashAbstractRecordImpl cr1 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.NO_CRASH);
            CrashAbstractRecordImpl cr2 = new CrashAbstractRecordImpl(CrashAbstractRecordImpl.NO_CRASH);
    ...
    private static boolean test_setup() {
        ...
        try {
            ...
            _from_client = new BufferedReader(new InputStreamReader(_test_socket.getInputStream()));
            _to_client = new PrintWriter(new OutputStreamWriter(_test_socket.getOutputStream()));
