...
public class MockDriver extends ibm_driver {
    public boolean initialise(Connection conn, JDBCAccess jdbcAccess, String tableName,
        ...
        super._preparedStatements[0][com.arjuna.ats.internal.arjuna.objectstore.jdbc.JDBCImple.READ_STATE] = new MockPreparedStatement(
                false);
        ...
        super._preparedStatements[0][com.arjuna.ats.internal.arjuna.objectstore.jdbc.JDBCImple.CURRENT_STATE] = new MockPreparedStatement(
                false);
