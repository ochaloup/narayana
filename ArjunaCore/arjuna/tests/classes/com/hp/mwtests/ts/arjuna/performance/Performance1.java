...
public class Performance1 {
    ...
    public void test() {
        ...
        Measurement measurement = PerformanceProfileStore.regressionCheck(worker, getClass().getName() + "_test1", true,
                numberOfTransactions, threadCount, batchSize, warmUpCount);
