...
public class ArjPropertyManagerTest {
    ...
    public void test() {
        BeanPopulator.getNamedInstance(ObjectStoreEnvironmentBean.class, "communicationStore")
                .setObjectStoreSync(false);
        assertFalse(BeanPopulator.getNamedInstance(ObjectStoreEnvironmentBean.class, "communicationStore")
                .isObjectStoreSync());
        ...
        assertTrue(BeanPopulator.getNamedInstance(ObjectStoreEnvironmentBean.class, "communicationStore")
                .isObjectStoreSync());
