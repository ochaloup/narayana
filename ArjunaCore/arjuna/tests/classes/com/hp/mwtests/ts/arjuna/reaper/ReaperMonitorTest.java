...
public class ReaperMonitorTest {
    ...
    public void test() {
        ...
        /*
         * the reaper byteman script will make sure we synchronize with the reaper after
         * this call just before it schedules the reapable for processing. the timout in
         * the check method is there in case something is really wrong and the reapable
        ...
        // insert a new transaction with a longer timeout and check that we can find the
        // remaining time
