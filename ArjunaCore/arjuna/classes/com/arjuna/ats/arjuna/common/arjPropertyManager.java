...
public class arjPropertyManager {
    /*
     * Note to implementers: if named instances of the CoreEnvironmentBean are
     * created then you must apply the same technique as is used in the
     * implementation of getObjectStoreEnvironmentBean method below
     */
    ...
    /*
     * Note to implementers: if named instances of the CoordinatorEnvironmentBean
     * are created then you must apply the same technique as is used in the
     * implementation of getObjectStoreEnvironmentBean method below
     */
     ...
     *         instances of beans of type ObjectStoreEnvironmentBean as returned
     *         from calls to {@link BeanPopulator#getNamedInstance(Class, String)}
     *         and {@link BeanPopulator#getDefaultInstance(Class)}.
     *
