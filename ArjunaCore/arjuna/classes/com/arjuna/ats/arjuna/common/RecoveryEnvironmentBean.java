...
public class RecoveryEnvironmentBean implements RecoveryEnvironmentBeanMBean {
     ...
     *            the interval between recovery scan phases, in seconds.
     */
     ...
     *
     * @param periodicRecoveryInitilizationOffset
     *            The period (in seconds) to wait before starting first recovery
     *            run.
     */
     ...
     *            true for network use, false for local JVM only.
     */
    ...
    /**
     * Returns the network port number on which the recovery listener should
     * bind.
     *
     ...
     *
     * @param recoveryPort
     *            the port number for the recovery listener.
     */
     ...
     * intended for use by strongly typed bean injection systems, this is a
     * wrapper around the String form of the method.
     *
     * @param inetAddress
     *            the address on which to bind the recovery listener.
     */
    ...
    /**
     * Sets the network port number on which the transaction status manager
     * should bind.
     *
     ...
     *            the hostname on which the transaction status manager will
     *            listen.
     */
     ...
     * Mainly intended for use by strongly typed bean injection systems, this is
     * a wrapper around the String form of the method.
     *
     * @param inetAddress
     *            the address on which to bind the transaction status manager.
     */
    ...
    /**
     * Sets the interval on which the ObjectStore will be scanned for expired
     * items, in hours.
     *
     * @param expiryScanInterval
    ...
    /**
     * Returns the time period after which items will be considered to have
     * expired, in hours.
     *
     * Default: 12 hours Equivalent deprecated property:
    ...
    /**
     * Sets the time period after which items will be considered to have
     * expired, in hours.
     *
     * @param transactionStatusManagerExpiryTime
    ...
    /**
     * Returns a list of names of classes that implement ExpiryScanner. The
    ...
    /**
     * Returns the set of ExpiryScanner instances. The returned list is a copy.
    ...
    /**
     * Sets the instances of ExpiryScanner. The provided list will be copied,
     * not retained.
     *
     * @param expiryScanners
    ...
    /**
     * Returns the set of RecoveryModule instances. The returned list is a copy.
     * May return an empty list, will not return null.
     *
     * If there is no pre-instantiated instance set and classloading or
     * instantiation of one or more elements fails, this method will log an
    ...
    /**
     * Sets the instances of RecoveryModule. The provided list will be copied,
     * not retained.
     *
     * @param recoveryModules
    ...
    /**
     * Sets the recovery activators. List elements should be names of classes
     * that implement RecoveryActivator. The provided list will be copied, not
     * retained.
     *
     * @param recoveryActivatorClassNames
    ...
    /**
     * Returns the set of RecoveryActivator instances. The returned list is a
    ...
    /**
     * Sets the instances of RecoveryActivator. The provided list will be
     * copied, not retained.
     *
     * @param recoveryActivators
