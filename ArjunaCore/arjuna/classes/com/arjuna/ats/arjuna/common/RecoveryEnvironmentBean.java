...
public class RecoveryEnvironmentBean implements RecoveryEnvironmentBeanMBean {
     ...
     *
     * Default: 120 seconds Equivalent deprecated property:
    ...
    /**
     * Returns the interval between recovery phases within a recovery scan, in
     * seconds.
     *
     * Default: 10 seconds Equivalent deprecated property:
     ...
     *
     * @param recoveryBackoffPeriod the interval between recovery scan phases, in
     *                              seconds.
     */
    ...
    /**
     * Returns the initial period to wait before starting recovery. Useful when
     * starting multiple servers at once.
     *
     ...
     *
     * @param periodicRecoveryInitilizationOffset The period (in seconds) to wait
     *                                            before starting first recovery
     *                                            run.
     */
     ...
     * com.arjuna.ats.arjuna.recovery.recoveryListener
     *
     ...
     *
     * Default: 0 Equivalent deprecated property:
     * com.arjuna.ats.arjuna.recovery.recoveryPort
     *
     ...
     *
     * Default: "localhost" Equivalent deprecated property:
    ...
    /**
     * Sets the InetAddress on which the recovery listener should bind. Mainly
     * intended for use by strongly typed bean injection systems, this is a wrapper
     * around the String form of the method.
     *
    ...
    /**
     * Returns the network port number on which the transaction status manager
     * should bind.
     *
     * Default: 0 Equivalent deprecated property:
    ...
    /**
     * Sets the network port number on which the transaction status manager should
     * bind.
     *
     * @param transactionStatusManagerPort the port number for the transaction
     ...
     *
     * @param transactionStatusManagerAddress the hostname on which the transaction
     *                                        status manager will listen.
     */
     ...
     * Mainly intended for use by strongly typed bean injection systems, this is a
     * wrapper around the String form of the method.
     *
     * @param inetAddress the address on which to bind the transaction status
     *                    manager.
     */
    ...
    /**
     * Returns the interval on which the ObjectStore will be scanned for expired
     * items, in hours.
     *
     * Default: 12 hours Equivalent deprecated property:
    ...
    /**
     * Sets the interval on which the ObjectStore will be scanned for expired items,
     * in hours.
     *
     * @param expiryScanInterval the interval between ObjectStore expiry checks, in
     *                           hours.
     */
    ...
    /**
     * Returns the time period after which items will be considered to have expired,
     * in hours.
     *
     * Default: 12 hours Equivalent deprecated property:
    ...
    /**
     * Sets the time period after which items will be considered to have expired, in
     * hours.
     *
    ...
    /**
     * Returns a list of names of classes that implement ExpiryScanner. The returned
     * list is a copy. May return an empty list, will not return null.
     *
    ...
    /**
     * Sets the expiry scanners. List elements should be names of classes that
     * implement ExpiryScanner. The provided list will be copied, not retained.
     *
     * @param expiryScannerClassNames a list of ExpiryScanner implementation class
     *                                names.
     */
     ...
     * return an empty list, will not return null.
     *
    ...
    public List<ExpiryScanner> getExpiryScanners() {
        synchronized (this) {
            if (expiryScanners == null) {
                List<ExpiryScanner> instances = ClassloadingUtility.loadAndInstantiateClasses(ExpiryScanner.class,
    ...
    /**
     * Sets the instances of ExpiryScanner. The provided list will be copied, not
     * retained.
     *
    ...
    /**
     * Returns a list of names of classes that implement RecoveryModule. The
     * returned list is a copy. May return an empty list, will not return null.
     *
     * Default: empty list. Equivalent deprecated property prefix:
     *
    ...
    /**
     * Sets the recovery modules. List elements should be names of classes that
     * implement RecoveryModule. The provided list will be copied, not retained.
     *
     * @param recoveryModuleClassNames a list of RecoveryModule implementation class
     *                                 names.
     */
    ...
    /**
     * Returns the set of RecoveryModule instances. The returned list is a copy. May
     * return an empty list, will not return null.
     *
     * If there is no pre-instantiated instance set and classloading or
     * instantiation of one or more elements fails, this method will log an
    ...
    public List<RecoveryModule> getRecoveryModules() {
        synchronized (this) {
            if (recoveryModules == null) {
                List<RecoveryModule> instances = ClassloadingUtility
                        .loadAndInstantiateClassesWithInit(RecoveryModule.class, recoveryModuleClassNames);
    ...
    /**
     * Sets the instances of RecoveryModule. The provided list will be copied, not
     * retained.
     *
    ...
    /**
     * Sets the recovery activators. List elements should be names of classes that
     * implement RecoveryActivator. The provided list will be copied, not retained.
     *
     * @param recoveryActivatorClassNames a list of RecoveryActivator implementation
     *                                    class names.
     */
    ...
    /**
     * Returns the set of RecoveryActivator instances. The returned list is a copy.
    ...
    public List<RecoveryActivator> getRecoveryActivators() {
        synchronized (this) {
            if (recoveryActivators == null) {
                List<RecoveryActivator> instances = ClassloadingUtility
                        .loadAndInstantiateClassesWithInit(RecoveryActivator.class, recoveryActivatorClassNames);
    ...
    /**
     * Sets the instances of RecoveryActivator. The provided list will be copied,
     * not retained.
     *
     ...
     * com.arjuna.ats.internal.arjuna.recovery.listener.timeoutsocket
     *
