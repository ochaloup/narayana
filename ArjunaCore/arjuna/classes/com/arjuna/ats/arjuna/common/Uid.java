...
public class Uid implements Cloneable, Serializable {
    ...
    public Uid(String uidString, boolean errsOk) {
        ...
        if (!_valid) {
            if (errsOk) {
                try {
                    /*
                     * We do this so the instance is printable, but it shouldn't
                     * be usable from here on in!
                     */
    ...
    /**
     * Get the byte representation of the Uid. Useful for packing and creating
     * other representations of transaction ids.
     * 
    ...
    public byte[] getBytes() {
        /*
         * We should only really be doing this once, so overhead should be
         * negligible.
         */
