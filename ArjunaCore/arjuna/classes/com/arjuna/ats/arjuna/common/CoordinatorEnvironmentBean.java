...
/**
 * A JavaBean containing configuration properties for the core transaction
 * coordinator.
 *
...
public class CoordinatorEnvironmentBean implements CoordinatorEnvironmentBeanMBean {
    ...
    @Deprecated
    private volatile boolean transactionLog = false; // rename to
                                                        // useTransactionLog ?

    private volatile int maxTwoPhaseCommitThreads = 100;

    // public static final String TRANSACTION_LOG_REMOVAL_MARKER =
    // "com.arjuna.ats.arjuna.coordinator.transactionLog.removalMarker";
    ...
    private volatile boolean startDisabled = false; // rename/repurpose to
                                                    // 'enable'?
    private volatile String txReaperMode = "DYNAMIC"; // rename bool
                                                        // txReaperModeDynamic?
    ...
    /**
     * Sets if asynchronous commit behaviour should be enabled or not. Note:
     * heuristics cannot be reported programatically if asynchronous commit is
     * used.
     *
     * If true then a separate thread will be created to complete the second
     * phase of the action (provided that knowledge about heuristic outcomes is
     * not required).
     *
     * @param asyncCommit
     *            true to enable asynchronous commit, false to disable.
     */
     ...
     *
     * If true then during the prepare phase of an action a separate thread will
     * be created for preparing each participant registered with the action
     *
     * Default: false Equivalent deprecated property:
     ...
     *
     * @param asyncPrepare
     *            true to enable asynchronous prepare, false to disable.
     */
     ...
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.asyncRollback
     *
     ...
     *
     * @param asyncRollback
     *            true to enable asynchronous rollback, false to disable.
     */
     ...
     *
     * @param maxTwoPhaseCommitThreads
    ...
    /**
     * Returns true if dynamic one phase commit optimization is to be used. This
     * means that if the first N-1 participants in the intentions list return
     * read-only then commit_one_phase will be called on the last participant.
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.dynamic1PC
     *
     * @return true if one phase commit is enabled, false otherwise.
     */
     ...
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.maintainHeuristics
     *
     ...
     *
     * @param maintainHeuristics
     *            true to enable recording of heuristics, false to disable.
     */
    ...
    /**
     * Returns true if write optimisation protocol should be used for
     * PersistenceRecord.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.transactionLog.writeOptimisation
     *
     ...
     *
     * @param writeOptimisation
     *            true to enable write optimization, false to disable.
     */
     ...
     *
     * @param readonlyOptimisation
     *            true to enable read only optimization, false to disable.
     */
    ...
    /**
     * Returns true if the old style of prepare handling should be used for
     * PersistenceRecord.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.classicPrepare
     *
     ...
     *
     * @param classicPrepare
     *            true to enable classic prepare handling, false to disable.
     */
    ...
    /**
     * Returns true if transaction statistics should be recorded. Note: Enabling
     * statistics may have a slight performance impact due to locking on the
     * counter variables.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.enableStatistics Effect: immediate.
     *
     * @return true if recording of transaction statistics is enabled, false
     *         otherwise.
     */
     ...
     *            true to enable statistics gathering, false to disable.
     */
     ...
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.sharedTransactionLog
     *
     ...
     *
     * @param sharedTransactionLog
     *            true to enable transaction log sharing, false to disable.
     */
    @Deprecated
    ...
    /**
     * Returns if the transaction manager should be created in a disabled state
     * or not.
     *
     ...
     *
     * @return true if the transaction manager will start in a disabled state,
     *         false otherwise.
     */
    ...
    /**
     * Sets if the transaction manager should be created in a disabled state or
     * not.
     *
     * @param startDisabled
     *            true to start in a diabled state, false to start enabled.
     */
     ...
     *
     * Default: "DYNAMIC" Equivalent deprecated property:
     ...
     *
     * @param txReaperMode
     *            the name of the required operating mode.
     */
    ...
    /**
     * Returns the timeout (wakeup) interval of the reaper's PERIODIC mode, in
     * milliseconds.
     *
     * Default: 120000ms Equivalent deprecated property:
     ...
     *
     * @param txReaperTimeout
     *            the reaper sleep interval, in milliseconds.
     */
    ...
    /**
     * Returns the number of millisecs delay after a cancel is scheduled, before
     * the reaper tries to interrupt the worker thread executing the cancel.
     *
     * Default: 500ms Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.txReaperCancelWaitPeriod
     *
     ...
     *
     * @param txReaperCancelWaitPeriod
     *            in milliseconds.
     */
    ...
    /**
     * Returns the number of millisecs delay after a worker thread is
     * interrupted, before the reaper writes the it off as a zombie and starts a
     * new thread.
     *
     * Default: 500ms Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.txReaperCancelFailWaitPeriod
     *
     ...
     *
     * @param txReaperCancelFailWaitPeriod
     *            in milliseconds.
     */
    ...
    /**
     * Returns the threshold for count of non-exited zombies at which the system
     * starts logging error messages.
     *
     * Default: 8 Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.txReaperZombieMax
     *
     * @return the number of zombie threads at which errors will start being
     *         reported.
     */
    ...
    /**
     * Sets the threshold number of zombie threads at which errors will start to
     * be reported.
     *
     * @param txReaperZombieMax
    ...
    /**
     * Returns the default interval after which a transaction may be considered
     * for timeout, in seconds. Note: depending on the reaper mode and workload,
     * transactions may not be timed out immediately.
     *
     * Default: 60 Equivalent deprecated property:
    ...
    /**
     * Sets the default lifetime after which a transaction may be considered for
     * timeout, in seconds.
     *
    ...
    /**
     * Returns if the transaction status manager (TSM) service, needed for out
     * of process recovery, should be provided or not.
     *
     * Default: true Equivalent deprecated property:
     * com.arjuna.ats.arjuna.coordinator.transactionStatusManagerEnable
     *
     * @return true is the transaction status manager is enabled, false
     *         otherwise.
     */
     ...
     *
     * @param transactionStatusManagerEnable
     *            true to enable the TSM, false to disable.
     */
    ...
    /**
     * Returns if beforeCompletion should be called on Synchronizations when
     * completing transactions that are marked rollback only.
     *
     * Default: false Equivalent deprecated property:
     * com.arjuna.ats.coordinator.beforeCompletionWhenRollbackOnly
     *
     * @return true if beforeCompletion will be called in rollback only cases,
     *         false otherwise.
     */
    ...
    /**
     * Sets if beforeCompletion should be called on transactions that are set
     * rollback only.
     *
     * @param beforeCompletionWhenRollbackOnly
     *            true to call beforeCompletions on rollback only tx, false to
     *            skip them.
     */
     ...
     * Equivalent deprecated property:
     * com.arjuna.ats.coordinator.checkedActionFactory
     *
     ...
     *
     * @param checkedActionFactoryClassName
     *            the name of a class that implements CheckedActionFactory.
     */
     ...
     * instantiation fails, this method will log appropriate warning and return
     * null, not throw an exception.
     *
    ...
    public CheckedActionFactory getCheckedActionFactory() {
        if (checkedActionFactory == null && checkedActionFactoryClassName != null) {
            synchronized (this) {
                if (checkedActionFactory == null && checkedActionFactoryClassName != null) {
                    CheckedActionFactory instance = ClassloadingUtility
                            .loadAndInstantiateClass(CheckedActionFactory.class, checkedActionFactoryClassName, null);
     ...
     *
     * @param instance
     *            an Object that implements CheckedActionFactory, or null.
     */
    ...
    /**
     * Whether to use the alternative abstract record ordering. At present this
     * is not fully documented, so stay away!
     *
     * Default: false
     *
    ...
    /**
     * Set whether or not to use the alternative abstract record ordering. Don't
     * try this whilst the system is running!
     *
     * @param alternativeRecordOrdering
     *            true for alternative (i.e. type) ordering, false for normal
     *            (i.e. Uid) ordering.
     */
     ...
     * transactions). This can provide a useful safety net to ensure cleanup of
     * locks and other resources, but does not perform well. In most cases it's
     * preferable to set a transaction timeout and rely on the reaper for
     * cleanup.
     *
     * Default: false
     *
     * @return true if a finalize method should be registered for BasicActions
     ...
     *
     * The option is applicable to the volatile phase of the two phase commit
     * protocol which provides a synchronization mechanism that allows an
     * interested party to be notified before and after the transaction
     * completes. If set to true then the beforeCompletion method will be called
     * on all non interposed synchronizations in parallel, after which the
     * beforeCompletion method will be called on all interposed synchronizations
     * in parallel.
     *
     * Default: false
     *
     * @return true if asynchronous before completion is enabled, value
     *         otherwise.
     */
    ...
    /**
     * Sets if asynchronous before completion behaviour should be enabled or
     * not.
     *
     * @param asyncBeforeSynchronization
     *            true to enable asynchronous before completion, false to
     *            disable.
     */
     ...
     * protocol which provides a synchronization mechanism that allows an
     * interested party to be notified before and after the transaction
     * completes. If set to true then the afterCompletion method will be called
     * on all interposed synchronizations in parallel, after which the
     * afterCompletion method will be called on all non interposed
     * synchronizations in parallel.
     *
     * Caveat: if an action is committed and the caller wishes to be notified of
     * heuristics outcomes then this behaviour is not available and the
     * afterCompletion callbacks will be invoked synchronously. .
     *
     * Default: false
     *
     * @return true if asynchronous after completion is enabled, value
     *         otherwise.
     */
     ...
     *
     * @param asyncAfterSynchronization
     *            true to enable asynchronous after completion, false to
     *            disable.
     */
    ...
    /**
     * Returns true if configured to allow the checked action factory to be
     * overriden
     *
     * Default: true
     *
    ...
    /**
     * Can be enabled to allow the checked action factory to be overridden at
     * runtime
     *
     * @param allowCheckedActionFactoryOverride
     *            Allow the checked action factory to be overriden
     */
