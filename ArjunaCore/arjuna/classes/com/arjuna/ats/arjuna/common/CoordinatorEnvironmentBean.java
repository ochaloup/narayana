...
public class CoordinatorEnvironmentBean implements CoordinatorEnvironmentBeanMBean {
     ...
     * heuristics cannot be reported programatically if asynchronous commit is used.
     *
     * If true then a separate thread will be created to complete the second phase
     * of the action (provided that knowledge about heuristic outcomes is not
     * required).
     *
     ...
     *
     * If true then during the prepare phase of an action a separate thread will be
     * created for preparing each participant registered with the action
     *
     * Default: false Equivalent deprecated property:
     ...
     *
     * @param maintainHeuristics true to enable recording of heuristics, false to
     *                           disable.
     */
     ...
     *
     * @param readonlyOptimisation true to enable read only optimization, false to
     *                             disable.
     */
     ...
     *
     * @param classicPrepare true to enable classic prepare handling, false to
     *                       disable.
     */
     ...
     * statistics may have a slight performance impact due to locking on the counter
     * variables.
     *
     * Default: false Equivalent deprecated property:
     ...
     *
     * @param enableStatistics true to enable statistics gathering, false to
     *                         disable.
     */
     ...
     *
     * @param sharedTransactionLog true to enable transaction log sharing, false to
     *                             disable.
     */
    @Deprecated
    ...
    /**
     * Returns if the transaction manager should be created in a disabled state or
     * not.
     *
     * Default: false (i.e. transaction manager is enabled on creation) Equivalent
     * deprecated property: com.arjuna.ats.arjuna.coordinator.startDisabled
     *
     * @return true if the transaction manager will start in a disabled state, false
     *         otherwise.
     */
     ...
     *
     * @param startDisabled true to start in a diabled state, false to start
     *                      enabled.
     */
    ...
    /**
     * Returns the number of millisecs delay after a cancel is scheduled, before the
     * reaper tries to interrupt the worker thread executing the cancel.
     *
    ...
    /**
     * Sets the threshold number of zombie threads at which errors will start to be
     * reported.
     *
    ...
    /**
     * Returns the default interval after which a transaction may be considered for
     * timeout, in seconds. Note: depending on the reaper mode and workload,
    ...
    /**
     * Returns if the transaction status manager (TSM) service, needed for out of
     ...
     *
     * @param transactionStatusManagerEnable true to enable the TSM, false to
     *                                       disable.
     */
     ...
     *
     * @return true if beforeCompletion will be called in rollback only cases, false
     *         otherwise.
     */
     ...
     * rollback only.
     *
     * @param beforeCompletionWhenRollbackOnly true to call beforeCompletions on
     *                                         rollback only tx, false to skip them.
     */
     ...
     *
     * @param checkedActionFactoryClassName the name of a class that implements
    ...
    /**
     * Whether to use the alternative abstract record ordering. At present this is
     * not fully documented, so stay away!
     *
     * Default: false
     *
    ...
    /**
     * Set whether or not to use the alternative abstract record ordering. Don't try
     * this whilst the system is running!
     *
     * @param alternativeRecordOrdering true for alternative (i.e. type) ordering,
     *                                  false for normal (i.e. Uid) ordering.
     */
     ...
     * resources, but does not perform well. In most cases it's preferable to set a
     * transaction timeout and rely on the reaper for cleanup.
     *
     * Default: false
     *
     ...
     * protocol which provides a synchronization mechanism that allows an interested
     * party to be notified before and after the transaction completes. If set to
     * true then the beforeCompletion method will be called on all non interposed
     * synchronizations in parallel, after which the beforeCompletion method will be
     * called on all interposed synchronizations in parallel.
     *
     * Default: false
     *
     ...
     *
     * @param asyncBeforeSynchronization true to enable asynchronous before
     *                                   completion, false to disable.
     */
     ...
     * protocol which provides a synchronization mechanism that allows an interested
     * party to be notified before and after the transaction completes. If set to
     * true then the afterCompletion method will be called on all interposed
     * synchronizations in parallel, after which the afterCompletion method will be
     * called on all non interposed synchronizations in parallel.
     *
     ...
     *
     * @param asyncAfterSynchronization true to enable asynchronous after
     *                                  completion, false to disable.
     */
     ...
     * runtime
     *
     * @param allowCheckedActionFactoryOverride Allow the checked action factory to
     *                                          be overriden
     */
