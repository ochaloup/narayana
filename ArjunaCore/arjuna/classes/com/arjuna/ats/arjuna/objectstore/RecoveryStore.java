...
/**
 * All ObjectStore implementations that are used to drive recovery MUST
 * implement this interface. Because recovery is a superset of transaction
 * logging, those methods are also available.
 *
