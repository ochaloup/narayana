...
public class ThreadUtil {
    ...
    /**
     * As the association is stored in a map callers need to ensure they remove
     * from the thread when the threadID is no longer required.
     * 
     * @param thread
     *            The thread to remove from the map
