...
/**
 * JMX interface to the JBossTS recovery store OutputObjectState and
 * InputObjectState are wrapped since they are not convertible to open MBean
 * types.
 *
 * @see com.arjuna.ats.arjuna.tools.osb.api.proxy.RecoveryStoreProxy for the
 *      actual remote RecoveryStore proxy
 *
 * @see com.arjuna.ats.arjuna.objectstore.RecoveryStore for the interface it
 *      implements
 */
