 ...
 *
 * OutputObjectState and InputObjectState are wrapped since they are not
 * convertible to open MBean types.
 *
 * @see com.arjuna.ats.arjuna.tools.osb.api.proxy.ParticipantStoreProxy for the
 *      actual remote RecoveryStore proxy
 *
 * @see com.arjuna.ats.arjuna.objectstore.ParticipantStore for the interface it
 *      implements
 */
