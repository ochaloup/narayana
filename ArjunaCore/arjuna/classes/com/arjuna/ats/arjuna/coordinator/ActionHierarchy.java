...
/**
 * Class that represents the transaction hierarchy. This class can cope with
 * transaction hierarchies of arbitrary depth.
 *
...
public class ActionHierarchy {
    ...
    /**
     * Create a new (blank) hierarchy with sufficient space for the specified
     * number of transactions. Once this space is exhausted, additional space
    ...
    /**
     * Create a copy of the specified transaction hierarchy. Any hierarchy
     * currently maintained by this object will be lost in favour of the new
     * hierarchy.
     *
    ...
    /**
     * Insert new entry growing table as needed. Transaction id will be added as
    ...
    /**
     * Scan hierarchy looking for a particular Uid starting at deepest and going
     * up. Do NOT go past any top level action.
     *
     * @return <code>true</code> if is ancestor, <code>false</code> otherwise.
     */
    ...
    /**
     * CAREFULLY unpack the 'new' hierarchy. We unpack into a temporary to
     * ensure that the current hierarchy is not corrupted.
     */
    ...
    public void unpack(InputBuffer state) throws IOException {
        ...
        /*
         * We don't need to copy this if we got here. We can simply assign to
         * it, and let the garbage collector figure things out.
         */
    ...
    /**
     * @return the identity of the transaction at the specified level in the
     *         hierarchy.
     */
    ...
    /**
     * @return the ActionInfo for the transaction at the specified level.
     *         ActionInfo is not a public class so this is of limited use
     *         outside of the transaction system.
     */
