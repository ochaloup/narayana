...
public class ActionHierarchy {
    ...
    /**
     * Create a new (blank) hierarchy with sufficient space for the specified number
     * of transactions. Once this space is exhausted, additional space will be
    ...
    public void print(PrintWriter strm) {
        ...
        if (currentDepth == 0)
            ...
            /*
             * No need to check if hierarchy[i] is set, since currentDepth implies it is.
             */
    ...
    /**
     * Create a copy of the specified transaction hierarchy. Any hierarchy currently
     * maintained by this object will be lost in favour of the new hierarchy.
     *
    ...
    /**
     * Insert new entry growing table as needed. Transaction id will be added as a
     ...
     * Do NOT go past any top level action.
     *
    ...
    /**
     * CAREFULLY unpack the 'new' hierarchy. We unpack into a temporary to ensure
     * that the current hierarchy is not corrupted.
     */
    ...
    public void unpack(InputBuffer state) throws IOException {
        ...
        /*
         * We don't need to copy this if we got here. We can simply assign to it, and
         * let the garbage collector figure things out.
         */
    ...
    /**
     * @return the ActionInfo for the transaction at the specified level. ActionInfo
     *         is not a public class so this is of limited use outside of the
     *         transaction system.
     */
