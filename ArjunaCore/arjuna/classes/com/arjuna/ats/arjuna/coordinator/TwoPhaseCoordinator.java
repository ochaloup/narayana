    ...
    protected boolean beforeCompletion() {
        ...
        synchronized (_syncLock) {
            if (!_beforeCalled) {
                 ...
                 * alright to proceed to commit. The TM instance will flag the
                 * outcome. If it's rolling back, then we'll get an exception.
                 * If it's committing then we'll be blocked until the commit
                 * (assuming we're still the slower thread).
                 */
            }
        }
