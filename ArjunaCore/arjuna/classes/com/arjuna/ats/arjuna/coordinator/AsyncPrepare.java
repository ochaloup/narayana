...
class AsyncPrepare extends Thread {
    ...
    public static AsyncPrepare create(BasicAction act, boolean reportHeuristics, AbstractRecord rec) {
    ...
    public void run() {
        if (_theAction != null) {
             ...
             * the action it is preparing, only change its notion of the current
             * transaction so that any abstract records that need that
             * information can still have it.
             */
