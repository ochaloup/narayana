...
/**
 * This allows users to define a mapping between record type integers and
 * specific Class-es. This replaces Gandiva from previous releases.
 */

public class RecordTypeManager {
    /*
     * We can afford to synchronize on the instance because this shouldn't be a
     * performance problem for recovery.
     */
    ...
    static {
        /*
         * TODO At present all record types that we need are known at compile time or
         * can be added programmatically. We may want to allow them to be specified
         * dynamically, e.g., on the command line or in a configuration file, but when
         * that requirement happens we can fill in this block ...
         */
    }
}
