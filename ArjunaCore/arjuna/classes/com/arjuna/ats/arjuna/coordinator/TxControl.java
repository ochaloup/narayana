...
public class TxControl {
    ...
    static {
        ...
        beforeCompletionWhenRollbackOnly = arjPropertyManager.getCoordinatorEnvironmentBean()
        ...
        if (env != null) {
            ...
            /*
             * In the past we used a Uid as the default node name. However, this
             * is too big for the way in which we use it within Xids now that we
             * also support ipv6. Hence the need to limit the size of a node
             * name to 10 bytes.
             */
