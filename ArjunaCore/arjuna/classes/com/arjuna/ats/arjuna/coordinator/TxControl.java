...
public class TxControl {
    ...
    public static class Shutdown extends Thread {
        public void run() {
            ...
            // synchronize on the class since the shutdown method on TxControl
    ...
    /**
     * Set the timeout to be associated with a newly created transaction if
     * there is no other timeout to be used.
     * 
     * @param timeout
     */
    ...
    /**
     * flag which is true if enable and disable operations, respectively, start
     * and stop the transaction status manager and false if they do not perform
     * a start and stop. this flag is true by default and can only be set to
     * false by setting property
     * {@link#com.arjuna.ats.arjuna.common.TRANSACTION_STATUS_MANAGER_ENABLE} to
     * value "NO"
     */
