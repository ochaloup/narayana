...
public class TransactionStatusManagerItem {
    ...
    /**
     * Read host/port pair from the ObjectStore using the process Uid as a
     * unique identifier.
     */
    ...
    /**
     * Constructor which obtains the process uid and host for use with the
     * specified port.
     */
    ...
    /**
     * Constructor which obtains the process uid for use with the specified host
     * and port.
     */
    ...
    /**
     * Used by a Recovery Manager to recreate a Transaction status manager
     * contact item.
     */
