...
/**
 * A JavaBean containing configuration properties for the JDBC based objectstore
 * implementation.
 *
...
public class JDBCStoreEnvironmentBean {
    ...
    /**
     * Returns the class name of the JDBCAccess implementation used for the
     * ObjectStore.
     *
     * Default: null Equivalent deprecated property:
     * com.arjuna.ats.arjuna.objectstore.jdbcUserDbAccessClassName
     *
    ...
    /**
     * Sets the class name of the JDBCAccess implementation used for the
     * ObjectStore.
     *
     * @param jdbcUserDbAccessClassName
     *            the name of the class implementing JDBCAccess.
     */
    ...
    public JDBCAccess getJdbcUserDbAccess() {
        if (jdbcUserDbAccess == null && jdbcUserDbAccessClassName != null) {
            synchronized (this) {
                if (jdbcUserDbAccess == null && jdbcUserDbAccessClassName != null) {
                    JDBCAccess instance = ClassloadingUtility.loadAndInstantiateClass(JDBCAccess.class,
                            jdbcUserDbAccessClassName, null);
     ...
     *
     * Default: null Equivalent deprecated property:
     * com.arjuna.ats.arjuna.objectstore.jdbcTxDbAccessClassName
     *
     * @return the name of a class implementing JDBCAccess.
     */
     ...
     * com.arjuna.ats.arjuna.objectstore.jdbcPoolSizeInitial
     *
     ...
     *
     * Default: 1 Equivalent deprecated property:
     * com.arjuna.ats.arjuna.objectstore.jdbcPoolSizeMaximum"
     *
     ...
     * com.arjuna.ats.arjuna.objectstore.jdbcPoolPutConnections
     *
     ...
     *
     * @param jdbcPoolPutConnections
     *            true to enable connection reuse, false to disable.
     */
