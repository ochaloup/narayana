...
public class CadaverActivationRecord extends ActivationRecord {
    ...
    /*
     * shouldMerge and should_replace are invoked by the record list manager to
     ...
     * shouldMerge and shouldReplace return false Default implementations here
     * always return false - ie new records do not override old
     */

    public boolean shouldReplace(AbstractRecord ar) {
        return (((order().equals(ar.order())) && ar.typeIs() == RecordType.ACTIVATION) ? true : false);
    }
