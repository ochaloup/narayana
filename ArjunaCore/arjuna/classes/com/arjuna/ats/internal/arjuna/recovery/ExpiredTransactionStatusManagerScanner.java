...
public class ExpiredTransactionStatusManagerScanner implements ExpiryScanner {
    public ExpiredTransactionStatusManagerScanner() {
        if (tsLogger.logger.isDebugEnabled()) {
            tsLogger.logger.debug("ExpiredTransactionStatusManagerScanner created, with expiry time of "
                    + Integer.toString(_expiryTime) + "  seconds");
        }
    ...
    public void scan() {
        ...
        if (tsLogger.logger.isDebugEnabled()) {
            tsLogger.logger.debug("ExpiredTransactionStatusManagerScanner - scanning to remove items from before "
