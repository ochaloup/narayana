...
public class HornetqJournalStore {
    ...
    public void start() throws Exception {
        ...
        for (RecordInfo record : committedRecords) {
            ...
            // don't unpack the rest yet, we may never need it. read_committed does it on
            // demand.
        }
    }
    ...
    public boolean write_committed(Uid uid, String typeName, OutputObjectState txData) throws ObjectStoreException {
        ...
        try {
            ...
            if (previousRecord == null) {
                // if appendAddRecord() fails, remove record from map. Leave it there if
                // appendUpdateRecord() fails.
    ...
    public InputObjectState read_committed(Uid uid, String typeName) throws ObjectStoreException {
        ...
        // this repeated unpacking is a little inefficient - subclass RecordInfo to hold
        // unpacked form too?
    ...
    /**
     * @return the "name" of the object store. Where in the hierarchy it appears,
     *         e.g., /ObjectStore/MyName/...
     */
