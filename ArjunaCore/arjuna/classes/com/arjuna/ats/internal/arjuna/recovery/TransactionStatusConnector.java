...
public class TransactionStatusConnector {
    /**
     * Recreate TransactionStatusManagerItem and attempt to establish a connection
     * to the host/port of the TransactionStatusManager.
     */
    ...
    /**
     * Retrieve the transaction status for the specified transaction, attempts to
        ...
        if (!_dead) {
            ...
            if (_tsmFound) {
                try {
                    ...
                    /*
                     * TODO we should optimise this so we only close once all transactions for a
                     * particular host have been sent.
                     */
