...
public class CheckedActionFactoryImple implements CheckedActionFactory {
    /**
     * This implementation returns the same CheckedAction instance for every
     * transaction. Since the check method of the instance returned is stateless
     * this works. But it is not guaranteed to be correct for other implementations
     * of CheckedAction so only follow this pattern if you understand the
     * implications.
     */
