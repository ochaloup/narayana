...
public class ThreadActionData {
    ...
    /**
     * By setting the register flag accordingly, information about the thread may
     * not be propagated to the action, i.e., only the thread's notion of current
     * changes.
     */
    ...
    /**
     * By setting the unregister flag accordingly, information about the thread is
     * not removed from the action.
     */
     ...
     * before the transaction service really begins, or you risk having some threads
     * see one view of the list that is different to other threads.
     *
    ...
    /**
     * Remove a per thread setup object to the global list. This should only happen
     * after the transaction service really ends, or you risk having some threads
     * see one view of the list that is different to other threads.
     *
     * @param s the setup to add.
     */
