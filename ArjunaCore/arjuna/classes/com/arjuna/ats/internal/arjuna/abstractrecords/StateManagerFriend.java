...
/**
 * Some StateManager methods really shouldn't be available to users to call
 * inadvertently. In C++ valid users (specific AbstractRecord instances) were
 * friends of StateManager.
 */

public class StateManagerFriend {
    public static final boolean forgetAction(StateManager inst, BasicAction act, boolean committed, int recordType) {
        try {
            Method m = StateManager.class.getDeclaredMethod("forgetAction", BasicAction.class, boolean.class,
                    int.class);
    ...
    public static final boolean rememberAction(StateManager inst, BasicAction act, int recordType, int state) {
        try {
    ...
    public static final void destroyed(StateManager inst) // throws
