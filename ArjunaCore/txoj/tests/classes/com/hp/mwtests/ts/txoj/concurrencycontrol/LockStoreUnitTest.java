...
public class LockStoreUnitTest {
     ...
     * 
     * To run, fire up two shells and run the first one with this test and with
     * no parameters. Take the Uid that is printed out and use it in the second
     * shell with the same test and the -uid option.
     * 
     * Optionally provide a value through the -val parameter on one or both of
     * the shells.
     * 
     ...
     * at com.hp.mwtests.ts.txoj.common.resources.AtomicObject.set(AtomicObject.
     * java:182) at
     * com.hp.mwtests.ts.txoj.concurrencycontrol.LockStoreUnitTest.main(
     * LockStoreUnitTest.java:141)
     * 
     * This shows concurrency control being applied across two different
     * instances of the same object running in different address spaces.
     */
