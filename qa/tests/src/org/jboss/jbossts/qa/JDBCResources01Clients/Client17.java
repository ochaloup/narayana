...
public class Client17 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // now try more inserts using a single transaction across many jdbc
            // calls
            ...
            /**
             * We have done most of the test that we need to so lets reduce the
             * size of the table and check that the transaction is being used by
             * rollingback some of our work.
             *
             */
