...
public interface TxWrapper {
     ...
     * 
     * @return one of the com.arjuna.ats.arjuna.coordinator.ActionStatus
     *         constants
     */
    int begin();
    ...
    /**
     * Enlist a resource within the current transaction. For JTA products other
     * than JBossTS this record should be converted to an XAResource and
