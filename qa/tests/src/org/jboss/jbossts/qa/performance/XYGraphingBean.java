...
public class XYGraphingBean implements ImageObserver {
    ...
    protected BufferedImage createYAxisLabel(Graphics g, String text) {
        ...
        BufferedImage b = new BufferedImage((int) labelRect.getHeight(), (int) labelRect.getWidth() + 2,
    ...
    public synchronized BufferedImage createGraphImage(int width, int height) {
        ...
        Rectangle graphRect = new Rectangle((int) maxLabelWidth + _yAxisLabel.getWidth() + 5, 50, width - 150,
                height - 150);

        /**
         * Draw the axis
         *
         * 5| Pixels / Value 0| 1 / 5 5| 1 1 / (1/5) 0| 5| 2 +--------
         */
        g.setColor(Color.gray);
        g.drawLine((int) graphRect.getX(), (int) graphRect.getY(), (int) graphRect.getX(),
                (int) (graphRect.getY() + graphRect.getHeight()));
        g.drawLine((int) graphRect.getX(), (int) (graphRect.getY() + graphRect.getHeight()),
                (int) (graphRect.getX() + graphRect.getWidth()), (int) (graphRect.getY() + graphRect.getHeight()));

        double scaleY = graphRect.getHeight() / (_maxY - _minY); // Pixels per
                                                                    // value
        ...
        for (int count = 0; count <= _numIncY; count++) {
            ...
            g.setColor(Color.black);
            g.drawString(label, (int) graphRect.getX() - (int) labelRect.getWidth() - 2,
                    (int) (count * incY) + (int) graphRect.getY() + 5);
            g.drawLine((int) graphRect.getX(), (int) (count * incY) + (int) graphRect.getY(),
                    (int) graphRect.getX() - 2, (int) (count * incY) + (int) graphRect.getY());

            g.setColor(Color.lightGray);
            g.drawLine((int) graphRect.getX() + 1, (int) (count * incY) + (int) graphRect.getY(),
                    (int) graphRect.getMaxX(), (int) (count * incY) + (int) graphRect.getY());
        }
        ...
        for (int count = 0; count <= _numIncX; count++) {
            ...
            g.drawImage(img, (int) (count * incX) + (int) graphRect.getX() - 8,
                    (int) (graphRect.getY() + graphRect.getHeight() + 15), this);
            g.drawLine((int) (count * incX) + (int) graphRect.getX(), (int) (graphRect.getY() + graphRect.getHeight()),
                    (int) (count * incX) + (int) graphRect.getX(),
                    (int) (graphRect.getY() + graphRect.getHeight()) + 2);

            g.setColor(Color.lightGray);
            g.drawLine((int) (count * incX) + (int) graphRect.getX(),
                    (int) (graphRect.getY() + graphRect.getHeight() - 1), (int) (count * incX) + (int) graphRect.getX(),
                    (int) (graphRect.getY()));
        }
        ...
        g.drawImage(_yAxisLabel, (int) (graphRect.getX() - maxLabelWidth - 10),
                (int) graphRect.getCenterY() - (int) _yAxisLabel.getHeight(), this);
        ...
        for (int count = 0; count < _dataSeries.size(); count++) {
            ...
            for (int pCount = 0; pCount < points.length; pCount++) {
                ...
                int yPosition = ((int) graphRect.getY() + (int) graphRect.getHeight())
                        - (int) ((points[pCount].getY() - _minY) * scaleY);
                int yPreviousPosition = ((int) graphRect.getY() + (int) graphRect.getHeight())
                        - (int) ((previous.getY() - _minY) * scaleY);
