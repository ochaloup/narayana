...
public class AITMatrixImpl02 extends LockManager implements MatrixOperations {
    public AITMatrixImpl02(int width, int height) throws InvocationException {
    ...
    public AITMatrixImpl02(int width, int height, Uid uid) throws InvocationException {
        super(uid);
        ...
        try {
            ...
            try {
                if (setlock(new Lock(LockMode.READ), 0) == LockResult.GRANTED) {
                    ...
                    // Modified 15/01/2001 K Jones:
                    // 'interposition.unregisterTransaction()' removed
