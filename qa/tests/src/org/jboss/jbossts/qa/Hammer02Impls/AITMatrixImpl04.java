...
public class AITMatrixImpl04 extends LockManager implements MatrixOperations {
    public AITMatrixImpl04(int width, int height) throws InvocationException {
    ...
    public AITMatrixImpl04(int width, int height, Uid uid) throws InvocationException {
        super(uid);
    ...
    public int get_width() throws InvocationException {
        return _width;
    }

    public int get_height() throws InvocationException {
        return _height;
    }
    ...
    private static class Element extends LockManager {
        private Element(int value) throws InvocationException {
            super(ObjectType.ANDPERSISTENT);
        ...
        private Element(Uid uid) throws InvocationException {
            super(uid);
        }
        ...
        public void get_value(IntHolder value) throws InvocationException {
            try {
                if (setlock(new Lock(LockMode.READ), 0) == LockResult.GRANTED) {
                    value.value = _value;
                } else {
        ...
        public void set_value(int value) throws InvocationException {
            try {
                if (setlock(new Lock(LockMode.WRITE), 0) == LockResult.GRANTED) {
                    _value = value;
                } else {
