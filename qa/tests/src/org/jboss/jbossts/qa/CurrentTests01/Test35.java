    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                current.commit(true);
                System.err.println(
                        "Client: Commit OK - Warning: Expected INVALID_TRANSACTION or TRANSACTION_ROLLEDBACK exception to be thrown");
            ...
            if (correct) {
                ...
                if (interPhaseSleepPeriod != 0) {
                    try {
                        System.err.println(
                                "Client: Inter-phase sleep period of " + (interPhaseSleepPeriod / 1000) + " seconds");
                ...
                if (correct) {
                    ...
                    try {
                        ...
                        System.err
                                .println("Client: Caught INVALID_TRANSACTION exception - Warning: Expected Commit OK");
                        System.err.println("Client: Test should fail");
                        correct = false;
                    } catch (Exception exception) {
                        System.err.println("Client: Caught unexpected exception: " + exception);
