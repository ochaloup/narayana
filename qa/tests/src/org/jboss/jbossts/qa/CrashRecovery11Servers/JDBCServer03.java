...
public class JDBCServer03 {
    public static void main(String args[]) {
        try {
            ...
            JDBCServiceImpl01 jdbcServiceImpl1 = new JDBCServiceImpl01(args[args.length - 4], databaseURL, databaseUser,
                    databasePassword, databaseDynamicClass);
            JDBCServiceImpl01 jdbcServiceImpl2 = new JDBCServiceImpl01(args[args.length - 3], databaseURL, databaseUser,
                    databasePassword, databaseDynamicClass);
