...
public class AITImplicitObjectImpl01 extends LockManager implements ImplicitObjectOperations {
    public AITImplicitObjectImpl01() throws InvocationException {
    ...
    public AITImplicitObjectImpl01(Uid uid) throws InvocationException {
        super(uid);
    }
    ...
    public void no_tran_nulloper() throws InvocationException {
    }

    public void no_tran_readlock() throws InvocationException {
        try {
    ...
    public void no_tran_writelock() throws InvocationException {
        try {
            if (setlock(new Lock(LockMode.WRITE), 0) != LockResult.GRANTED) {
    ...
    public void tran_commit_readlock() throws InvocationException {
        try {
            AtomicTransaction atomicTransaction = new AtomicTransaction();
    ...
    public void tran_commit_writelock() throws InvocationException {
        try {
            AtomicTransaction atomicTransaction = new AtomicTransaction();
    ...
    public void tran_rollback_nulloper() throws InvocationException {
        try {
            AtomicTransaction atomicTransaction = new AtomicTransaction();
    ...
    public void tran_rollback_readlock() throws InvocationException {
        try {
            AtomicTransaction atomicTransaction = new AtomicTransaction();
    ...
    public void tran_rollback_writelock() throws InvocationException {
        try {
            AtomicTransaction atomicTransaction = new AtomicTransaction();
