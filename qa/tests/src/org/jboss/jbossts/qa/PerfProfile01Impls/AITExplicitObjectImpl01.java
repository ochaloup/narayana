...
public class AITExplicitObjectImpl01 extends LockManager implements ExplicitObjectOperations {
    public AITExplicitObjectImpl01() throws InvocationException {
    ...
    public AITExplicitObjectImpl01(Uid uid) throws InvocationException {
        super(uid);
    }
    ...
    public void no_tran_nulloper(Control ctrl) throws InvocationException {
        try {
    ...
    public void no_tran_readlock(Control ctrl) throws InvocationException {
        try {
            com.arjuna.ats.jts.ExplicitInterposition interposition = new com.arjuna.ats.jts.ExplicitInterposition();
            ...
            try {
                if (setlock(new Lock(LockMode.READ), 0) != LockResult.GRANTED) {
                    ...
                    // Modified 15/01/2001 K Jones: Removed
                    // 'interposition.unregisterTransaction()'
    ...
    public void no_tran_writelock(Control ctrl) throws InvocationException {
        try {
            com.arjuna.ats.jts.ExplicitInterposition interposition = new com.arjuna.ats.jts.ExplicitInterposition();
    ...
    public void tran_commit_nulloper(Control ctrl) throws InvocationException {
        try {
            com.arjuna.ats.jts.ExplicitInterposition interposition = new com.arjuna.ats.jts.ExplicitInterposition();
    ...
    public void tran_commit_writelock(Control ctrl) throws InvocationException {
        try {
            com.arjuna.ats.jts.ExplicitInterposition interposition = new com.arjuna.ats.jts.ExplicitInterposition();
    ...
    public void tran_rollback_nulloper(Control ctrl) throws InvocationException {
        try {
            com.arjuna.ats.jts.ExplicitInterposition interposition = new com.arjuna.ats.jts.ExplicitInterposition();
