...
public class JDBCInfoTableImpl02 implements InfoTable {
    ...
    public void insert(String name, String value) throws InvocationException {
        try {
            ...
            System.err
                    .println("INSERT INTO " + _databaseUser + "_InfoTable VALUES(\'" + name + "\', \'" + value + "\')");
            statement.executeUpdate(
                    "INSERT INTO " + _databaseUser + "_InfoTable VALUES(\'" + name + "\', \'" + value + "\')");
    ...
    public void update(String name, String value) throws InvocationException {
        try {
            ...
            System.err.println("UPDATE " + _databaseUser + "_InfoTable SET Value = \'" + value + "\' WHERE Name = \'"
                    + name + "\'");
            statement.executeUpdate("UPDATE " + _databaseUser + "_InfoTable SET Value = \'" + value
                    + "\' WHERE Name = \'" + name + "\'");
    ...
    public String select(String name) throws InvocationException {
        String value = "";
        ...
        try {
            ...
            ResultSet resultSet = statement
                    .executeQuery("SELECT Value FROM " + _databaseUser + "_InfoTable WHERE Name = \'" + name + "\'");
