...
public class JDBCInfoTableImpl01 implements InfoTable {
    public JDBCInfoTableImpl01(String databaseURL, String databaseUser, String databasePassword,
    ...
    public void insert(String name, String value) throws InvocationException {
        try {
            ...
            statement
                    .executeUpdate("INSERT INTO " + _dbUser + "_InfoTable VALUES(\'" + name + "\', \'" + value + "\')");
    ...
    public void update(String name, String value) throws InvocationException {
        try {
            ...
            System.err.println(
                    "UPDATE " + _dbUser + "_InfoTable SET Value = \'" + value + "\' WHERE Name = \'" + name + "\'");
    ...
    public String select(String name) throws InvocationException {
        ...
        try {
            ...
            ResultSet resultSet = statement
                    .executeQuery("SELECT Value FROM " + _dbUser + "_InfoTable WHERE Name = \'" + name + "\'");
            if (!resultSet.next()) {
