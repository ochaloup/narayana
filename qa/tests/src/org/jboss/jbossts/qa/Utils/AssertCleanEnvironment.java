...
/**
 * This class acts as a main program which can be used to test the state of the
...
public class AssertCleanEnvironment {
    ...
    private static void checkRunningProcesses(String[] args) throws Exception {
    ...
    private static void checkObjectStore(String[] args) throws Exception {
        ...
        if ((objectStoreDir != null) && objectStoreDir.isDirectory() && (!objectStoreDir.getName().equals(""))
                && (!objectStoreDir.getName().equals("/")) && (!objectStoreDir.getName().equals("\\"))
                && (!objectStoreDir.getName().equals(".")) && (!objectStoreDir.getName().equals(".."))) {
