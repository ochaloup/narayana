...
/**
 * Uses reflection to configure the datasources to avoid the need for compile
 * time linking against specific drivers jars
 */
public class JNDIManager {
    public static void main(String[] args) {
        try {
            String profileName = args[args.length - 1];
            String driver = JDBCProfileStore.driver(profileName,
                    0 /* driver number */);
            ...
            // We use reflection to configure the data source so as to avoid a
            // compile or runtime
            ...
            if (driver.equals("com.arjuna.ats.jdbc.TransactionalDriver")) {
                ...
                XADataSourceReflectionWrapper wrapper = new XADataSourceReflectionWrapper(
            ...
            //
            try {
                // expect suitable java.naming.provider.url and
