...
public class JVMStats {
    ...
    private static void doGarbageCollection() {
        /*
         * // no clean way to force this from within the jvm, so we'll sleep and
         * hope the gc runs. System.gc(); try { Thread.sleep(100); }
         * catch(InterruptedException e) {
         * 
         * }
         * 
         * JBTM-555: use jboss profiler agent to invoke gc via jvmti. This
         * requires native code, so tests using this will only execute on
