...
public class ServerIORStore {
    ...
    public static void removeIOR(String serverName) throws Exception {
        _iorStore.removeIOR(serverName);
    }

    public static String loadIOR(String serverName) throws Exception {
    ...
    static {
        try {
            String iorStoreClassname = System.getProperty(IOR_STORE_PLUGIN_CLASSNAME,
                    DEFAULT_IOR_STORE_PLUGIN_CLASSNAME);
