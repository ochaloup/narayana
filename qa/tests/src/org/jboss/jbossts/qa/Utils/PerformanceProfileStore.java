...
public class PerformanceProfileStore {
    ...
    public static boolean checkPerformance(String performanceName, float operationDuration) {
        ...
        try {
            ...
            System.out.println("Operation duration change: "
    ...
    private static void storePerformance(String performanceName, float operationDuration) throws Exception {
        Properties performanceProfile = new Properties();

        try {
            FileInputStream performanceProfileFileInputStream = new FileInputStream(
                    getBaseDir() + File.separator + "PerformanceProfiles");
        ...
        FileOutputStream performanceProfileFileOutputStream = new FileOutputStream(
                getBaseDir() + File.separator + "PerformanceProfiles");
    ...
    private static float loadPerformance(String performanceName) throws Exception {
    ...
    private static void remove() {
        try {
            ...
            System.err.println(
                    "Failed to remove \"perf_profile" + File.separator + "PerformanceProfiles\": " + exception);
            exception.printStackTrace(System.err);
        }
    }
