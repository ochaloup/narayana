...
public class EmptyObjectStore {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (arjPropertyManager.getObjectStoreEnvironmentBean().getObjectStoreType() != null && arjPropertyManager
                    .getObjectStoreEnvironmentBean().getObjectStoreType().startsWith("JDBCStore")) {
                JDBCAccess mJDBC = (JDBCAccess) Class
                        .forName(new JDBCStoreEnvironmentBean().getJdbcUserDbAccessClassName()).newInstance();
