...
public class CopyTransactionPropertiesFile {
    public final static String BACKUP = "backup", RESTORE = "restore", BACKUP_SUFFIX = "_qabackup";

    /**
     * Copy a file from source to destination returns true if the copy was
     * successfull returns false if the copy failed
     */
    public static boolean copyFile(String source, String destination) {
        ...
        try {
            File src = new File(source), dest = new File(destination);
