...
public class JDBCServiceImpl02 implements AfterCrashServiceOperations {
    public JDBCServiceImpl02(String rowName, String databaseURL, String databaseUser, String databasePassword,
    ...
    public void get(IntHolder value) throws InvocationException {
        try {
            ...
            /*
             * ResultSet resultSet = statement.executeQuery("SELECT Value FROM "
             * + _dbUser +"_Service WHERE Name = \'" + _rowName + "\'");
             * resultSet.next(); value.value = resultSet.getInt("Value"); if
             * (resultSet.next()) throw new Exception();
             */
