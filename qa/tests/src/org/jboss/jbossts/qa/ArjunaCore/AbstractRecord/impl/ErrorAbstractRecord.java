...
public class ErrorAbstractRecord extends AbstractRecord {
    /**
     * default constructor will call main constructor setting crash point and
     * type so that no crash will occur.
     */
    ...
    /**
     * Typeis is over-riden to force TransactionManager to process this record
     * first.
     */
    public int typeIs() {
    ...
    private int outcome() {
        int value = TwoPhaseOutcome.FINISH_OK;;// default
    ...
    private int mCrashType = 7; // default is 7 these are the return values of
                                // TwoPhaseOutcome
}
