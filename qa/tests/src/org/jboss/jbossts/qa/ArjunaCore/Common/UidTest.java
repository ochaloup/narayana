...
public class UidTest {
    ...
    /**
     * To check this method we are going to start sub processes create a bunch
     * of Uid's then check that the final list is unique.
     */
    ...
    public String mCommand = "java -Demma.verbosity.level=silent -cp " + System.getProperty("java.class.path")
            + " org.jboss.jbossts.qa.ArjunaCore.Common.UidTestWorker";
