...
public class BaseTestClient extends BaseTestCase {
    ...
    public void createTx(Uid uid) throws Exception {
    ...
    public void commit(boolean flag) throws Exception {
        mAtom.commit(flag);
    }

    // extra methods because we are changing the return type of the base class
    public int intCommit() throws Exception {
        return intCommit(true);
    }

    public int intCommit(boolean flag) throws Exception {
    ...
    public void add(AbstractRecord record) throws Exception {
        mAtom.add(record);
    }
