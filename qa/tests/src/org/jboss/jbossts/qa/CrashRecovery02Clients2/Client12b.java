...
public class Client12b {
    public static void main(String[] args) {
        try {
            ...
            /*
             * Prepare followed by a crash should eventually resolve to a
             * rollback, but we have no way of communicating that to the root
             * coordinator or guaranteeing it anyway. So heuristic outcomes are
             * the only option now.
             */
