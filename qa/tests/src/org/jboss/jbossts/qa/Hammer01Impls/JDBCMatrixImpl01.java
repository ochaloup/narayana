...
public class JDBCMatrixImpl01 implements MatrixOperations {
    public JDBCMatrixImpl01(int width, int height, String databaseURL, String databaseUser, String databasePassword,
    ...
    public void get_value(int x, int y, IntHolder value) throws InvocationException {
        ...
        try {
            ...
            resultSet = statement.executeQuery(
                    "SELECT Value FROM " + _dbUser + "_Matrix WHERE X = \'" + x + "\' AND Y = \'" + y + "\'");
            resultSet.next();
    ...
    public void set_value(int x, int y, int value) throws InvocationException {
        ...
        try {
            ...
            statement.executeUpdate("UPDATE " + _dbUser + "_Matrix SET Value = \'" + value + "\' WHERE X = \'" + x
                    + "\' AND Y = \'" + y + "\'");
