...
public class JDBCMatrixImpl02 implements MatrixOperations {
    public JDBCMatrixImpl02(int width, int height, String databaseURL, String databaseUser, String databasePassword,
    ...
    public void get_value(int x, int y, IntHolder value) throws InvocationException {
        ...
        try {
            ...
            resultSet = statement.executeQuery(
                    "SELECT Value FROM " + _databaseUser + "_Matrix WHERE X = \'" + x + "\' AND Y = \'" + y + "\'");
            resultSet.next();
    ...
    public void set_value(int x, int y, int value) throws InvocationException {
        ...
        try {
            ...
            statement.executeUpdate("UPDATE " + _databaseUser + "_Matrix SET Value = \'" + value + "\' WHERE X = \'" + x
                    + "\' AND Y = \'" + y + "\'");
