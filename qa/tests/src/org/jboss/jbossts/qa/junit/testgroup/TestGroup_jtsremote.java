...
public class TestGroup_jtsremote extends TestGroupBase {
    ...
    @Test
    public void JTSRemote_DistributedHammerTest1() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.HammerServer.class,
                Task.TaskType.EXPECT_READY, 960);
        server1.start("$(1)");
        Task server2 = createTask("server2", com.hp.mwtests.ts.jts.remote.servers.HammerServer.class,
                Task.TaskType.EXPECT_READY, 960);
        server2.start("$(2)");

        Task client = createTask("client1", com.hp.mwtests.ts.jts.remote.hammer.DistributedHammer1.class,
    ...
    public void JTSRemote_DistributedHammerTest2() {
        ...
        Task client = createTask("client1", com.hp.mwtests.ts.jts.remote.hammer.DistributedHammer2.class,
                Task.TaskType.EXPECT_PASS_FAIL, 960);
        client.start("$(1)", "$(2)");
        client.waitFor();
    ...
    @Test
    public void JTSRemote_ExplicitPropagationTest() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.ExplicitStackServer.class,
                Task.TaskType.EXPECT_READY, 480);
        server1.start("$(1)");
    ...
    public void JTSRemote_ImplicitPropagationTest() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.StackServer.class,
                Task.TaskType.EXPECT_READY, 480);
        server1.start("$(1)");
    ...
    @Test
    public void JTSRemote_ImplicitGridTest() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.ImplGridServer.class,
                Task.TaskType.EXPECT_READY, 480);
        server1.start("$(1)");
    ...
    @Test
    public void JTSRemote_CurrentTest() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.GridServer.class,
                Task.TaskType.EXPECT_READY, 480);
        server1.start("$(1)");
    ...
    @Test
    public void JTSRemote_ExplicitInterpositionTest() {
        Task server1 = createTask("server1", com.hp.mwtests.ts.jts.remote.servers.SetGetServer.class,
                Task.TaskType.EXPECT_READY, 480);
        server1.start("$(1)");
    ...
    public void JTSRemote_PerfTest() {
        ...
        startAndWaitForClient(com.hp.mwtests.ts.jts.remote.hammer.PerfHammer.class, "$(1)", numberOfCalls, threadCount,
                batchSize);
