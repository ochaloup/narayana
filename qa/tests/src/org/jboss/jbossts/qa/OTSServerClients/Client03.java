...
public class Client03 {
    public static void main(String[] args) {
        try {
            ...
            // This test creates a transaction with timeout period of 4 seconds
            // then
            // sleeps for 8 seconds.
            // When the timeout goes off at the transaction service, the
            // transaction is
            // rolled back and destroyed.
            // The subsequent call to get-status on the transaction results in
            // an
            // org.omg.CORBA.OBJECT_NOT_EXIST exception being thrown.
            // The JTS specification appears to be quite vague in this area,
            // however our
            // implementation is compliant with this vagueness.
            // Hence, For the purposes of this test,
            // org.omg.CORBA.OBJECT_NOT_EXIST being thrown
