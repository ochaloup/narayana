...
public class TestRunner {
    ...
    public Object addTest(PerfTest test) {
        ...
        tests.add(t);
        t.setDaemon(true); // means rogue test won't stop the VM from
                            // terminating
    ...
    public boolean waitOn(Object handle, long timeout) {
        ...
        if (isRunning(t)) {
            ...
            if (log.isInfoEnabled())
                log.info("joined with task " + t.getName() + ": t=" + t.getResult() + " e: " + t.getException());
        } else {
            if (log.isInfoEnabled())
                log.info("task " + t.getName() + " is not running: t=" + t.getResult() + " e: " + t.getException());
        }
