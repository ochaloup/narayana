...
public class DbWrapper {
    ...
    public static DataSource initMysqlDS(XADataSource xds, String user, String pass, String url) {
        log.fatal("Mysql support is disabled - please uncomment the implementation of "
                + DbWrapper.class.getCanonicalName() + ".initMysqlDS");

        return null;
        /*
         * com.mysql.jdbc.jdbc2.optional.MysqlXADataSource ds =
         * (com.mysql.jdbc.jdbc2.optional.MysqlXADataSource) xds;
         * ds.setUser(user); ds.setPassword(pass); ds.setURL(url);
         * 
         * return ds;
         */
    }
    ...
    public static DataSource initDerbyDS(String dsName, final Properties props, String host, String user, String pass) {
        log.fatal("Derby support is disabled - please uncomment the implementation of "
                + DbWrapper.class.getCanonicalName() + ".initDerbyDS");
        return null;
        /*
         * String dbName = getDbName(props); Integer port = getDbPort(props);
         * 
         * if (host != null) { org.apache.derby.jdbc.ClientXADataSource cds =
         * new org.apache.derby.jdbc.ClientXADataSource();
         * 
         * cds.setServerName (host); cds.setDatabaseName(dbName); if (port !=
         * null) cds.setPortNumber(port); cds.setUser(user);
         * cds.setPassword(pass); cds.setDataSourceName(dsName);
         * cds.setConnectionAttributes((String)
         * props.get("connectionAttributes")); if (props.get("traceLevel") !=
         * null) { cds.setTraceFile((String) props.get("debug.file"));
         * cds.setTraceLevel(Integer.parseInt((String)
         * props.get("debug.level"))); } return cds; } else {
         * org.apache.derby.jdbc.EmbeddedXADataSource eds = new
         * org.apache.derby.jdbc.EmbeddedXADataSource();
         * 
         * eds.setDatabaseName(dbName); eds.setUser(user);
         * eds.setPassword(pass); eds.setDataSourceName(dsName); //
         * eds.setConnectionAttributes((String)
         * props.get("connectionAttributes"));
     ...
     * 
     * jdbc:h2:tcp://localhost/rc;user=user1;password=pass1 jdbc:h2:db2"
     * jdbc:derby:db1;create=true jdbc:derby://localhost:1527/db1;create=true
     * jdbc:mysql://localhost:3306/db1?createDatabaseIfNotExist=true
     * 
     */
    private static final String[] URLS = {"jdbc:h2:tcp:", "jdbc:h2:", "jdbc:derby:net:", "jdbc:derby://", "jdbc:derby:",
    ...
    public static void parseUrl(String url, Properties props) {
        ...
        try {
            ...
            if (uri.getHost() != null)
                props.put("db.host", uri.getHost());
            if (uri.getPort() != -1)
                props.put("db.port", uri.getPort());
            if (uri.getPath() != null)
    ...
    private static String parseDbName(String s) { // jdbc:derby:db2
        int i = s.indexOf('?');
    ...
    static String[] h2DbUrl = {"jdbc:h2:tcp://localhost/rc;user=user1;password=pass1"}; // h2.baseDir
                                                                                        // sets
                                                                                        // the
                                                                                        // base
                                                                                        // dir
