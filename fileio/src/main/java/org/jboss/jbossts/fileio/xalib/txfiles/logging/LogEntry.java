...
public class LogEntry // implements Serializable
{
    ...
    /**
     * Constructor to create <code<LogEntry</code> objects to represent an entry
     * in the log file.
     *
     * @param position
     *            the position in the Transactional file of the first byte in
     *            the <code>data</code> array of bytes
     * @param recordLength
     *            the length of the <code>data</code> to read/write
     * @param data
     *            an array of the updated bytes
     */
