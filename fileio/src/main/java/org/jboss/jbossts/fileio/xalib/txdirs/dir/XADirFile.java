...
/**
 * Instances of this class are used by {@link XADir} objects to apply file
 * operations. These operations can include creating new, deletinig and renaming
 * files.
 * <p>
 * Each of these file operations invoke methods from the Apache's
 * {@link org.apache.commons.transaction.file.FileResourceManager} object to
 * manipulate operations on the files.
 *
 * @see XADir
...
public class XADirFile implements Serializable {
    ...
    /**
     * Constructor to create <code>XADirFile</code> objects. These objects can
     * be used to apply file operations.
     *
     * @param file
     *            the <code>File</code> object that represents the file in the
     ...
     *
     * @return <code>String</code> representing the name of the file in the
     *         transactional directory
     */
     ...
     *
     * @param file
     *            the <codeFile</code> object that contains the new file name
     * @return true if the rename operations completed successfully;false
     *         otherwise
     *
     */
    ...
    /**
     * Create a new file in the disk. If the file already exists the method will
    ...
    /**
     * This method will delete the file. If the file does not exist it will
     * return false; Otherwise true.
     *
     * @return true if the file could be deleted successfully; false otherwise.
     */
