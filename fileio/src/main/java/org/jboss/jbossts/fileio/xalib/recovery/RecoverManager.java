...
/**
 * This class can be used to recover incomplete transactions after a system
 * crash.
 *
...
public class RecoverManager {
    /**
     * Constructor to create RecoverManager objects. Every object will try to
     * get a {@link com.arjuna.ats.arjuna.recovery.RecoveryManager} and start a
     * thread on it.
     */
