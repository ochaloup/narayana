...
public class DataRecord implements Serializable {
     ...
     * read/write operations are used in the <code>XAFile</code>. It is also
     * used by the
     * {@link org.jboss.jbossts.fileio.xalib.txfiles.file.XAResourceManager}
     * after reading a log file and while trying to re-construct the records'
     * information to be committed to the <code>XAFile</code>.
     *
     * @param startPoint
     *            the position in the file of the first byte in the
     *            <code>recordBytes</code> array
     * @param recordLength
     *            the length of the updated bytes to commit
     * @param recordBytes
     *            the actual updated bytes
     * @exception IOException
     *                if an I/O error occurs
     */
    protected DataRecord(long startPoint, int recordLength, int[] recordBytes) throws IOException {
     ...
     * 
     * @return an array of <code>int</code>s that contains the updated bytes
     */
     ...
     * <code>recordBytes</code> array.
     * 
     * @return a <code>long</code> which represents the starting position of
     ...
     * 
     * @return an <code>int</code> which represents the length of this record
     */
    ...
    /**
     * Returns a <code>String</code> which contains all the updated bytes of
     * this record.
     * 
     * @return a <code>String</code> which represents the updated bytes of this
     *         record
     */
    ...
    /**
     * Returns a <code>byte</code> array which contains the updated bytes held
     * by this record.
     * 
     ...
     * used to display a more readable representation of the updated bytes held
     * by this record.
     * 
     * @param ints
     *            the array of updated bytes to convert
