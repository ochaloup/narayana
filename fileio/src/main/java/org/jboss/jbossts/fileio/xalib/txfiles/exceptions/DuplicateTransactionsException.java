 ...
 * {@link org.jboss.jbossts.fileio.xalib.txfiles.file.XAFile} to disallow
 * associating the same thread id with two different Transactions and two
 * different
 * {@link org.jboss.jbossts.fileio.xalib.txfiles.file.XAResourceManager}s.
 * 
...
public class DuplicateTransactionsException extends XAException {
    ...
    /**
     * Constructs a <code>DuplicateTransactionsException</code> with the given
