...
/**
 * Signals that a lock cannot be granted to either read from or write to a
 * Transactional file.
 * <p>
 * The exception is mainly used by
 * {@link org.jboss.jbossts.fileio.xalib.txfiles.file.XAFile} in the attempt of
...
public class LockRefusedException extends IOException {
    /**
     * Constructs a <code>LockRefusedException</code> with <code>null</code> as
    ...
    /**
     * Constructs a <code>LockRefusedException</code> with the given
     * <code>msg</code> as its detail message.
     * <p>
