...
public class JBossTSServerExtension implements LoadableExtension {
    ...
    public static boolean isSolaris() {
        ...
        return osName != null && ((osName.indexOf("Solaris") > -1) || (osName.indexOf("solaris") > -1)
    ...
    enum OSType {
        ...
        // IBM JDK does not have "jps" so using "ps", Solaris have "ps" in
        // "/usr/ucb/".
        String getPSCommand() {
            return null;
        }
        ...
        static OSType getOSType() {
            if (JBossTSServerExtension.isHpux())
                return HPUX;
            if (JBossTSServerExtension.isWindows())
                return WINDOWS;
            if (JBossTSServerExtension.isSolaris())
                return SOLARIS;
            return LINUX;
        }
