...
public class BasicClient extends HttpServlet {
    ...
    /**
     * Run a simple WS-AT transaction involving a transactional Web Service that
     * is configured with the inbound bridge. This client uses WS-AT type
    ...
    /**
     * Run a simple JTA transaction involving a transactional Web Service, with
     * communication passing though the outbound bridge. This client uses JTA
     * (XA) type transaction handling, whilst the service understands WS-AT type
     * only.
     * <p/>
     * Note: due to the implementation of the transaction infrastructure, this
     * method must be invoked with a web application container. It will not run
    ...
    private void testJTATransaction(int numberOfSeats) throws Exception {
        ...
        javax.transaction.UserTransaction ut = (javax.transaction.UserTransaction) initialContext
