...
/**
 * Common methods for tx bridge test cases. TODO: make server name ('default',
 * ...) configurable
 */
public abstract class AbstractBasicTests {
     ...
     * -Xmx1024m
     * -javaagent:/home/jhalli/IdeaProjects/jboss/byteman_trunk/install/lib/
     * byteman.jar=port:9091,listener:true -Dorg.jboss.byteman.debug=true
     * -Dorg.jboss.byteman.verbose=true
     * -Dorg.jboss.byteman.dump.generated.classes=true
     * -Dorg.jboss.byteman.dump.generated.classes.dir=dump -Demma.exit.delay=10
     */
    ...
    public void setUp() throws Exception {
        ...
        bytemanArgument.setValue("-javaagent:" + byteman_home + "/byteman.jar=port:9091,listener:true,sys:"
                + byteman_home + "/byteman-dtest.jar");
