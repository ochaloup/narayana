...
public class AccountManagerTest {
    ...
    public static Archive<?> createCustomerManagerArchive() {
        return ShrinkWrap.create(WebArchive.class, "customerManager.war")
                .addClasses(InvoiceManagerEJBHome.class, InvoiceManagerEJB.class, InvoiceManagerEJBImpl.class,
                        Invoice.class, AccountManagerEJB.class, CustomerManagerEJB.class, AccountManager.class,
                        Customer.class)
