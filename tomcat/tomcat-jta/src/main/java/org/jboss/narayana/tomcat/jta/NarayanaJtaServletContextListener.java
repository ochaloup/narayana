...
public class NarayanaJtaServletContextListener implements ServletContextListener {
     ...
     * values. If one doesn't exist, following defaults will be used. The
     * settings from configuration file is transfered to
     * {@link com.arjuna.ats.jta.common.JTAEnvironmentBean} where runtime
     ...
     *            containing the ServletContext that is being initialized
     */
    @Override
     ...
     * 
     * @param servletContextEvent
     *            containing the ServletContext that is being destroyed
     */
    @Override
